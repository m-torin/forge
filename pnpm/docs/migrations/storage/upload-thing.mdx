...
[uploadthing](https://uploadthing.com) is a platform for storing files in the
cloud. It's a great alternative to AWS S3 and it's free for small projects.
Here's how to switch the default storage provider to uploadthing.
...
Additionally, replace all instances of `BLOB_READ_WRITE_TOKEN` with
`UPLOADTHING_TOKEN` in the `packages/env/index.ts` file.
...
We'll also need to create a new file for the storage package to handle the
Tailwind CSS classes and SSR.
...
Create a new file in your app's `lib` directory to define the file router. This
file will be used to define the file routes for your app, using your
[Auth](/packages/authentication) package to get the current user.
...
Create a new route handler in your app's `api` directory to handle the file
routes.
...
Update your root layout to include the `StorageSSRPlugin`. This will add SSR
hydration and avoid a loading state on your upload button.
...
`generateUploadButton` function to create a button that will upload files to the
...
Now you can import this component into your app and use it as a regular
component.

## 10. Advanced configuration

uploadthing is a powerful platform that offers a lot of advanced configuration
options. You can learn more about them in the
[uploadthing documentation](https://docs.uploadthing.com/).

<Card
  title="File Routes"
  icon="route"
  href="https://docs.uploadthing.com/file-routes"
  horizontal
>
...
<Card
  title="Security"
  icon="shield"
  href="https://docs.uploadthing.com/concepts/auth-security"
  horizontal
>
