...
Today we're going to create an AI chatbot using next-forge and the built-in AI
...
That's it! You've now created an AI chatbot using next-forge and the built-in AI
