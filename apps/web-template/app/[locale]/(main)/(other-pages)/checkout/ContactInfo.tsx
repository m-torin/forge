...
import { ButtonPrimary, ButtonSecondary, Checkbox, Input, Label } from '@/components/ui';
    ...
    return (
      <div className="z-0 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
        ...
        >
          ...
          <div>
            <Checkbox defaultChecked label="Email me news and offers" name="uudai" />
          </div>

          {/* ============ */}
          <div className="flex flex-col pt-6 sm:flex-row">
            <ButtonPrimary onClick={() => onCloseActive()} className="sm:px-7! shadow-none">
              Save and next to Shipping
            </ButtonPrimary>
            <ButtonSecondary onClick={() => onCloseActive()} className="mt-3 sm:ml-3 sm:mt-0">
              Cancel
            </ButtonSecondary>
          </div>
        </div>
