...
import { IconUser, IconShield, IconDevices, IconLink } from '@tabler/icons-react';
...
export function EnhancedAccountForm({ user, locale, dict }: EnhancedAccountFormProps) {
  ...
  return (
    <Tabs defaultValue="profile" orientation="vertical">
      ...
      <Tabs.Panel value="security" pl="xl">
        <Stack gap="xl">
          <SecuritySettings />
          <MagicLinkSection />
        </Stack>
      ...
      <Tabs.Panel value="accounts" pl="xl">
        <SocialAccountsSection />
      </Tabs.Panel>

      <Tabs.Panel value="sessions" pl="xl">
        <SessionManager />
      </Tabs.Panel>
    </Tabs>
  );
