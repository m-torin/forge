...
function FavoritesCountError({ error, testId }: { error: string; testId?: string }) {
  return (
    <div className="relative p-2" data-testid={testId}>
...
export function FavoritesCount({
  ...
  try {
    ...
    console.error('FavoritesCount error:', err);
    setInternalError('Failed to load favorites count');
