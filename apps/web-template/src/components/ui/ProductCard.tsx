...
const ProductQuickView: FC<ProductQuickViewProps> = ({ product, onClose }) => {
  const { title, featuredImage, price, description, vendor } = product;
    ...
    <div className="p-6">
      <div className="flex flex-col lg:flex-row lg:gap-8">
        ...
        <div className="mt-6 lg:mt-0 lg:w-1/2">
          ...
          {vendor && <p className="mt-1 text-sm text-gray-500">{vendor}</p>}
...
const ProductCard: FC<ProductCardProps> = memo(
  ({
    ...
    const { featuredImage, handle, id, price, rating, reviewCount, title, vendor } =
      productData ?? {};
