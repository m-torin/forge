...
- **Nosecone Security Headers**: Configurable security headers with Vercel Toolbar support
...
Production-ready security headers with Vercel Toolbar compatibility:
...
// For development with Vercel Toolbar
export const devMiddleware = noseconeMiddleware(noseconeOptionsWithToolbar);
```
