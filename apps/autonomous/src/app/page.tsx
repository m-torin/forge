        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              This system uses Claude CLI to autonomously develop, test, and deploy Upstash Workflow functions
              with self-healing capabilities and continuous learning.
            </p>
            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Complete autonomous development from specification to deployment with comprehensive testing
                </p>
              </div>
          ...
          <div className="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
            <p>Research paper: &quot;Autonomous Workflow Development and Repair System Using Claude CLI&quot;</p>
