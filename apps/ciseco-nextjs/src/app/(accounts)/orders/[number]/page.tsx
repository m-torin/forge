    ...
    <div>
      <div className="flex flex-wrap items-end gap-4">
        <div>
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-neutral-900 sm:text-3xl">Order #{order.number}</h1>
        </div>

        <div className="ml-auto">
          <ButtonSecondary sizeClass="py-2.5 px-4 sm:px-6" fontSize="text-sm font-medium" href="#">
            View invoice
                  ...
                  <dl className="grid grid-cols-2 gap-x-6 text-sm">
                    ...
                    <div>
                      ...
                      <dd className="mt-3 flex flex-col gap-y-3 text-neutral-500">
                        <p>{product.email}</p>
                        <p>{product.phone}</p>
                        <button type="button" className="font-medium text-neutral-950 underline">
                          Edit
              ...
              <div className="border-t border-neutral-200 px-4 py-6 sm:px-6 lg:p-8">
                ...
                <div aria-hidden="true" className="mt-6">
                  ...
                  <div className="mt-6 hidden grid-cols-4 text-sm font-medium text-neutral-500 sm:grid">
                    ...
                    <div className={clsx(product.step > 0 ? 'text-neutral-950' : '', 'text-center')}>Processing</div>
                    <div className={clsx(product.step > 1 ? 'text-neutral-950' : '', 'text-center')}>Shipped</div>
                    <div className={clsx(product.step > 2 ? 'text-neutral-950' : '', 'text-right')}>Delivered</div>
                  </div>
                </div>
              </div>
            </div>
