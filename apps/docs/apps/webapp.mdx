...
- 🛒 **E-commerce Components** - Product cards, cart, checkout flow
- 🎨 **Modern UI Design** - Headless UI components with Tailwind CSS
- 🎠 **Interactive Carousels** - Embla carousel integration for product displays
- 📱 **Responsive Design** - Mobile-first approach with swipe gestures
- 🧪 **Comprehensive Testing** - Unit tests, integration tests, and E2E testing
- 📊 **Observability** - Integrated monitoring and error tracking
...
│   ├── GlobalClient.tsx   # Client-side global components
│   ├── actions.ts         # Server actions
│   ├── layout.tsx         # Root layout
│   └── not-found.tsx      # 404 page
├── components/            # Reusable UI components
│   ├── ProductCard.tsx    # Product display components
│   ├── SectionPromo*.tsx  # Promotional sections
...
- **@repo/database** - Database integration
