...
Add content directly in your files with MDX syntax and React components. You can
use any of our components, or even build your own.
...
<Card
  ...
  icon="chart-mixed"
  href="essentials/settings#analytics"
>
...
<Card
  ...
  icon="browser"
  href="essentials/settings#custom-domain"
>
