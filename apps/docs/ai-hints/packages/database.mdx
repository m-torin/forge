...
```prisma
// In /packages/pkgs-databases/prisma/prisma/schema.prisma
model User {
...
- Task templates:
  [Database setup template](/ai-hints/forge-reference#database-patterns)
- Command sequences:
  [Migration recovery](/ai-hints/forge-reference#database-migration-recovery)
