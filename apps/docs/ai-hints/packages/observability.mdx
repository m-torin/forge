...
- Task templates:
  [Observability setup template](/ai-hints/task-templates#implementing-error-tracking)
- Command sequences:
  [Debugging build failures](/ai-hints/command-sequences#debugging-build-failures)
