...
- Task templates:
  [Observability setup template](/ai-hints/forge-reference#observability-patterns)
- Command sequences:
  [Debugging build failures](/ai-hints/forge-reference#debugging-build-failures)
