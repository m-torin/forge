...
| `@repo/db-prisma`            | Prisma ORM + generated types   | 3     | ❌           | `import { db } from '@repo/db-prisma'`    |
...
import { createObservability } from "@repo/observability/client/next";
...
import { createObservability } from "@repo/observability/server";
```
