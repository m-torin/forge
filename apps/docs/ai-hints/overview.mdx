...
- **[Package Hints](/ai-hints/packages)** - Detailed guidance for specific
  packages
  - **[AI Package](/ai-hints/packages/ai)** - Centralized model configuration and AI integration
  - **[Auth Package](/ai-hints/packages/auth)** - Authentication patterns and user management
  - **[Database Package](/ai-hints/packages/database)** - Prisma schema and migrations
  - **[Observability Package](/ai-hints/packages/observability)** - Logging and monitoring
