...
Each **title** and **subtitle** creates an anchor and also shows up on the table
...
include the entire folder path. For example,
`[link to text](/writing-content/text)` links to the page "Text" in our
components section.
...
Mintlify supports [LaTeX](https://www.latex-project.org) through the Latex
component.
