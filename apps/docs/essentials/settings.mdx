...
settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages in the [API Configuration](https://mintlify.com/docs/api-playground).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](https://mintlify.com/docs/api-playground/introduction)
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<CodeGroup>
  ```json Absolute "openapi": "https://example.com/openapi.json" ``` ```json
  Relative "openapi": "/openapi.json" ``` ```json Multiple "openapi":
