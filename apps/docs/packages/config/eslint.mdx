...
<Tab title="React Package">
  ...
  import reactConfig from '@repo/eslint-config/react-package'; export default
...
<Tab title="Next.js Applications">
  ...
  eslint.config.ts import nextConfig from '@repo/eslint-config/next'; export
...
<Tab title="Server Packages">
  ...
  eslint.config.ts import serverConfig from '@repo/eslint-config/server'; export
