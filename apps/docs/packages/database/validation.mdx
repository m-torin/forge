...
The database package provides Prisma-generated Zod schemas that ensure type-safe validation matching your database constraints exactly.

## Overview

When you run `pnpm prisma:generate`, Prisma automatically generates Zod schemas for all your models. These schemas provide:
