...
<CardGroup cols={2}>
  ...
  >
    Primary database with comprehensive schema for auth, PIM, and workflows. See
    the [modernization guide](/packages/database/prisma-modernization) for
    latest patterns.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Modern ORM Patterns" icon="sparkles">
    Prisma validator fragments with 100% type safety and transaction support
  </Card>
...
# Open Prisma Studio (from database package)
