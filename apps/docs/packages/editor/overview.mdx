...
dist/
├── standalone/
│   ├── embeddable-standalone.global.js      # IIFE bundle for HTML
│   ├── embeddable-standalone.global.js.map  # Source map
│   └── embeddable-standalone.d.ts           # TypeScript declarations
├── react/
│   ├── react-bundle.mjs                     # React ESM bundle
│   ├── react-bundle.cjs                     # React CJS bundle
│   └── react-bundle.d.ts                    # TypeScript declarations
├── nextjs/
│   ├── nextjs-bundle.mjs                    # Next.js ESM bundle
│   ├── nextjs-bundle.cjs                    # Next.js CJS bundle
│   └── nextjs-bundle.d.ts                   # TypeScript declarations
├── components/
│   ├── components.mjs                       # Components ESM
│   ├── components.cjs                       # Components CJS
...
├── src/
│   ├── components/
│   │   ├── EmbeddableNotionEditor/    # Standalone embeddable editor
│   │   ├── NotionEditor/              # Full-featured editor
│   │   └── index.ts                   # Component exports
│   ├── hooks/                         # React hooks
│   ├── utils/                         # Utility functions
│   ├── types/                         # TypeScript definitions
│   ├── testing/                       # Test utilities
│   ├── external.ts                    # Clean external API
