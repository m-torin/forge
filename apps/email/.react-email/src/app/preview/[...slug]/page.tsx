...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["auth","magic-link"]},{"slug":["auth","password-reset"]},{"slug":["auth","verification"]},{"slug":["notifications","api-key-created"]},{"slug":["notifications","organization-invitation"]},{"slug":["notifications","welcome"]},{"slug":["transactional","contact"]}]
  );
}