...
// Remove useWorkflow import as it's no longer available in the new orchestration package
...
export function WorkflowTrigger({ workflow, defaultPayload }: WorkflowTriggerProps) {
  ...
  const { executeWorkflow, isExecuting, orchestrationProvider, workflowClient } = useWorkflows()
