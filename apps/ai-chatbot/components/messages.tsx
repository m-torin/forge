...
import { REASONING_CHAT_MODEL_ID } from '@/lib/ai/models';
...
function PureMessages({
  ...
  return (
    ...
    >
      <Conversation className="mx-auto flex min-w-0 max-w-4xl flex-col gap-4 px-2 pb-4 pt-4 md:gap-6 md:px-4">
        <ConversationContent className="flex flex-col gap-4 md:gap-6">
          ...
          {status === 'submitted' &&
            ...
            selectedModelId !== REASONING_CHAT_MODEL_ID && <ThinkingMessage />}
