...
import { MessageContent, Response } from '@repo/ai/ui/react';
import { motion } from 'framer-motion';
import { Sparkles } from 'lucide-react';
import { memo, useState } from 'react';
import { DocumentToolResult } from './document';
// Keep local Response import as fallback since AI Elements may not have all features yet
        ...
        >
          ...
          {message.parts?.map((part, index) => {
            ...
            if (type === 'tool-createDocument') {
              ...
              return (
                <DocumentPreview key={toolCallId} isReadonly={isReadonly} result={part.output} />
              );
            }
