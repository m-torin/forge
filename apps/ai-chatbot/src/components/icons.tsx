/**
 * Bot icon component for AI messages
 */
...
/**
 * User icon component for user messages
 */
...
/**
 * Attachment icon component for file uploads
 */
...
export const WifiIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.25 5.31802C3.44 3.57102 6.21 2.50002 8 2.50002C9.79 2.50002 12.56 3.57102 14.75 5.31802L13.625 6.74302C11.83 5.28402 9.42 4.37502 8 4.37502C6.58 4.37502 4.17 5.28402 2.375 6.74302L1.25 5.31802ZM3.5 8.16802C4.82 7.16602 6.42 6.62502 8 6.62502C9.58 6.62502 11.18 7.16602 12.5 8.16802L11.375 9.59302C10.45 8.84702 9.22 8.50002 8 8.50002C6.78 8.50002 5.55 8.84702 4.625 9.59302L3.5 8.16802ZM5.75 11.031C6.37 10.531 7.19 10.25 8 10.25C8.81 10.25 9.63 10.531 10.25 11.031L9.125 12.456C8.73 12.131 8.37 12 8 12C7.63 12 7.27 12.131 6.875 12.456L5.75 11.031ZM8 13.5C7.72 13.5 7.5 13.72 7.5 14C7.5 14.28 7.72 14.5 8 14.5C8.28 14.5 8.5 14.28 8.5 14C8.5 13.72 8.28 13.5 8 13.5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.22 2.22L1.158 3.282L3.5 5.624C3.016 6.014 2.568 6.438 2.158 6.894L1.25 5.318C1.658 4.824 2.116 4.372 2.61 3.964L2.22 2.22ZM8 2.5C9.79 2.5 12.56 3.571 14.75 5.318L13.625 6.743C12.544 5.876 11.324 5.218 10.034 4.808L11.096 5.87C11.72 6.118 12.312 6.422 12.864 6.778L13.5 8.168C13.348 8.036 13.192 7.908 13.032 7.784L13.5 8.168L12.5 8.168L11.375 9.593C11.032 9.31 10.664 9.056 10.274 8.828L9.212 9.89C9.472 10.026 9.722 10.178 9.958 10.344L11.596 11.982L12.658 10.92L14.778 13.04L13.716 14.102L1.898 2.284L2.22 2.22ZM8 10.25C7.19 10.25 6.37 10.531 5.75 11.031L6.875 12.456C7.27 12.131 7.63 12 8 12C8.37 12 8.73 12.131 9.125 12.456L8.063 11.394C8.042 11.346 8.02 11.298 8 11.25V10.25ZM8 13.5C7.72 13.5 7.5 13.72 7.5 14C7.5 14.28 7.72 14.5 8 14.5C8.28 14.5 8.5 14.28 8.5 14C8.5 13.72 8.28 13.5 8 13.5ZM5.938 7.938L4.876 6.876C4.456 7.194 4.066 7.544 3.71 7.922L2.5 8.168L3.625 9.593C4.074 9.246 4.566 8.944 5.094 8.694L5.938 7.938Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const CalendarIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <rect x="2" y="3" width="12" height="11" rx="1" ry="1" />
...
export const LinkIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M10 5h2a3 3 0 0 1 3 3 3 3 0 0 1-3 3h-2m-4 0H4a3 3 0 0 1-3-3 3 3 0 0 1 3-3h2" />
