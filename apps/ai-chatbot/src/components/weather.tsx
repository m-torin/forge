...
/**
 * Interface for weather data at a specific location
 */
...
/**
 * Sample weather data for testing and fallback
 */
const SAMPLE = {
  latitude: 37.763283,
  longitude: -122.41286,
...
export function Weather({ weatherAtLocation = SAMPLE }: { weatherAtLocation?: WeatherAtLocation }) {
  ...
  // Use Mantine's useViewportSize instead of manual resize listeners
  ...
  const { displayTimes, displayTemperatures } = useMemo(() => {
