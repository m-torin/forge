...
export function GalleryLayout({
  ...
  const [selectedVariant, _setSelectedVariant] = useState<ProductVariant | null>(null);
  ...
  // Transform images for signed gallery
  const signedImages = images.map((img: any, index: number) => ({
    id: index,
    mediaId: img.mediaId,
    ...
    <div className="nc-ProductDetailPage2">
      ...
      <div className="relative">
        ...
        <div className="h-screen sticky top-0">
          <SignedListingImageGallery images={signedImages} />
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-4">
                    ...
                    {product.status && <ProductStatus status={product.status} />}
                  </div>
                  ...
                  <AccordionInfo
                    data={[
                      ...
                      },
                      {
                        ...
                        content: product.materials || 'Premium materials. Machine washable.',
                      },
                    ]}
                  />
                </div>
      ...
      {reviews && reviews.length > 0 && (
        <div className="container py-16">
          <Heading className="mb-8">{dict.product?.customerReviews || 'Customer Reviews'}</Heading>
      ...
      {relatedProducts && relatedProducts.length > 0 && (
        <div className="container py-16">
          <Heading className="mb-8">{dict.product?.youMayAlsoLike || 'You May Also Like'}</Heading>
