...
const LikeSaveBtns = (props: LikeSaveBtnsProps = {}) => {
  return (
    <ErrorBoundary
      fallback={
        <div className="flex gap-1">
          <button
            className="py-1.5 px-3 flex rounded-lg bg-neutral-100 cursor-not-allowed border-none"
            disabled
          >
