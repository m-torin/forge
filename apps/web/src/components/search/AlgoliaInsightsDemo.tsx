...
class AlgoliaInsights {
  ...
  clickedObjectIDsAfterSearch({
    ...
    try {
      ...
      console.error('[Algolia Insights] Failed to track click:', _error);
    }
  }
  ...
  convertedObjectIDsAfterSearch({
    ...
    try {
      ...
      console.error('[Algolia Insights] Failed to track conversion:', _error);
    }
  }
  ...
  viewedObjectIDs({
    ...
    try {
      ...
      console.error('[Algolia Insights] Failed to track view:', _error);
    }
  }
  ...
  getEvents() {
    try {
      ...
      console.error('[Algolia Insights] Failed to get events:', _error);
      return [];
    }
  }
}
...
function InsightfulProductCard({ hit, position }: { hit: any; position: number }) {
  ...
  const trackClick = useCallback(() => {
    try {
      ...
      console.error('Failed to track click:', _error);
    }
  }, [hit, position]);
  ...
  const trackAddToCart = useCallback(() => {
    try {
      ...
      console.error('Failed to track add to cart:', _error);
    }
  }, [hit]);
  ...
  React.useEffect(() => {
    try {
      ...
      console.error('Failed to track view on mount:', _error);
    }
  }, [trackView]);
