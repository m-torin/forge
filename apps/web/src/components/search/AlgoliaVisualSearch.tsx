...
function CameraCapture({
  ...
  const capturePhoto = () => {
    try {
      ...
      console.error('Failed to capture photo:', _error);
...
export default function AlgoliaVisualSearch({
  ...
  const performVisualSearch = useCallback(
    async (imageUrl: string) => {
      try {
        ...
        console.error('Visual search failed:', _error);
      ...
      if (file) {
        ...
        reader.onload = (e) => {
          try {
            ...
            console.error('Failed to process image:', _error);
  ...
  const clearSearch = () => {
    try {
      ...
      console.error('Failed to clear search:', _error);
                    ...
                    <Button
                      ...
                      onClick={() => {
                        try {
                          ...
                          console.error('Failed to open camera:', _error);
