  ...
  return [
    {
      ...
      author: {
        ...
        avatar: createImageObject(avatarImage1, 'Scott Walkinshaw'),
        description:
    ...
    },
    {
      ...
      author: {
        ...
        avatar: createImageObject(avatarImage2, 'Erica Alexander'),
        description:
    ...
    },
    {
      ...
      author: {
        name: 'Wellie Edwards',
        avatar: createImageObject(avatarImage3, 'Wellie Edwards'),
        description:
    ...
    },
    {
      ...
      author: {
        name: 'Alex Klein',
        avatar: createImageObject(avatarImage4, 'Alex Klein'),
        description:
    ...
    },
    {
      ...
      author: {
        name: 'Eden Birch',
        avatar: createImageObject(avatarImage1, 'Eden Birch'),
        description:
    ...
    },
    {
      ...
      author: {
        name: 'Scott Edwards',
        avatar: createImageObject(avatarImage2, 'Scott Edwards'),
        description:
