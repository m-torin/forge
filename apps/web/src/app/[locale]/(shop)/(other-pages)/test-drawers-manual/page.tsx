...
export default async function TestDrawersManualPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Stack gap="xl">
        <Alert color="blue" radius="md" title="Important">
          <Text>
            This page helps you manually test all drawer functionality. Use the
            header buttons to test cart and navigation drawers. Use the product
            cards below to test quick view drawers.
          </Text>
        </Alert>
          ...
          <Stack gap="md">
            <Card withBorder padding="sm" radius="sm">
              ...
              <Text className="mb-2" size="sm">
                Click the cart icon in the header (top right). The cart drawer
                should:
              </Text>
              <ul className="list-disc list-inside text-sm space-y-1 ml-4">
                ...
                <li>
                  Show 3 products (Basic Tee, Basic Coahuila, Nomad Tumbler)
                </li>
            ...
            <Card withBorder padding="sm" radius="sm">
              ...
              <Text className="mb-2" size="sm">
                Click the menu icon in the header (top right, near cart). The
                navigation drawer should:
              </Text>
              <ul className="list-disc list-inside text-sm space-y-1 ml-4">
                <li>Slide in from the right</li>
                ...
                <li>
                  Display navigation menu items (Home, Shop, Beauty, Sport,
                  Templates, Explore)
                </li>
            ...
            <Card withBorder padding="sm" radius="sm">
              ...
              <Text className="mb-2" size="sm">
                Hover over any product card below and click the "Quick view"
                button. The drawer should:
              </Text>
              <ul className="list-disc list-inside text-sm space-y-1 ml-4">
        ...
        <Card shadow="sm" withBorder padding="lg" radius="md">
          ...
          <Text color="dimmed" className="mb-4" size="sm">
            Hover over these products and click "Quick view" to test the product
            details drawer
          </Text>
          ...
          <Stack gap="sm">
            <div>
              ...
              <Text color="dimmed" size="sm">
                Should display cart items from getCart() function with product
            ...
            <div>
              ...
              <Text color="dimmed" size="sm">
                Should display navigation menu from getNavigation() function
            ...
            <div>
              ...
              <Text color="dimmed" size="sm">
                Should fetch and display full product details from
                getProductDetailByHandle() when quick view is clicked.
              </Text>
            </div>
          </Stack>
        </Card>

        <Card shadow="sm" withBorder bg="gray.0" padding="lg" radius="md">
          <Title order={3} className="mb-4">
            Troubleshooting
          </Title>
          <Text className="mb-2" size="sm">
          ...
          <ul className="list-decimal list-inside text-sm space-y-1 ml-4">
            ...
            <li>
              Verify data fetching functions are working (getCart,
              getNavigation, getProductDetailByHandle)
            </li>
