    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            href="https://agrippan.sentry.io/issues/?project=4509465421086720"
            target="_blank"
          >
            Issues Page
          </a>
        ...
        <button
          onClick={async () => {
            if (!observability) {
              console.log("Observability not initialized");
              return;
            }

            // Log the beginning of the operation
            observability.log('info', 'Starting example frontend operation', {
              operation: "test",
            });
            ...
            try {
              ...
              observability.log('info', 'Completed example frontend operation');
            }
          }}
          type="button"
        >
        ...
        {hasSentError ? (
          <p className="success">
            Sample error was sent to observability providers.
          </p>
        ) : (
