...
- Name: Authentication >> should navigate between sign in and sign up
- Location: /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:31:7
...
Call log:
  - waiting for getByRole('link', { name: /sign up/i })
    ...
    at /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:36:22
```
