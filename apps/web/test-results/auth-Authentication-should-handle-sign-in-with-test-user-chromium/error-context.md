...
- Name: Authentication >> should handle sign in with test user
- Location: /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:55:7
...
Call log:
  - waiting for locator('input[type="email"]')
    ...
    at /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:62:16
```
