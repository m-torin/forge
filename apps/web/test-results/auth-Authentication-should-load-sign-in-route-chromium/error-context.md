...
- Name: Authentication >> should load sign-in route
- Location: /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:34:7
...
Call log:
  - navigating to "http://localhost:3200/sign-in", waiting until "load"

    at /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:35:33
```
