...
- Name: Authentication >> should show sign up page
- Location: /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:22:7
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /sign up/i })
    ...
    at /Users/torin/repos/new--/forge/apps/web/e2e/auth.spec.ts:26:67
```
