...
const workflows = [
  {
    ...
    tags: ['Task Queue', 'Validation', 'Batch Processing'],
    title: 'Basic',
  },
  {
    id: 'kitchen-sink',
    ...
    tags: ['ETL', 'Order Processing', 'Advanced'],
    title: 'Kitchen Sink',
  },
  {
    id: 'image-processing',
    ...
    endpoint: '/api/workflows/image-processing',
    ...
    tags: ['Media', 'Sharp', 'Image Processing'],
...
export default function WorkersPage() {
  ...
  const payloadsMap = useMap<string, string>(
    workflows.map((w) => [w.id, JSON.stringify(w.example, null, 2)]),
  );
              ...
              <Stack gap="lg">
                ...
                <Group justify="space-between">
                  <Text c="dimmed" size="sm">
                    Click "Run" to execute a workflow, or "Customize" to edit the payload first.
                  </Text>
                  <Button
                    leftSection={<IconPlayerPlay size={14} />}
                    onClick={() => {
                      workflows.forEach((w) => triggerWorkflowWithExample(w));
                    }}
                    size="xs"
                    variant="subtle"
                  >
