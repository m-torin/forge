...
export function ProductInfo({ 
  ...
  const { title, price, rating, reviewNumber, status, options, selectedOptions, featuredImage, handle } = product
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <a href="#reviews" className="flex items-center text-sm font-medium">
              ...
              <div className="ms-1.5 flex">
                ...
                <span className="text-neutral-600 underline dark:text-neutral-400">{reviewNumber} {dict.product.reviews}</span>
              </div>
            </a>
            <span>·</span>
            ...
            {showAffiliateSellers && (
              <>
                <span>·</span>
                <span className="text-sm text-neutral-600 dark:text-neutral-400">{sellers.length} {dict.product.sellers}</span>
              </>
            )}
          </div>
        </div>
