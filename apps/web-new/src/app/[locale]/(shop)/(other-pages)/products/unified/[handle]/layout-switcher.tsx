...
export function LayoutSwitcher({ layoutType, setLayoutType }: LayoutSwitcherProps) {
  return (
    <div className="container mb-8">
      <div className="flex items-center justify-center gap-4 rounded-lg border border-neutral-200 bg-white p-2 dark:border-neutral-700 dark:bg-neutral-800">
        <span className="text-sm font-medium text-neutral-600 dark:text-neutral-400">Layout:</span>
