...
const VerifyIcon: FC<VerifyIconProps> = ({ className = 'ml-1', iconClass = 'w-5 h-5' }) => {
  return (
    <span className={className} data-testid="verify-icon-span">
      <svg className={iconClass} viewBox="0 0 17 17" fill="none" data-testid="verify-icon-svg">
        <path
          ...
          data-testid="verify-icon-badge-path"
        />
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          data-testid="verify-icon-checkmark-path"
        />
      </svg>
    </span>
  );
