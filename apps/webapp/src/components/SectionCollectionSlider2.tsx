      ...
      <div className="embla" ref={emblaRef}>
        <div className="embla__container -ms-5 sm:-ms-8">
          ...
          <div className="embla__slide basis-[86%] ps-5 sm:ps-8 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
            <div className="aspect-w-1 aspect-h-1 group relative h-0 w-full flex-1 overflow-hidden rounded-2xl bg-neutral-100">
              <div>
              ...
              >
                <span className="sr-only">View all collections</span>
              </Link>
            </div>
          </div>
        </div>
