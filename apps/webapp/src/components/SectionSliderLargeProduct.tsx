...
const SectionSliderLargeProduct: FC<SectionSliderLargeProductProps> = ({
  ...
  return (
    <div className={`nc-SectionSliderLargeProduct ${className}`}>
      ...
      <div data-testid="embla-container" className="embla" ref={emblaRef}>
        <div data-testid="embla-slides" className="embla__container -ms-5 sm:-ms-8">
          ...
          >
            <div
              data-testid="more-items-background"
              className="relative h-[410px] overflow-hidden rounded-2xl"
            >
              <div className="h-[410px] bg-black/5 dark:bg-neutral-800" />
              <div
                data-testid="more-items-content"
                className="absolute inset-x-10 inset-y-6 flex flex-col items-center justify-center"
              >
