  ...
  const renderItem = (index: number) => {
    ...
    return (
      ...
      >
        ...
        <div className="fade--animation__left relative flex max-w-5xl flex-1/2 flex-col items-start">
        ...
        <div className="relative -z-10 flex-1/2 lg:pr-10">
          <Image
            ...
            className="fade--animation__image h-auto w-full max-w-[40rem] object-contain select-none"
            src={item.imageUrl}
            alt={item.heading}
            width={790}
            height={790}
