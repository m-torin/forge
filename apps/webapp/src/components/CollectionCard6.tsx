...
const CollectionCard6: FC<CollectionCard6Props> = ({ className = '', bgSvgUrl, collection }) => {
  ...
  return (
    <div
      className={`aspect-w-1 aspect-h-1 hover:nc-shadow-lg group relative h-0 w-full overflow-hidden rounded-3xl bg-white transition-shadow dark:bg-neutral-900 ${className}`}
    >
      <div>
        <div className="absolute inset-0 opacity-10">
          {bgSvgUrl && <Image src={bgSvgUrl} alt="svgbg" fill />}
        </div>
