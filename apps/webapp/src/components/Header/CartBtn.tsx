...
export default function CartBtn({ 'data-testid': testId = 'cart-btn' }: Props = {}) {
  ...
  return (
    <button
      ...
      data-testid={testId}
    >
      <div className="bg-primary-500 dark:bg-primary-600 absolute top-2 right-1.5 flex h-4 w-4 items-center justify-center rounded-full text-[10px] leading-none font-medium text-white">
