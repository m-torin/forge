  ...
  return (
    <Headless.RadioGroup
      ...
      className={clsx(
        className,
        // Basic groups
        '**:data-[slot=label]:font-normal space-y-4',
        // With descriptions
  ...
  return (
    <Headless.Field
      ...
      className={clsx(
        ...
        // Control layout
        '*:data-[slot=control]:mt-0.75 *:data-[slot=control]:col-start-1 *:data-[slot=control]:row-start-1',
        // Label layout
...
const base = [
  // Basic layout
  'relative isolate flex size-[1.1875rem] shrink-0 rounded-full',
