  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'has-data-focus:after:ring-2 has-data-focus:after:ring-blue-500 after:pointer-events-none after:absolute after:inset-0 after:rounded-full after:ring-inset after:ring-transparent',
        // Disabled state
    ...
    >
      <Headless.Select
        ...
        className={clsx([
          // Basic layout
          'relative block w-full appearance-none rounded-full py-[calc(--spacing(2.5)-1px)]',
          // Horizontal padding
          multiple
      ...
      {!multiple && (
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="group-has-data-disabled:stroke-zinc-600 size-5 stroke-zinc-500 sm:size-4 dark:stroke-zinc-400 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
