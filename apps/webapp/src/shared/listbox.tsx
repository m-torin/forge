    ...
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        <Headless.ListboxSelectedOption
          ...
          options={options}
          placeholder={
            placeholder && <span className="block truncate text-neutral-500">{placeholder}</span>
          }
          className={clsx([
            // Basic layout
            ...
            // Border
            'group-data-active:border-neutral-950/20 group-data-hover:border-neutral-950/20 dark:group-data-active:border-white/20 dark:group-data-hover:border-white/20 border border-neutral-950/10 dark:border-white/10',
            // Background color
        ...
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="group-data-disabled:stroke-neutral-600 size-5 stroke-neutral-500 sm:size-4 dark:stroke-neutral-400 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
      ...
      <Headless.ListboxOptions
        ...
        className={clsx(
          ...
          // Shadows
          'shadow-lg ring-1 ring-neutral-950/10 dark:ring-inset dark:ring-white/10',
          // Transitions
...
export function ListboxDescription({
  ...
  return (
    <span
      ...
      className={clsx(
        className,
        'group-data-focus/option:text-white flex flex-1 overflow-hidden text-neutral-500 before:w-2 before:min-w-0 before:shrink dark:text-neutral-400',
      )}
    >
