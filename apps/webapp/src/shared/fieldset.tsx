...
export function Legend({
  ...
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        'text-sm/6 font-semibold text-neutral-950 data-disabled:opacity-50 dark:text-white',
      )}
    />
  );
}
...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'text-sm/6 text-neutral-500 data-disabled:opacity-50 dark:text-neutral-400',
      )}
    />
  );
}
