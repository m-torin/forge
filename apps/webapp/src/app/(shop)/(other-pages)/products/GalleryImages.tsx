          ...
          <div className="embla-thumbs__container flex">
            {images.map((image, index) => (
              <button
                key={image}
                className={clsx(
                  'relative flex aspect-5/3 w-24 shrink-0 cursor-pointer items-center justify-center border-0 bg-transparent p-0 transition-[transform,filter] duration-300 ease-in-out',
                  index === selectedIndex
...
const HeaderGalleryGrid1 = ({
  ...
  return (
    <header className="relative md:grid md:grid-cols-4 md:gap-6">
      <div
        className="relative aspect-4/5 size-full md:col-span-2 md:aspect-4/4"
      ...
      <div className="hidden md:col-span-2 md:grid md:grid-cols-2 md:gap-6">
        {images.slice(1, 5).map((item, index) => (
          <div
            className="relative aspect-2/2 size-full"
            key={item}
...
const HeaderGalleryGrid2 = ({
  ...
  return (
    <header className="relative md:grid md:grid-cols-4">
      <div
        className="relative aspect-4/5 size-full md:col-span-3 md:aspect-5/4"
        onClick={() => handleOpenDialog(0)}
        onKeyDown={e => {
          if (e.key === 'Enter' || e.key === ' ') {
            e.preventDefault();
      ...
      <div className="hidden md:grid md:grid-cols-1 md:gap-4 md:ps-4">
        {images.slice(1, 4).map((item, index) => (
          <div
            className="relative aspect-3/2 size-full"
            key={item}
            onClick={() => handleOpenDialog(index + 1)}
            onKeyDown={e => {
              if (e.key === 'Enter' || e.key === ' ') {
...
const HeaderGalleryGrid3 = ({
  ...
  return (
    <header className="relative md:grid md:grid-cols-3 md:gap-6">
      <div
        className="relative aspect-4/5 size-full md:aspect-3/4"
        onClick={() => handleOpenDialog(0)}
        onKeyDown={e => {
          if (e.key === 'Enter' || e.key === ' ') {
            e.preventDefault();
      ...
      <div
        className="relative hidden size-full md:block md:aspect-3/4"
...
const HeaderGalleryGrid4 = ({
  ...
  return (
    <header className="relative md:grid md:grid-cols-3 md:gap-6">
      ...
      <div
        className="relative hidden aspect-4/5 size-full md:block md:aspect-3/4"
        onClick={() => handleOpenDialog(3)}
        onKeyDown={e => {
          if (e.key === 'Enter' || e.key === ' ') {
            e.preventDefault();
