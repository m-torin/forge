        ...
        <header className="mx-auto -mt-10 flex max-w-2xl flex-col lg:-mt-7">
          <Form action={handleFormSubmit} className="relative w-full">
            <fieldset className="text-neutral-500 dark:text-neutral-300">
              ...
              />
              <input
                className="focus:border-primary-300 focus:ring-primary-200/50 dark:focus:ring-primary-600/25 block w-full rounded-full border bg-white py-4 pr-5 pl-12 placeholder:text-zinc-500 focus:ring-3 sm:py-5 sm:text-sm md:pl-15 dark:bg-neutral-800 dark:placeholder:text-zinc-400"
                id="search-input"
                type="search"
