...
const PageSubcription = () => {
  const renderPricingItem = (pricing: PricingItem, _index: number) => {
    return (
      <div
        key={pricing.name}
      ...
      >
        {pricing.isPopular && (
          <span className="bg-primary-500 absolute top-3 right-3 z-10 rounded-full px-3 py-1 text-xs tracking-widest text-white">
            POPULAR
          </span>
        )}
        <div className="mb-8">
