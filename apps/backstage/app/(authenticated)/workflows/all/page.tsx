...
export default function AllWorkflowsPage() {
  ...
  // Tag options for filter (top 20)
  const tagOptions = useMemo(() => {
    if (!stats) return [];
    return stats.popularTags.slice(0, 20).map((tag: any) => ({
      ...
      <Stack gap="xl">
        ...
        <Card shadow="sm" withBorder={true} padding="lg">
          <Stack gap="md">
            <Group justify="space-between">
              ...
              <Button component={Link} href="/workflows" variant="subtle">
                Back to Overview
              </Button>
            </Group>
              ...
              <Table.Tbody>
                {filteredWorkflows.map((workflow) => (
                  <Table.Tr key={workflow.id}>
                    ...
                    <Table.Td>
                      <Badge color={getCategoryColor(workflow.category)} variant="light">
                        {workflow.category}
                      </Badge>
                    </Table.Td>
                    <Table.Td>
                    ...
                    <Table.Td>
                      <Group gap={4}>
                        {workflow.tags.slice(0, 3).map((tag: any) => (
        ...
        <Card shadow="sm" withBorder={true} padding="lg">
          <Stack gap="md">
            ...
            <Group gap="sm">
              {stats.popularTags.slice(0, 15).map((tag: any) => (
                <Badge
                  key={tag.tag}
