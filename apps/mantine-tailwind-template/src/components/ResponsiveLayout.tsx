...
export function ResponsiveLayout({ children, sidebar, auth }: ResponsiveLayoutProps) {
  ...
  const useModernLayout = capabilities.hasContainerQueries && capabilities.hasSubgrid;
  const useAdvancedBackdrop = capabilities.hasBackdropFilter && capabilities.hasColorMix;
  const animationDuration = capabilities.prefersReducedMotion ? '0.01s' : '300ms';
      ...
      >
        ...
        <aside
          ...
          style={{
            ...
            containIntrinsicSize: capabilities.hasContainerQueries ? '320px auto' : undefined,
