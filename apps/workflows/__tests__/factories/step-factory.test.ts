...
describe('StepFactory', () => {
  ...
  describe('step creation', () => {
    ...
    it('should throw error if no templateId provided', () => {
      ...
      expect(() => factory.createStep(config)).toThrow('Step must have a templateId or extends property')
    })
  ...
  describe('composite steps', () => {
    ...
    it('should handle errors in composite steps', async () => {
      ...
      factory.createStep({ id: 'failing-step', name: 'Failing Step', templateId: 'failing-template' })

      const compositeStep = factory.composeSteps(
        'composite-with-error',
        'Composite with Error',
  ...
  describe('loop steps', () => {
    beforeEach(() => {
      ...
      factory.createStep({ id: 'process-step', name: 'Process Step', templateId: 'process-template' })
    })
    ...
    it('should handle errors in loop steps', async () => {
      ...
      factory.registerTemplate(failingTemplate)
      factory.createStep({ id: 'failing-process-step', name: 'Failing Process Step', templateId: 'failing-process' })
