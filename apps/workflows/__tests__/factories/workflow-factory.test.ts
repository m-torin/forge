...
import { WorkflowFactory, WorkflowTemplate, WorkflowFactoryConfig } from '@/lib/factories/workflow-factory'
...
describe('WorkflowFactory', () => {
  ...
  describe('template registration', () => {
    ...
    it('should warn when overwriting a template', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Workflow template test-workflow-template is being overwritten')
  ...
  describe('workflow creation', () => {
    ...
    it('should throw error if template not found', () => {
      ...
      expect(() => factory.createWorkflow(config)).toThrow('Workflow template not found: non-existent')
    })
  ...
  describe('workflow handler execution', () => {
    ...
    it('should handle step dependencies in execution', async () => {
      ...
      expect(executionOrder).toEqual(['my-workflow_step_1', 'my-workflow_step_2', 'my-workflow_step_3'])
    })
  ...
  describe('workflow management', () => {
    ...
    it('should throw error when cloning non-existent workflow', () => {
      expect(() => factory.cloneWorkflow('non-existent', {}))
        .toThrow('Workflow not found: non-existent')
    })
  })
