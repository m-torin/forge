...
const PaymentMethod: FC<Props> = ({ isActive, onCloseActive, onOpenActive }) => {
    ...
    return (
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          <label htmlFor="Credit-Card" className="flex items-center space-x-4 sm:space-x-6">
            <div
              className={`rounded-xl border-2 p-2.5 ${
                active ? 'border-neutral-600 dark:border-neutral-300' : 'border-gray-200 dark:border-neutral-600'
              }`}
            >
          ...
          <div className={`mt-6 mb-4 space-y-3 sm:space-y-5 ${active ? 'block' : 'hidden'}`}>
            ...
            <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
              ...
              <div className="flex-1">
                ...
                <Input autoComplete="off" className="mt-1.5" placeholder="CVC" />
              </div>
            </div>
          </div>
        </div>
  ...
  const renderInterNetBanking = () => {
    ...
    return (
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        />
        <div className="flex-1">
          <label htmlFor="Internet-banking" className="flex items-center space-x-4 sm:space-x-6">
            <div
              className={`rounded-xl border-2 p-2.5 ${
                active ? 'border-neutral-600 dark:border-neutral-300' : 'border-gray-200 dark:border-neutral-600'
              }`}
            >
              <svg className="h-6 w-6 sm:h-7 sm:w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className={`mt-6 mb-4 ${active ? 'block' : 'hidden'}`}>
            ...
            <ul className="mt-3.5 space-y-2 text-sm text-neutral-500 dark:text-neutral-400">
              <li>
                <h3 className="mb-1 text-base font-semibold text-neutral-800 dark:text-neutral-200">ChisNghiax</h3>
              </li>
              <li>
                {' '}
                Bank name: <span className="font-medium text-neutral-900 dark:text-neutral-200">Example Bank Name</span>
              </li>
              <li>
                {' '}
                Account number: <span className="font-medium text-neutral-900 dark:text-neutral-200">555 888 777</span>
              </li>
              <li>
                {' '}
                Sort code: <span className="font-medium text-neutral-900 dark:text-neutral-200">999</span>
              </li>
              <li>
                {' '}
                IBAN: <span className="font-medium text-neutral-900 dark:text-neutral-200">IBAN</span>
              </li>
              <li>
                {' '}
                BIC: <span className="font-medium text-neutral-900 dark:text-neutral-200">BIC/Swift</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  const renderWallet = () => {
    ...
    return (
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        />
        <div className="flex-1">
          <label htmlFor="Wallet" className="flex items-center space-x-4 sm:space-x-6">
            <div
              className={`rounded-xl border-2 p-2.5 ${
                active ? 'border-neutral-600 dark:border-neutral-300' : 'border-gray-200 dark:border-neutral-600'
              }`}
  ...
  const renderPaymentMethod = () => {
    return (
      <div className="rounded-xl border border-neutral-200 dark:border-neutral-700">
        ...
        <div
          className={`space-y-6 border-t border-neutral-200 px-6 py-7 dark:border-neutral-700 ${
