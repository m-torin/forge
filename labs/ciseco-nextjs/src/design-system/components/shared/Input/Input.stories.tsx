...
const meta: Meta<typeof Input> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A flexible input component with customizable styling, size, and rounded corners.',
      },
    },
    layout: 'centered',
  },
  ...
  render: () => (
    <div className="w-80 space-y-4">
      <div>
        ...
        <Input fontClass="text-xs font-normal" placeholder="Small input..." sizeClass="h-8 px-3 py-2" />
      </div>
      <div>
      ...
      <div>
        ...
        <Input fontClass="text-lg font-normal" placeholder="Large input..." sizeClass="h-14 px-6 py-4" />
      </div>
    </div>
  ),
}
...
export const DifferentRounds: Story = {
  render: () => (
    <div className="w-80 space-y-4">
      <div>
        <label className="mb-2 block text-sm font-medium">Square</label>
        <Input placeholder="Square corners..." rounded="rounded-none" />
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium">Small Rounded</label>
        <Input placeholder="Small rounded..." rounded="rounded" />
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium">Medium Rounded</label>
        <Input placeholder="Medium rounded..." rounded="rounded-lg" />
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium">Fully Rounded (Default)</label>
...
export const ValidationStates: Story = {
  render: () => (
    <div className="w-80 space-y-4">
      ...
      <div>
        <label className="mb-2 block text-sm font-medium text-green-700">Success</label>
        <Input
      ...
      <div>
        <label className="mb-2 block text-sm font-medium text-red-700">Error</label>
        <Input placeholder="Error state..." className="border-red-300 focus:border-red-500 focus:ring-red-200" />
      </div>
      <div>
        <label className="mb-2 block text-sm font-medium text-gray-500">Disabled</label>
