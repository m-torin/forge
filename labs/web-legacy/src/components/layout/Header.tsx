...
import { useAppLayout } from '@/react/AppLayoutContext';
    ...
    const handleSearchSelect = useCallback(
      (item: any, source: string) => {
        try {
          ...
          setInternalError('Failed to navigate');
        }
      },
      [router, locale],
    );
            ...
            <Container className="min-h-20 py-4" fluid>
              <Group h="100%" justify="space-between" px="md">
                ...
                <Group gap="md">
                  ...
                  <ErrorBoundary fallback={<Skeleton height={32} width={32} radius="xl" />}>
                    <CartButton locale={locale} numberItems={cartItemsCount} onClick={openCart} />
                  </ErrorBoundary>
                </Group>
              </Group>
            </Container>
