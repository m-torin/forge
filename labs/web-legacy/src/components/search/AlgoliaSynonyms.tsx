...
function SynonymEditor({
  ...
  const handleSave = () => {
    try {
      ...
      console.error('Failed to save synonym:', _error);
  ...
  const handleTypeChange = (value: string | null) => {
    try {
      ...
      console.error('Failed to change synonym type:', _error);
    ...
    try {
      ...
      words.forEach((word) => {
        try {
          ...
          console.error('Error processing word:', word, _error);
        }
      });
      ...
      console.error('Failed to test synonyms:', _error);
