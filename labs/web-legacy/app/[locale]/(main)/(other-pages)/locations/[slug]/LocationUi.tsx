...
function LocationSkeleton({ testId }: { testId?: string }) {
  return (
...
export function LocationUi({
  ...
  if (!mounted || isLoading) {
    return <LocationSkeleton testId={testId} />;
  }
  ...
  try {
    ...
    logger.error('LocationUi error', err);
    _setInternalError('Failed to render location products');
