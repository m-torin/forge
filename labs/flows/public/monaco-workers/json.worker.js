...
function format(documentText, range, options) {
  ...
  if (options.insertSpaces) {
    indentValue =
      cachedSpaces[options.tabSize || 4] ??
      repeat(cachedSpaces[1], options.tabSize || 4);
  } else {
    indentValue = '	';
  }
  ...
  while (firstToken !== 17) {
    ...
    if (secondToken === 2) {
      ...
      if (
        ...
        (!options.keepLines && firstToken !== 1)
      ) {
      ...
      if (
        (options.keepLines && numberLineBreaks > 0) ||
        (!options.keepLines && firstToken !== 3)
      ) {
        replaceContent = newLinesAndIndent();
      } else if (options.keepLines) {
        replaceContent = cachedSpaces[1];
...
(function (integer2) {
  ...
  function is(value) {
    return (
      typeof value === 'number' &&
      integer2.MIN_VALUE <= value &&
      value <= integer2.MAX_VALUE
    );
  }
  integer2.is = is;
})(integer || (integer = {}));
...
(function (uinteger2) {
  ...
  function is(value) {
    return (
      typeof value === 'number' &&
      uinteger2.MIN_VALUE <= value &&
      value <= uinteger2.MAX_VALUE
    );
  }
  uinteger2.is = is;
})(uinteger || (uinteger = {}));
  ...
  function is(value) {
    ...
    return (
      ...
      (Is.undefined(candidate.codeDescription) ||
        Is.string(
          (a = candidate.codeDescription) === null || a === void 0
            ? void 0
            : a.href,
        )) &&
...
(function (DeleteFile2) {
  function create(uri, options, annotation) {
    ...
    if (
      options !== void 0 &&
      (options.recursive !== void 0 || options.ignoreIfNotExists !== void 0)
    ) {
      result.options = options;
    }
    if (annotation !== void 0) {
...
(function (MarkupKind2) {
  ...
  function is(value) {
    const candidate = value;
    return (
      candidate === MarkupKind2.PlainText || candidate === MarkupKind2.Markdown
    );
  }
  MarkupKind2.is = is;
    ...
    return (
      ...
      (Is.typedArray(candidate.textEdits, TextEdit.is) &&
        (candidate.tooltip === void 0 ||
          Is.string(candidate.tooltip) ||
          MarkupContent.is(candidate.tooltip)) &&
        (candidate.paddingLeft === void 0 ||
          Is.boolean(candidate.paddingLeft)) &&
        (candidate.paddingRight === void 0 ||
...
(function (Is2) {
  ...
  function numberRange(value, min, max) {
    return (
      toString.call(value) === '[object Number]' && min <= value && value <= max
    );
  }
...
var FullTextDocument2 = class FullTextDocument {
  constructor(uri, languageId, version, content) {
    this._uri = uri;
    this._languageId = languageId;
    this._version = version;
...
(function (ErrorCode2) {
  ...
  ErrorCode2[(ErrorCode2['UnexpectedEndOfComment'] = 257)] =
    'UnexpectedEndOfComment';
  ErrorCode2[(ErrorCode2['UnexpectedEndOfString'] = 258)] =
    'UnexpectedEndOfString';
  ErrorCode2[(ErrorCode2['UnexpectedEndOfNumber'] = 259)] =
    'UnexpectedEndOfNumber';
  ErrorCode2[(ErrorCode2['InvalidUnicode'] = 260)] = 'InvalidUnicode';
  ErrorCode2[(ErrorCode2['InvalidEscapeCharacter'] = 261)] =
    'InvalidEscapeCharacter';
  ...
  ErrorCode2[(ErrorCode2['CommaOrCloseBacketExpected'] = 517)] =
    'CommaOrCloseBacketExpected';
  ErrorCode2[(ErrorCode2['CommaOrCloseBraceExpected'] = 518)] =
  ...
  ErrorCode2[(ErrorCode2['PropertyKeysMustBeDoublequoted'] = 528)] =
    'PropertyKeysMustBeDoublequoted';
  ErrorCode2[(ErrorCode2['SchemaResolveError'] = 768)] = 'SchemaResolveError';
  ErrorCode2[(ErrorCode2['SchemaUnsupportedFeature'] = 769)] =
...
var SchemaCollector = class SchemaCollector {
  ...
  include(node) {
    return (
      (this.focusOffset === -1 || contains2(node, this.focusOffset)) &&
      node !== this.exclude
    );
  }
  newSub() {
...
var ValidationResult = class {
  ...
  mergeProcessedProperties(validationResult) {
    validationResult.processedProperties.forEach((p) =>
...
function validate(n, schema, validationResult, matchingSchemas, context) {
  ...
  switch (node.type) {
    case 'object':
      validateObjectNode(node);
      break;
    case 'array':
      validateArrayNode(node);
      break;
    case 'string':
      validateStringNode(node);
      break;
    case 'number':
      validateNumberNode(node);
      break;
  }
    ...
    if (Array.isArray(schema.type)) {
      if (!schema.type.some(matchesType)) {
        validationResult.problems.push({
          ...
          message:
            schema.errorMessage ||
            t('Incorrect type. Expected one of {0}.', schema.type.join(', ')),
        });
      }
    } else if (schema.type) {
      if (!matchesType(schema.type)) {
        validationResult.problems.push({
          ...
          message:
            schema.errorMessage ||
            t('Incorrect type. Expected "{0}".', schema.type),
        });
      }
    }
    ...
    if (notSchema) {
      ...
      if (!subValidationResult.hasProblems()) {
        validationResult.problems.push({
          location: { offset: node.offset, length: node.length },
          message:
            schema.errorMessage || t('Matches a schema that is not allowed.'),
        });
      }
    ...
    if (isDefined(schema.const)) {
      ...
      if (!equals(val, schema.const)) {
        validationResult.problems.push({
          ...
          message:
            schema.errorMessage ||
            t('Value must be {0}.', JSON.stringify(schema.const)),
        });
  ...
  function validateNumberNode(node2) {
  ...
  function validateStringNode(node2) {
    if (
      isNumber(schema.minLength) &&
      stringLength(node2.value) < schema.minLength
    ) {
      validationResult.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: t(
      ...
      if (!regex?.test(node2.value)) {
        validationResult.problems.push({
          ...
          message:
            ...
            schema.errorMessage ||
            t('String does not match the pattern of "{0}".', schema.pattern),
        });
      }
    }
    if (schema.format) {
            ...
            if (errorMessage) {
              validationResult.problems.push({
                ...
                message:
                  schema.patternErrorMessage ||
                  schema.errorMessage ||
                  t('String is not a URI: {0}', errorMessage),
              });
            }
          }
          break;
  ...
  function validateArrayNode(node2) {
    ...
    if (containsSchema) {
      ...
      if (containsCount === 0 && !isNumber(schema.minContains)) {
        validationResult.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message:
            schema.errorMessage || t('Array does not contain required item.'),
        });
      }
  ...
  function validateObjectNode(node2) {
    ...
    if (Array.isArray(schema.required)) {
      for (const propertyName of schema.required) {
        if (!seenKeys[propertyName]) {
          const keyNode =
            node2.parent &&
            node2.parent.type === 'property' &&
            node2.parent.keyNode;
          const location = keyNode
            ? { offset: keyNode.offset, length: keyNode.length }
            : { offset: node2.offset, length: 1 };
          validationResult.problems.push({
            location,
          ...
          if (isBoolean(propertySchema)) {
            if (!propertySchema) {
              ...
              validationResult.problems.push({
                ...
                message:
                  schema.errorMessage ||
                  t('Property {0} is not allowed.', propertyName),
              });
            } else {
    ...
    if (schema.dependentRequired) {
      for (const key in schema.dependentRequired) {
        ...
        if (prop && Array.isArray(propertyDeps)) {
          validatePropertyDependencies(key, propertyDeps);
        }
      }
    }
    ...
    if (schema.dependencies) {
      for (const key in schema.dependencies) {
        const prop = seenKeys[key];
        if (prop) {
          validatePropertyDependencies(key, schema.dependencies[key]);
        }
      }
    }
    ...
    function validatePropertyDependencies(key, propertyDep) {
...
function parse3(textDocument, config) {
  ...
  function checkScanError() {
    switch (scanner.getTokenError()) {
      case 4:
        error(
          t('Invalid unicode sequence in string.'),
          ErrorCode.InvalidUnicode,
        );
        return true;
      case 5:
        error(
          t('Invalid escape character in string.'),
          ErrorCode.InvalidEscapeCharacter,
        );
        return true;
      case 3:
        error(t('Unexpected end of number.'), ErrorCode.UnexpectedEndOfNumber);
        return true;
      case 1:
        error(
          t('Unexpected end of comment.'),
          ErrorCode.UnexpectedEndOfComment,
        );
        return true;
      case 2:
        error(t('Unexpected end of string.'), ErrorCode.UnexpectedEndOfString);
        return true;
      case 6:
        error(
          t(
  ...
  function finalize(node, scanNext) {
    node.length =
  ...
  function parseArray(parent) {
    ...
    while (scanner.getToken() !== 4 && scanner.getToken() !== 17) {
      if (scanner.getToken() === 5) {
        if (!needsComma) {
          error(t('Value expected'), ErrorCode.ValueExpected);
        }
        ...
        error(t('Expected comma'), ErrorCode.CommaExpected);
      }
      const item = parseValue(node);
      if (!item) {
        error(
          t('Value expected'),
    ...
    if (scanner.getToken() !== 4) {
      return error(
        t('Expected comma or closing bracket'),
        ErrorCode.CommaOrCloseBacketExpected,
        node,
      );
    }
    return finalize(node, true);
  }
  const keyPlaceholder = new StringASTNodeImpl(void 0, 0, 0);
  function parseProperty(parent, keysSeen) {
    const node = new PropertyASTNodeImpl(
      parent,
      scanner.getTokenOffset(),
      keyPlaceholder,
    );
    let key = parseString(node);
    if (!key) {
      if (scanner.getToken() === 16) {
        error(
          t('Property keys must be doublequoted'),
          ErrorCode.PropertyKeysMustBeDoublequoted,
        );
    ...
    if (scanner.getToken() === 6) {
      ...
      error(t('Colon expected'), ErrorCode.ColonExpected);
      if (
        scanner.getToken() === 10 &&
  ...
  function parseObject(parent) {
    ...
    while (scanner.getToken() !== 2 && scanner.getToken() !== 17) {
      if (scanner.getToken() === 5) {
        if (!needsComma) {
          error(t('Property expected'), ErrorCode.PropertyExpected);
        }
        const commaOffset = scanner.getTokenOffset();
        scanNext();
        if (scanner.getToken() === 2) {
      ...
      const property = parseProperty(node, keysSeen);
      if (!property) {
        error(
          t('Property expected'),
    ...
    if (scanner.getToken() !== 2) {
      return error(
        t('Expected comma or closing brace'),
    ...
    if (scanner.getTokenError() === 0) {
      ...
      try {
        ...
        if (!isNumber(numberValue)) {
          return error(t('Invalid number format.'), ErrorCode.Undefined, node);
        }
  ...
  if (token !== 17) {
    ...
    if (!root) {
      error(
        t('Expected a JSON object, array or literal.'),
        ErrorCode.Undefined,
      );
    } else if (scanner.getToken() !== 17) {
      error(t('End of file expected.'), ErrorCode.Undefined);
    }
  }
  return new JSONDocument(root, problems, commentRanges);
}
...
var JSONCompletion = class {
        ...
        if (!existing) {
          ...
          if (supportsCommitCharacters) {
            suggestion.commitCharacters =
              suggestion.kind === CompletionItemKind.Property
  ...
  getPropertyCompletions(
    ...
    matchingSchemas.forEach((s) => {
      if (s.node === node && !s.inverted) {
        ...
        if (
          typeof schemaPropertyNames === 'object' &&
          !schemaPropertyNames.deprecationMessage &&
          !schemaPropertyNames.doNotSuggest
        ) {
          const propertyNameCompletionItem = (
            name,
            enumDescription = void 0,
          ) => {
            const proposal = {
              kind: CompletionItemKind.Property,
              label: name,
              ...
              documentation:
                enumDescription ||
                this.fromMarkup(schemaPropertyNames.markdownDescription) ||
                schemaPropertyNames.description ||
                '',
            };
          ...
          if (schemaPropertyNames.enum) {
            for (let i = 0; i < schemaPropertyNames.enum.length; i++) {
              ...
              if (
                schemaPropertyNames.markdownEnumDescriptions &&
                i < schemaPropertyNames.markdownEnumDescriptions.length
              ) {
                enumDescription = this.fromMarkup(
                  schemaPropertyNames.markdownEnumDescriptions[i],
                );
              } else if (
                schemaPropertyNames.enumDescriptions &&
                i < schemaPropertyNames.enumDescriptions.length
              ) {
  ...
  getContributedValueCompletions(
    doc,
    node,
    offset,
    document,
    ...
    if (!node) {
      ...
      if (
        node &&
        node.type === 'property' &&
        offset > (node.colonOffset || 0)
      ) {
        const parentKey = node.keyNode.value;
        const valueNode = node.valueNode;
        if (
          (!valueNode || offset <= valueNode.offset + valueNode.length) &&
          node.parent
        ) {
      ...
      if (schema2) {
        const addSchemaProblem = (errorMessage, errorCode) => {
          if (jsonDocument.root && schemaRequest) {
            ...
            const property =
              astRoot.type === 'object' ? astRoot.properties[0] : void 0;
...
function colorFromHex(text) {
  ...
  switch (text.length) {
    ...
    case 7:
      return {
        red:
          (hexDigit(text.charCodeAt(1)) * 16 + hexDigit(text.charCodeAt(2))) /
          255,
        green:
          (hexDigit(text.charCodeAt(3)) * 16 + hexDigit(text.charCodeAt(4))) /
          255,
        blue:
          (hexDigit(text.charCodeAt(5)) * 16 + hexDigit(text.charCodeAt(6))) /
          255,
        alpha: 1,
      };
    case 9:
      return {
        ...
        blue:
          ...
          255,
        alpha:
          (hexDigit(text.charCodeAt(7)) * 16 + hexDigit(text.charCodeAt(8))) /
          255,
      };
  }
  return void 0;
...
var JSONDocumentSymbols = class {
  ...
  findDocumentSymbols(
    ...
    if (
      ...
      endsWith(resourceString.toLowerCase(), '/user/keybindings.json')
    ) {
      if (root.type === 'array') {
        const result2 = [];
...
(() => {
  ...
  var t2 = {
      470: (t3) => {
        function e2(t4) {
          if ('string' != typeof t4)
            throw new TypeError(
              'Path must be a string. Received ' + JSON.stringify(t4),
            );
        }
        function r2(t4, e3) {
          for (
            var r3, n3 = '', i = 0, o = -1, s = 0, h = 0;
            h <= t4.length;
            ++h
          ) {
        ...
        var n2 = {
          resolve: function () {
            for (
              var t4, n3 = '', i = false, o = arguments.length - 1;
              o >= -1 && !i;
              o--
            ) {
              var s;
              o >= 0
                ? (s = arguments[o])
                : (void 0 === t4 && (t4 = process.cwd()), (s = t4)),
                e2(s),
                0 !== s.length &&
                  ((n3 = s + '/' + n3), (i = 47 === s.charCodeAt(0)));
            }
            return (
              (n3 = r2(n3, !i)),
              i ? (n3.length > 0 ? '/' + n3 : '/') : n3.length > 0 ? n3 : '.'
            );
          },
          ...
          join: function () {
            ...
            for (var t4, r3 = 0; r3 < arguments.length; ++r3) {
              var i = arguments[r3];
              e2(i),
                i.length > 0 && (void 0 === t4 ? (t4 = i) : (t4 += '/' + i));
            }
          ...
          relative: function (t4, r3) {
            ...
            for (
              var o = t4.length, s = o - i, h = 1;
              h < r3.length && 47 === r3.charCodeAt(h);
              ++h
            );
            for (
              var a2 = r3.length - h, c = s < a2 ? s : a2, f2 = -1, u = 0;
              u <= c;
              ++u
            ) {
              if (u === c) {
            ...
            var g = '';
            for (u = i + f2 + 1; u <= o; ++u)
              (u !== o && 47 !== t4.charCodeAt(u)) ||
                (0 === g.length ? (g += '..') : (g += '/..'));
            return g.length > 0
              ? g + r3.slice(h + f2)
              : ((h += f2), 47 === r3.charCodeAt(h) && ++h, r3.slice(h));
          },
          ...
          basename: function (t4, r3) {
            ...
            if (void 0 !== r3 && r3.length > 0 && r3.length <= t4.length) {
              ...
              return (
                i === o ? (o = a2) : -1 === o && (o = t4.length), t4.slice(i, o)
              );
            }
            for (n3 = t4.length - 1; n3 >= 0; --n3)
          ...
          extname: function (t4) {
            e2(t4);
            for (
              var r3 = -1, n3 = 0, i = -1, o = true, s = 0, h = t4.length - 1;
              h >= 0;
              --h
            ) {
          ...
          parse: function (t4) {
            ...
            o ? ((r3.root = '/'), (n3 = 1)) : (n3 = 0);
            for (
              var s = -1, h = 0, a2 = -1, c = true, f2 = t4.length - 1, u = 0;
              f2 >= n3;
              --f2
            )
              if (47 !== (i = t4.charCodeAt(f2)))
                -1 === a2 && ((c = false), (a2 = f2 + 1)),
                  46 === i
                    ? -1 === s
                      ? (s = f2)
                      : 1 !== u && (u = 1)
            ...
            return (
              ...
              (1 === u && s === a2 - 1 && s === h + 1)
                ? -1 !== a2 &&
                  (r3.base = r3.name =
                    0 === h && o ? t4.slice(1, a2) : t4.slice(h, a2))
                : (0 === h && o
                    ? ((r3.name = t4.slice(1, s)), (r3.base = t4.slice(1, a2)))
                    : ((r3.name = t4.slice(h, s)), (r3.base = t4.slice(h, a2))),
                  (r3.ext = t4.slice(s, a2))),
              h > 0 ? (r3.dir = t4.slice(0, h - 1)) : o && (r3.dir = '/'),
              r3
            );
          },
          sep: '/',
  ...
  (r.d = (t3, e2) => {
    for (var n2 in e2)
      r.o(e2, n2) &&
        !r.o(t3, n2) &&
        Object.defineProperty(t3, n2, { enumerable: true, get: e2[n2] });
  }),
    (r.o = (t3, e2) => Object.prototype.hasOwnProperty.call(t3, e2)),
    (r.r = (t3) => {
  ...
  (() => {
    ...
    function s(t4, r2) {
      if (!t4.scheme && r2)
        throw new Error(
          `[UriError]: Scheme is missing: {scheme: "", authority: "${t4.authority}", path: "${t4.path}", query: "${t4.query}", fragment: "${t4.fragment}"}`,
        );
    ...
    class f2 {
      static isUri(t4) {
        return (
          t4 instanceof f2 ||
          (!!t4 &&
            'string' == typeof t4.authority &&
            'string' == typeof t4.fragment &&
            'string' == typeof t4.path &&
            'string' == typeof t4.query &&
            'string' == typeof t4.scheme &&
            'string' == typeof t4.fsPath &&
            'function' == typeof t4.with &&
            'function' == typeof t4.toString)
        );
      }
      scheme;
      authority;
      ...
      constructor(t4, e3, r2, n2, i2, o2 = false) {
        'object' == typeof t4
          ? ((this.scheme = t4.scheme || h),
            (this.authority = t4.authority || h),
            (this.path = t4.path || h),
            (this.query = t4.query || h),
            (this.fragment = t4.fragment || h))
          : ((this.scheme = /* @__PURE__ */ (function (t5, e4) {
              return t5 || e4 ? t5 : 'file';
            })(t4, o2)),
            (this.authority = e3 || h),
            (this.path = (function (t5, e4) {
              switch (t5) {
                case 'https':
                case 'http':
                case 'file':
      ...
      with(t4) {
        ...
        return (
          void 0 === e3 ? (e3 = this.scheme) : null === e3 && (e3 = h),
          void 0 === r2 ? (r2 = this.authority) : null === r2 && (r2 = h),
          void 0 === n2 ? (n2 = this.path) : null === n2 && (n2 = h),
          void 0 === i2 ? (i2 = this.query) : null === i2 && (i2 = h),
          void 0 === o2 ? (o2 = this.fragment) : null === o2 && (o2 = h),
          e3 === this.scheme &&
          r2 === this.authority &&
          n2 === this.path &&
          i2 === this.query &&
      ...
      static file(e3) {
        let r2 = h;
        if (
          (t3 && (e3 = e3.replace(/\\/g, a2)), e3[0] === a2 && e3[1] === a2)
        ) {
          const t4 = e3.indexOf(a2, 2);
          -1 === t4
            ? ((r2 = e3.substring(2)), (e3 = a2))
            : ((r2 = e3.substring(2, t4)), (e3 = e3.substring(t4) || a2));
        }
      ...
      static revive(t4) {
        if (t4) {
          if (t4 instanceof f2) return t4;
          {
            const e3 = new l(t4);
            return (
              (e3._formatted = t4.external),
              (e3._fsPath = t4._sep === u ? t4.fsPath : null),
              e3
            );
          }
        }
    ...
    class l extends f2 {
      ...
      toString(t4 = false) {
        return t4
          ? y(this, true)
          : (this._formatted || (this._formatted = y(this, false)),
            this._formatted);
      }
      toJSON() {
        const t4 = { $mid: 1 };
        return (
          this._fsPath && ((t4.fsPath = this._fsPath), (t4._sep = u)),
          this._formatted && (t4.external = this._formatted),
          this.path && (t4.path = this.path),
          this.scheme && (t4.scheme = this.scheme),
          this.authority && (t4.authority = this.authority),
          this.query && (t4.query = this.query),
          this.fragment && (t4.fragment = this.fragment),
          t4
        );
      }
    }
    ...
    function d(t4, e3, r2) {
      ...
      for (let o2 = 0; o2 < t4.length; o2++) {
        ...
        if (
          ...
          -1 !== i2 &&
            ((n2 += encodeURIComponent(t4.substring(i2, o2))), (i2 = -1)),
            void 0 !== n2 && (n2 += t4.charAt(o2));
        else {
      ...
      return (
        -1 !== i2 && (n2 += encodeURIComponent(t4.substring(i2))),
        void 0 !== n2 ? n2 : t4
      );
    }
    function p(t4) {
      ...
      for (let r2 = 0; r2 < t4.length; r2++) {
        ...
        35 === n2 || 63 === n2
          ? (void 0 === e3 && (e3 = t4.substr(0, r2)), (e3 += g[n2]))
          : void 0 !== e3 && (e3 += t4[r2]);
      }
    ...
    function m(e3, r2) {
      ...
      return (
        (n2 =
          e3.authority && e3.path.length > 1 && 'file' === e3.scheme
            ? `//${e3.authority}${e3.path}`
            : 47 === e3.path.charCodeAt(0) &&
                ((e3.path.charCodeAt(1) >= 65 && e3.path.charCodeAt(1) <= 90) ||
                  (e3.path.charCodeAt(1) >= 97 &&
                    e3.path.charCodeAt(1) <= 122)) &&
                58 === e3.path.charCodeAt(2)
              ? r2
                ? e3.path.substr(1)
                : e3.path[1].toLowerCase() + e3.path.substr(2)
              : e3.path),
        t3 && (n2 = n2.replace(/\//g, '\\')),
        n2
      );
    ...
    function y(t4, e3) {
      const r2 = e3 ? p : d;
      let n2 = '',
        { scheme: i2, authority: o2, path: s2, query: h2, fragment: c2 } = t4;
      if (
        (i2 && ((n2 += i2), (n2 += ':')),
        (o2 || 'file' === i2) && ((n2 += a2), (n2 += a2)),
        o2)
      ) {
        let t5 = o2.indexOf('@');
        if (-1 !== t5) {
          ...
          (o2 = o2.substr(t5 + 1)),
            (t5 = e4.lastIndexOf(':')),
            -1 === t5
              ? (n2 += r2(e4, false, false))
              : ((n2 += r2(e4.substr(0, t5), false, false)),
                (n2 += ':'),
                (n2 += r2(e4.substr(t5 + 1), false, true))),
            (n2 += '@');
        }
        (o2 = o2.toLowerCase()),
          (t5 = o2.lastIndexOf(':')),
          -1 === t5
            ? (n2 += r2(o2, false, true))
            : ((n2 += r2(o2.substr(0, t5), false, true)),
              (n2 += o2.substr(t5)));
      }
      if (s2) {
        if (
          ...
          t5 >= 65 &&
            t5 <= 90 &&
            (s2 = `/${String.fromCharCode(t5 + 32)}:${s2.substr(3)}`);
        } else if (s2.length >= 2 && 58 === s2.charCodeAt(1)) {
          const t5 = s2.charCodeAt(0);
          t5 >= 65 &&
            t5 <= 90 &&
            (s2 = `${String.fromCharCode(t5 + 32)}:${s2.substr(2)}`);
        }
        n2 += r2(s2, true, false);
      }
      return (
        h2 && ((n2 += '?'), (n2 += r2(h2, false, false))),
        c2 && ((n2 += '#'), (n2 += e3 ? c2 : d(c2, false, false))),
        n2
      );
    }
    function v(t4) {
    ...
    !(function (t4) {
      (t4.joinPath = function (t5, ...e3) {
        ...
        (t4.resolvePath = function (t5, ...e3) {
          ...
          return (
            n2 && i2[0] === x && !t5.authority && (i2 = i2.substring(1)),
            t5.with({ path: i2 })
          );
        }),
        (t4.dirname = function (t5) {
          ...
          return (
            1 === e3.length && 46 === e3.charCodeAt(0) && (e3 = ''),
            t5.with({ path: e3 })
          );
        }),
...
var JSONSchemaService = class {
  ...
  onResourceChange(uri) {
    ...
    uri = normalizeId(uri);
    const toWalk = [uri];
    const all = Object.keys(this.schemasById).map(
      (key) => this.schemasById[key],
    );
    while (toWalk.length) {
  ...
  resolveSchemaContent(schemaToResolve, handle) {
      ...
      this.traverseNodes(node, (next) => {
        ...
        while (next.$ref) {
          ...
          if (segments[0].length > 0) {
            openPromises.push(
              resolveExternalLink(next, segments[0], segments[1], parentHandle),
            );
            return;
          } else {
            if (!seenRefs.has(ref)) {
    ...
    const collectAnchors = (root) => {
      ...
      this.traverseNodes(root, (next) => {
        ...
        const anchor =
          isString(id) && id.charAt(0) === '#' ? id.substring(1) : next.$anchor;
        if (anchor) {
          if (result.has(anchor)) {
            resolveErrors.push(
              t("Duplicate anchor declaration: '{0}'", anchor),
            );
          } else {
      ...
      for (const p of document.root.properties) {
        if (p.keyNode.value === '$schema' && p.valueNode?.type === 'string') {
          ...
          if (this.contextService && !/^\w[\w\d+.-]*:/.test(schemaId)) {
            schemaId = this.contextService.resolveRelativePath(
              schemaId,
              resource,
            );
          }
  ...
  getMatchingSchemas(document, jsonDocument, schema) {
    if (schema) {
      const id =
        schema.id || 'schemaservice://untitled/matchingSchemas/' + idCounter2++;
    ...
    return this.getSchemaForResource(document.uri, jsonDocument).then(
      (schema2) => {
        if (schema2) {
          return jsonDocument
            .getMatchingSchemas(schema2.schema)
            .filter((s) => !s.inverted);
        }
        return [];
      },
...
',
  ...
  return format2(documentToFormat.getText(), range, options).map((edit) => {
    return TextEdit.replace(
      Range.create(
        documentToFormat.positionAt(edit.offset),
        documentToFormat.positionAt(edit.offset + edit.length),
      ),
      edit.content,
    );
  });
  ...
  addChildProperty(childProperty) {
    ...
    if (this.childrenProperties.length > 0) {
      ...
      if (childProperty.noKeyName) {
        ...
        insertionIndex = binarySearchOnPropertyArray(
          this.childrenProperties,
          childProperty,
          compareProperties,
        );
...
function binarySearchOnPropertyArray(
  propertyTreeArray,
  propertyTree,
  compare_fn,
) {
  ...
  const lastPropertyInArrayName =
    propertyTreeArray[propertyTreeArray.length - 1].propertyName.toLowerCase();
...
function sort(documentToSort, formattingOptions) {
  ...
  const formattedJsonString = TextDocument2.applyEdits(
    documentToSort,
    format4(documentToSort, options, void 0),
  );
  const formattedJsonDocument = TextDocument2.create(
    'test://test.json',
    'json',
    0,
    formattedJsonString,
  ...
  const sortedAndFormattedJsonDocument = TextDocument2.applyEdits(
    sortedJsonDocument,
    edits,
  );
  return [
    TextEdit.replace(
      Range.create(
        Position.create(0, 0),
        documentToSort.positionAt(documentToSort.getText().length),
      ),
      sortedAndFormattedJsonDocument,
    ),
  ];
}
function findJsoncPropertyTree(formattedDocument) {
  ...
  while ((token = scanner.scan()) !== 17) {
    if (
      ...
      if (
        secondToLastNonTriviaNonCommentToken === 2 ||
        secondToLastNonTriviaNonCommentToken === 4
      ) {
    ...
    if (scanner.getTokenStartLine() !== lastTokenLine) {
      for (let i = lastTokenLine; i < scanner.getTokenStartLine(); i++) {
        const lengthOfLine = formattedDocument.getText(
          Range.create(Position.create(i, 0), Position.create(i + 1, 0)),
        ).length;
        numberOfCharactersOnPreviousLines =
          numberOfCharactersOnPreviousLines + lengthOfLine;
      }
    ...
    switch (token) {
      case 10: {
        if (
          lastNonTriviaNonCommentToken === void 0 ||
          lastNonTriviaNonCommentToken === 1 ||
          (lastNonTriviaNonCommentToken === 5 &&
            currentContainerStack[currentContainerStack.length - 1] ===
              Container.Object)
        ) {
          const childProperty = new PropertyTree(
      ...
      case 4: {
        ...
        if (
          currentProperty.endLineNumber === void 0 &&
          (lastNonTriviaNonCommentToken === 2 ||
            lastNonTriviaNonCommentToken === 4)
        ) {
          currentProperty.endLineNumber = endLineNumber - 1;
          currentProperty.lastProperty = true;
          currentProperty.lineWhereToAddComma =
            lineOfLastNonTriviaNonCommentToken;
          currentProperty.indexWhereToAddComa =
      ...
      case 5: {
        ...
        if (
          ...
          currentProperty.commaIndex =
            scanner.getTokenOffset() - numberOfCharactersOnPreviousLines;
      ...
      case 13: {
        ...
        if (
          (lastNonTriviaNonCommentToken === 1 ||
            lastNonTriviaNonCommentToken === 3) &&
          lineOfLastNonTriviaNonCommentToken === scanner.getTokenStartLine()
        ) {
          updateBeginningLineNumber = true;
        }
...
function sortJsoncDocument(jsonDocument, propertyTree) {
  ...
  const sortedJsonDocument = TextDocument2.create(
    'test://test.json',
    'json',
    0,
  ...
  while (queueToSort.length > 0) {
    ...
    for (let i = 0; i < propertyTreeArray.length; i++) {
      ...
      const range = Range.create(
        Position.create(propertyTree2.beginningLineNumber, 0),
        Position.create(propertyTree2.endLineNumber + 1, 0),
      );
      const jsonContentToReplace = jsonDocument.getText(range);
      const jsonDocumentToReplace = TextDocument2.create(
        'test://test.json',
        'json',
        0,
        jsonContentToReplace,
      );
      if (
        propertyTree2.lastProperty === true &&
        i !== propertyTreeArray.length - 1
      ) {
        const lineWhereToAddComma =
          propertyTree2.lineWhereToAddComma - propertyTree2.beginningLineNumber;
        const indexWhereToAddComma = propertyTree2.indexWhereToAddComa;
        const edit2 = {
          range: Range.create(
            Position.create(lineWhereToAddComma, indexWhereToAddComma),
            Position.create(lineWhereToAddComma, indexWhereToAddComma),
          ),
          text: ',',
        };
      ...
      const length =
        propertyTree2.endLineNumber - propertyTree2.beginningLineNumber + 1;
      const edit = {
        range: Range.create(
...
function updateSortingQueue(queue, propertyTree, beginningLineNumber) {
  ...
  if (propertyTree.type === Container.Object) {
    ...
    queue.push(
      new SortingRange(beginningLineNumber, propertyTree.childrenProperties),
    );
  } else if (propertyTree.type === Container.Array) {
    updateSortingQueueForArrayProperties(
      queue,
      propertyTree,
      beginningLineNumber,
    );
...
function updateSortingQueueForArrayProperties(
  queue,
  propertyTree,
  beginningLineNumber,
) {
...
function findNode(pointer, node) {
  ...
  if (node && node.type === 'object') {
    const propertyNode = node.properties.find(
      (propertyNode2) => propertyNode2.keyNode.value === token,
    );
    if (!propertyNode) {
      return null;
    }
  ...
  return {
    configure: (settings) => {
      ...
      settings.schemas?.forEach(
        jsonSchemaService.registerExternalSchema.bind(jsonSchemaService),
      );
    ...
    parseJSONDocument: (document) =>
      parse3(document, { collectComments: true }),
