...
/**
 * Base metadata interface for JavaScript editor
 */
...
/**
 * Evaluates JavaScript code with the provided input data
...
/**
 * Main compute function for JavaScript editor node
...
export const computeFunction = async <T extends { metadata?: unknown }>(
  ...
  try {
    ...
    const eventId = generateEventId('jsEditor');
    ...
    logError('JavaScript evaluation error', { error });
