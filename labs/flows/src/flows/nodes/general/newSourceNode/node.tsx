...
import { metaNewSourceNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';
import { logError } from '@repo/observability';

/**
 * NewSourceNode Component
 ...
 */
export const NewSourceNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data } = props;
...
NewSourceNode.displayName = 'NewSourceNode';
