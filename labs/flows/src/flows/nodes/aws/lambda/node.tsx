...
import { metaAwsLambdaNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';

/**
 * AwsLambdaNode Component
 ...
 */
export const AwsLambdaNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data, id } = props;
...
AwsLambdaNode.displayName = 'AwsLambdaNode';
