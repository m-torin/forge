...
import { metaAwsSnsNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';

/**
 * AwsSnsNode Component
 ...
 */
export const AwsSnsNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data, id } = props;
...
AwsSnsNode.displayName = 'AwsSnsNode';
