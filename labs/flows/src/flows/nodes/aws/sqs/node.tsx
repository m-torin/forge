...
import { metaAwsSqsNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';

/**
 * AwsSqsNode Component
 ...
 */
export const AwsSqsNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data, id } = props;
...
AwsSqsNode.displayName = 'AwsSqsNode';
