...
import { metaAnthropicGptNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';
import { logError } from '@repo/observability';

/**
 * AnthropicGptNode Component
 ...
 */
export const AnthropicGptNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data } = props;
...
AnthropicGptNode.displayName = 'AnthropicGptNode';
