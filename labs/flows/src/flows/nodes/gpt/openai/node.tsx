...
import { metaOpenaiGptNode } from './metadata';
import { handleSubmit } from './handleSubmit';
import { computeWrapper } from './computeEvent';
import { logError } from '@repo/observability';

/**
 * OpenaiGptNode Component
 ...
 */
export const OpenaiGptNode: FC<FbNodeProps> = memo((props: FbNodeProps) => {
  const { data } = props;
...
OpenaiGptNode.displayName = 'OpenaiGptNode';
