...
const Schema: z.ZodType<Prisma.AuditLogUpdateInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    timestamp: z
      ...
      .optional(),
    user: z
      .lazy(() => UserUpdateOneRequiredWithoutAuditLogsNestedInputObjectSchema)
      .optional(),
    flow: z
...
export const AuditLogUpdateInputObjectSchema = Schema;
