...
import { FlowUpdateOneRequiredWithoutTestCasesNestedInputObjectSchema } from './FlowUpdateOneRequiredWithoutTestCasesNestedInput.schema';
...
const Schema: z.ZodType<Prisma.TestCaseUpdateInput> = z
  .object({
    color: z
      .union([
        MantineColorSchema,
    ...
    deleted: z
      ...
      .optional(),
    flow: z
      .lazy(() => FlowUpdateOneRequiredWithoutTestCasesNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const TestCaseUpdateInputObjectSchema = Schema;
