...
import { FlowCreateNestedManyWithoutInstanceInputObjectSchema } from './FlowCreateNestedManyWithoutInstanceInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    flows: z
      .lazy(() => FlowCreateNestedManyWithoutInstanceInputObjectSchema)
      .optional(),
    tags: z
...
export const InstanceCreateWithoutTagGroupsInputObjectSchema = Schema;
