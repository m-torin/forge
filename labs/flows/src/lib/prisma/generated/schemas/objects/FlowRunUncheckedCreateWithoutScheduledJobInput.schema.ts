...
import { FlowEventUncheckedCreateNestedManyWithoutFlowRunInputObjectSchema } from './FlowEventUncheckedCreateNestedManyWithoutFlowRunInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    flowEvents: z
      .lazy(
        () => FlowEventUncheckedCreateNestedManyWithoutFlowRunInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const FlowRunUncheckedCreateWithoutScheduledJobInputObjectSchema =
  Schema;
