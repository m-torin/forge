...
import { FlowRunUncheckedUpdateManyWithoutFlowInputObjectSchema } from './FlowRunUncheckedUpdateManyWithoutFlowInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    data: z.union([
      ...
      z.lazy(() => FlowRunUncheckedUpdateManyWithoutFlowInputObjectSchema),
    ]),
  })
  .strict();

export const FlowRunUpdateManyWithWhereWithoutFlowInputObjectSchema = Schema;
