...
import { EdgeUpdateManyWithoutSourceNodeNestedInputObjectSchema } from './EdgeUpdateManyWithoutSourceNodeNestedInput.schema';
...
const Schema: z.ZodType<Prisma.NodeUpdateInput> = z
  .object({
    arn: z
      .union([
        z.string(),
    ...
    secrets: z
      ...
      .optional(),
    sourceEdges: z
      .lazy(() => EdgeUpdateManyWithoutSourceNodeNestedInputObjectSchema)
      .optional(),
    targetEdges: z
...
export const NodeUpdateInputObjectSchema = Schema;
