...
import { EdgeCreateNestedManyWithoutSourceNodeInputObjectSchema } from './EdgeCreateNestedManyWithoutSourceNodeInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    secrets: z
      ...
      .optional(),
    sourceEdges: z
      .lazy(() => EdgeCreateNestedManyWithoutSourceNodeInputObjectSchema)
      .optional(),
    targetEdges: z
...
export const NodeCreateWithoutInfrastructureInputObjectSchema = Schema;
