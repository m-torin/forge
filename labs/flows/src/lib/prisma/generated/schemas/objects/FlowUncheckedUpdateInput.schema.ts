...
import { FlowRunUncheckedUpdateManyWithoutFlowNestedInputObjectSchema } from './FlowRunUncheckedUpdateManyWithoutFlowNestedInput.schema';
...
const Schema: z.ZodType<Prisma.FlowUncheckedUpdateInput> = z
  .object({
    createdAt: z
      .union([
        z.coerce.date(),
    ...
    edges: z
      ...
      .optional(),
    flowRuns: z
      .lazy(() => FlowRunUncheckedUpdateManyWithoutFlowNestedInputObjectSchema)
      .optional(),
    flowEvents: z
      .lazy(
...
export const FlowUncheckedUpdateInputObjectSchema = Schema;
