...
import { FlowUpdateOneRequiredWithoutFlowRunsNestedInputObjectSchema } from './FlowUpdateOneRequiredWithoutFlowRunsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.FlowRunUpdateInput> = z
  .object({
    isScheduled: z
      .union([
        z.boolean(),
    ...
    timeStarted: z
      ...
      .optional(),
    flow: z
      .lazy(() => FlowUpdateOneRequiredWithoutFlowRunsNestedInputObjectSchema)
      .optional(),
    flowEvents: z
...
export const FlowRunUpdateInputObjectSchema = Schema;
