...
import { NodeUncheckedUpdateManyWithoutInfrastructureNestedInputObjectSchema } from './NodeUncheckedUpdateManyWithoutInfrastructureNestedInput.schema';
...
const Schema: z.ZodType<Prisma.InfrastructureUncheckedUpdateInput> = z
  .object({
    arn: z
      .union([
        z.string(),
    ...
    nodes: z
      .lazy(
        () =>
          NodeUncheckedUpdateManyWithoutInfrastructureNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const InfrastructureUncheckedUpdateInputObjectSchema = Schema;
