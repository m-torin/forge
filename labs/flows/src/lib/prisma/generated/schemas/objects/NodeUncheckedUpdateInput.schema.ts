...
import { EdgeUncheckedUpdateManyWithoutSourceNodeNestedInputObjectSchema } from './EdgeUncheckedUpdateManyWithoutSourceNodeNestedInput.schema';
...
const Schema: z.ZodType<Prisma.NodeUncheckedUpdateInput> = z
  .object({
    arn: z
      .union([
        z.string(),
    ...
    sourceEdges: z
      .lazy(
        () => EdgeUncheckedUpdateManyWithoutSourceNodeNestedInputObjectSchema,
      )
      .optional(),
    targetEdges: z
      .lazy(
...
export const NodeUncheckedUpdateInputObjectSchema = Schema;
