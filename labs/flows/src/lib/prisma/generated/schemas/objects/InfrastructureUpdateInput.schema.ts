...
import { NodeUpdateManyWithoutInfrastructureNestedInputObjectSchema } from './NodeUpdateManyWithoutInfrastructureNestedInput.schema';
...
const Schema: z.ZodType<Prisma.InfrastructureUpdateInput> = z
  .object({
    arn: z
      .union([
        z.string(),
    ...
    deleted: z
      ...
      .optional(),
    nodes: z
      .lazy(() => NodeUpdateManyWithoutInfrastructureNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const InfrastructureUpdateInputObjectSchema = Schema;
