import { z } from 'zod';
import { NodeFlowIdRfIdCompoundUniqueInputObjectSchema } from './NodeFlowIdRfIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.NodeWhereUniqueInput> = z
  .object({
    id: z.string(),
    flowId_rfId: z.lazy(() => NodeFlowIdRfIdCompoundUniqueInputObjectSchema),
    AND: z
      .union([
