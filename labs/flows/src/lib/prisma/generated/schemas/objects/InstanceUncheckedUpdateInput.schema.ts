...
import { TagGroupUncheckedUpdateManyWithoutInstanceNestedInputObjectSchema } from './TagGroupUncheckedUpdateManyWithoutInstanceNestedInput.schema';
...
const Schema: z.ZodType<Prisma.InstanceUncheckedUpdateInput> = z
  .object({
    createdAt: z
      .union([
        z.coerce.date(),
    ...
    tagGroups: z
      .lazy(
        () => TagGroupUncheckedUpdateManyWithoutInstanceNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const InstanceUncheckedUpdateInputObjectSchema = Schema;
