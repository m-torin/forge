import { z } from 'zod';
import { FlowIdInstanceIdCompoundUniqueInputObjectSchema } from './FlowIdInstanceIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.FlowWhereUniqueInput> = z
  .object({
    id: z.string(),
    id_instanceId: z.lazy(
      () => FlowIdInstanceIdCompoundUniqueInputObjectSchema,
    ),
    AND: z
      .union([
...
export const FlowWhereUniqueInputObjectSchema = Schema;
