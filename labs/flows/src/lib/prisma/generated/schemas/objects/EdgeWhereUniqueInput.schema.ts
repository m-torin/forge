import { z } from 'zod';
import { EdgeSourceNodeIdTargetNodeIdCompoundUniqueInputObjectSchema } from './EdgeSourceNodeIdTargetNodeIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.EdgeWhereUniqueInput> = z
  .object({
    id: z.string(),
    sourceNodeId_targetNodeId: z.lazy(
      () => EdgeSourceNodeIdTargetNodeIdCompoundUniqueInputObjectSchema,
    ),
    AND: z
      .union([
...
export const EdgeWhereUniqueInputObjectSchema = Schema;
