...
import { EdgeUpdateManyWithoutFlowNestedInputObjectSchema } from './EdgeUpdateManyWithoutFlowNestedInput.schema';
...
const Schema: z.ZodType<Prisma.FlowUpdateInput> = z
  .object({
    createdAt: z
      .union([
        z.coerce.date(),
    ...
    deleted: z
      ...
      .optional(),
    edges: z
      .lazy(() => EdgeUpdateManyWithoutFlowNestedInputObjectSchema)
      .optional(),
    flowRuns: z
...
export const FlowUpdateInputObjectSchema = Schema;
