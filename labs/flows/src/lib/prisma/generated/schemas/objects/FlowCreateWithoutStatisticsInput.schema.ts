...
import { EdgeCreateNestedManyWithoutFlowInputObjectSchema } from './EdgeCreateNestedManyWithoutFlowInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    edges: z
      .lazy(() => EdgeCreateNestedManyWithoutFlowInputObjectSchema)
      .optional(),
    flowRuns: z
...
export const FlowCreateWithoutStatisticsInputObjectSchema = Schema;
