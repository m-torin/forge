...
import { TagUncheckedUpdateManyWithoutFlowInputObjectSchema } from './TagUncheckedUpdateManyWithoutFlowInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    data: z.union([
      ...
      z.lazy(() => TagUncheckedUpdateManyWithoutFlowInputObjectSchema),
    ]),
  })
  .strict();

export const TagUpdateManyWithWhereWithoutFlowInputObjectSchema = Schema;
