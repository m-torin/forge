...
import { AuditLogUncheckedUpdateManyWithoutFlowInputObjectSchema } from './AuditLogUncheckedUpdateManyWithoutFlowInput.schema';
...
const Schema: z.ZodType<any> = z
  .object({
    ...
    data: z.union([
      ...
      z.lazy(() => AuditLogUncheckedUpdateManyWithoutFlowInputObjectSchema),
    ]),
  })
  .strict();

export const AuditLogUpdateManyWithWhereWithoutFlowInputObjectSchema = Schema;
