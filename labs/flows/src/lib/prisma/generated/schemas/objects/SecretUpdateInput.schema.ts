...
import { FlowUpdateOneWithoutSecretsNestedInputObjectSchema } from './FlowUpdateOneWithoutSecretsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.SecretUpdateInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    deleted: z
      ...
      .optional(),
    flow: z
      .lazy(() => FlowUpdateOneWithoutSecretsNestedInputObjectSchema)
      .optional(),
    node: z
...
export const SecretUpdateInputObjectSchema = Schema;
