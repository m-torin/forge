...
} from '@/actions/pim3/taxonomies/actions';
...
export function TaxonomyBulkAssignModal({
  ...
  selectedTaxonomyIds,
  taxonomyCount,
}: TaxonomyBulkAssignModalProps): JSX.Element {
  ...
  const loadAvailableItems = async () => {
    try {
      ...
      const { getProductsWithPIMFilters } = await import('@/actions/pim3/actions');
      const { getCollectionsAction } = await import('@/actions/pim3/actions');
