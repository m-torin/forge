...
describe("SEO Metadata", () => {
  ...
  it("formats title correctly", () => {
    ...
    expect(metadata.title).toBe("Custom Title | forge");
    expect(metadata.openGraph?.title).toBe("Custom Title | forge");
    ...
    if (
      ...
      expect(metadata.appleWebApp.title).toBe("Custom Title | forge");
    }
  });
