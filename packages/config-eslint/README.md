...
This package manages shared ESLint dependencies for all configurations. Individual projects don't
need to install additional ESLint plugins when using these configs.
...
The Next.js configuration includes specialized rules for Next.js 15 applications:
...
The React and Next.js configurations include Testing Library rules for test files:
...
Code blocks within Markdown files are also linted with relaxed rules to allow for documentation
examples.
...
The Next.js configuration includes specific overrides for testing Next.js components:
