...
import reactConfig from './react-package.mjs';
import { createConfig, SEVERITY } from './types/config.mjs';
...
const createNextConfigRules = () => ({
  // Allow default exports for Next.js config
  'import/no-default-export': SEVERITY.OFF,
  'import/prefer-default-export': SEVERITY.ERROR,
});

const createNextTestingRules = () => ({
...
const createServerComponentTestingRules = () => ({
