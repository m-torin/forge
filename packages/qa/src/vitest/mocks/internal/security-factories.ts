/**
 * Centralized security test factories for the entire monorepo
 * Provides reusable test suite generators and mock objects for security functionality
 *
 * Previously located in packages/security/__tests__/test-factory.ts
...
/**
 * Pre-configured security test scenarios for common use cases
 */
export const securityTestScenarios = {
  // Rate limiting scenarios
  rateLimiting: {
    normalLoad: createScenarios.rateLimiting(50, 100),
    heavyLoad: createScenarios.rateLimiting(150, 100),
    bursts: createScenarios.rateLimiting(10, 5),
  },

  // Security headers scenarios
  headers: {
    standard: createScenarios.securityHeaders(),
  },
