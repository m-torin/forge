...
import { extractFromHtml } from '../src/shared/patterns/quick-scrape';
import { ScrapingConfig, SelectorMap } from '../src/shared/types/scraping-types';
import { validateConfigOrThrow } from '../src/shared/utils/validation';
