...
export const testPatterns = {
  ...
  // Invalid locales
  invalidLocales: ['invalid', 'xx', 'en-XX', 'fr-XX', '', null, undefined, 123, {}, []],
 ...
 */
export const dictionaryTestData = {
  ...
  largeDictionaries: {
    en: Array.from({ length: 1000 }, (_, i) => [`key${i}`, `Value ${i}`]).reduce(
      (acc, [key, value]) => ({ ...acc, [key]: value }),
      {},
    ),
    fr: Array.from({ length: 1000 }, (_, i) => [`key${i}`, `Valeur ${i}`]).reduce(
      (acc, [key, value]) => ({ ...acc, [key]: value }),
      {},
    ),
  },
 ...
 */
export const middlewareTestData = {
  // Request scenarios
  requests: [
    {
...
export const utilityTestData = {
  ...
  extension: [
    ...
    },
    {
      ...
      expected: { common: { greetings: { hello: 'Hello', goodbye: 'Goodbye' } } },
    },
    {
...
export const performanceTestData = {
  ...
  largeDictionaries: {
    small: Array.from({ length: 100 }, (_, i) => [`key${i}`, `value${i}`]).reduce(
      (acc, [key, value]) => ({ ...acc, [key]: value }),
      {},
    ),
    medium: Array.from({ length: 1000 }, (_, i) => [`key${i}`, `value${i}`]).reduce(
      (acc, [key, value]) => ({ ...acc, [key]: value }),
      {},
    ),
    large: Array.from({ length: 10000 }, (_, i) => [`key${i}`, `value${i}`]).reduce(
      (acc, [key, value]) => ({ ...acc, [key]: value }),
      {},
    ),
  },
  ...
  memoryPatterns: {
    smallObjects: Array.from({ length: 1000 }, (_, i) => ({ id: i, value: `value${i}` })),
