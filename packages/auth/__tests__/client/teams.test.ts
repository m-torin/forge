...
// Helper to reset organization mock shape between tests
function resetOrganizationMock() {
...
describe("client teams functionality", () => {
  ...
  describe("createTeam", () => {
    ...
    test("should handle team creation errors", async () => {
      ...
      await expect(createTeam({ name: "Test Team" })).rejects.toThrow(
  ...
  describe("removeTeam", () => {
    test("should remove team successfully", async () => {
      ...
      expect(mockAuthClient.organization.removeTeam).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
    ...
    test("should handle team removal errors", async () => {
      ...
      await expect(removeTeam("team-123")).rejects.toThrow(
        "Team removal failed",
      );
      expect(mockLogger.error).toHaveBeenCalledWith(
        "Remove team failed:",
  ...
  describe("addTeamMember", () => {
    test("should add team member successfully", async () => {
      ...
      expect(result).toStrictEqual(memberData);
  ...
  describe("updateTeamMemberRole", () => {
    test("should update team member role successfully", async () => {
      ...
      mockAuthClient.organization.updateTeamMemberRole.mockResolvedValue(
        memberData,
      );
      ...
      expect(result).toStrictEqual(memberData);
      expect(
        mockAuthClient.organization.updateTeamMemberRole,
  ...
  describe("getTeam", () => {
    test("should get team successfully", async () => {
      ...
      expect(result).toStrictEqual(teamData);
      expect(mockAuthClient.organization.getTeam).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
  ...
  describe("listTeamMembers", () => {
    ...
    test("should handle list members errors", async () => {
      ...
      await expect(listTeamMembers("team-123")).rejects.toThrow(
        "List members failed",
      );
      expect(mockLogger.error).toHaveBeenCalledWith(
  ...
  describe("team invitations", () => {
    test("should get team invitations successfully", async () => {
      ...
      mockAuthClient.organization.getTeamInvitations.mockResolvedValue(
        invitations,
      );
      ...
      expect(
        mockAuthClient.organization.getTeamInvitations,
      ).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
    ...
    test("should accept team invitation successfully", async () => {
      ...
      mockAuthClient.organization.acceptTeamInvitation.mockResolvedValue(
        result_data,
      );
      ...
      expect(
        mockAuthClient.organization.acceptTeamInvitation,
      ).toHaveBeenCalledWith({
    ...
    test("should reject team invitation successfully", async () => {
      ...
      mockAuthClient.organization.rejectTeamInvitation.mockResolvedValue(
        undefined,
      );
      ...
      expect(result).toBeUndefined();
      expect(
        mockAuthClient.organization.rejectTeamInvitation,
      ).toHaveBeenCalledWith({
        invitationId: "inv-123",
      });
    });
    ...
    test("should cancel team invitation successfully", async () => {
      ...
      mockAuthClient.organization.cancelTeamInvitation.mockResolvedValue(
        undefined,
      );
      ...
      expect(result).toBeUndefined();
      expect(
        mockAuthClient.organization.cancelTeamInvitation,
      ).toHaveBeenCalledWith({
        invitationId: "inv-123",
      });
    });
    ...
    test("should handle invitation errors", async () => {
      ...
      await expect(rejectTeamInvitation("inv-123")).rejects.toThrow(
        "Invitation failed",
      );

      // Test cancel error
      mockAuthClient.organization.cancelTeamInvitation.mockRejectedValue(error);
      await expect(cancelTeamInvitation("inv-123")).rejects.toThrow(
        "Invitation failed",
      );
    });
  });
  ...
  describe("advanced team operations", () => {
    test("should transfer team ownership successfully", async () => {
      ...
      mockAuthClient.organization.transferTeamOwnership.mockResolvedValue(
        result_data,
      );
      ...
      expect(result).toStrictEqual(result_data);
      expect(
        mockAuthClient.organization.transferTeamOwnership,
      ).toHaveBeenCalledWith({
        teamId: "team-123",
        newOwnerId: "user-456",
      });
    ...
    test("should leave team successfully", async () => {
      ...
      expect(result).toBeUndefined();
      expect(mockAuthClient.organization.leaveTeam).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
    ...
    test("should archive team successfully", async () => {
      ...
      expect(result).toStrictEqual(teamData);
      expect(mockAuthClient.organization.archiveTeam).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
    ...
    test("should duplicate team successfully", async () => {
      ...
      expect(result).toStrictEqual(newTeam);
    ...
    test("should get team stats successfully", async () => {
      ...
      expect(mockAuthClient.organization.getTeamStats).toHaveBeenCalledWith({
        teamId: "team-123",
      });
    });
    ...
    test("should handle advanced operation errors", async () => {
      ...
      mockAuthClient.organization.transferTeamOwnership.mockRejectedValue(
        error,
      );
      await expect(
      ...
      await expect(
        duplicateTeam({ teamId: "team-123", newName: "Copy" }),
      ).rejects.toThrow("Operation failed");

      // Test get stats error
      mockAuthClient.organization.getTeamStats.mockRejectedValue(error);
      await expect(getTeamStats("team-123")).rejects.toThrow(
        "Operation failed",
      );
    });
  });
  ...
  describe("bulk operations", () => {
    test("should bulk update team members successfully", async () => {
      ...
      mockAuthClient.organization.bulkUpdateTeamMembers.mockResolvedValue(
        results,
      );
      ...
      expect(
        mockAuthClient.organization.bulkUpdateTeamMembers,
      ).toHaveBeenCalledWith({
        teamId: "team-123",
        updates: [
          { userId: "user-1", role: "admin" },
    ...
    test("should export team data successfully", async () => {
      ...
      expect(result).toStrictEqual(exportData);
    ...
    test("should import team data successfully", async () => {
      ...
      mockAuthClient.organization.importTeamData.mockResolvedValue(
        importResult,
      );
      ...
      expect(result).toStrictEqual(importResult);
    ...
    test("should handle bulk operation errors", async () => {
      const { bulkUpdateTeamMembers, exportTeamData, importTeamData } =
        await import("../../src/client/teams");

      const error = new Error("Bulk operation failed");

      // Test bulk update error
      mockAuthClient.organization.bulkUpdateTeamMembers.mockRejectedValue(
        error,
      );
      await expect(
        bulkUpdateTeamMembers({ teamId: "team-123", updates: [] }),
      ).rejects.toThrow("Bulk operation failed");

      // Test export error
      mockAuthClient.organization.exportTeamData.mockRejectedValue(error);
      await expect(exportTeamData({ teamId: "team-123" })).rejects.toThrow(
      ...
      await expect(
        importTeamData({ teamId: "team-123", data: {} }),
      ).rejects.toThrow("Bulk operation failed");
    });
  });
  ...
  describe("edge cases and error handling", () => {
    ...
    test("should handle non-Error exceptions", async () => {
      ...
      await expect(updateTeam("team-123", { name: "Test" })).rejects.toThrow(
        "Update team failed",
      );
      expect(mockLogger.error).toHaveBeenCalledWith(
        "Update team failed:",
