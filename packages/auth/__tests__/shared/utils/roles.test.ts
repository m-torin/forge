...
describe("role utilities", () => {
  describe("hasRolePermission", () => {
    ...
    test("should deny unknown user role", async () => {
      ...
      const hierarchy = ["admin", "user"];
      const result = rolesModule.hasRolePermission(
        "unknown",
        "user",
        hierarchy,
      );
    ...
    test("should work with complex hierarchy", async () => {
      ...
      expect(
        rolesModule.hasRolePermission("super-admin", "guest", hierarchy),
      ).toBeTruthy();
      expect(
        rolesModule.hasRolePermission("admin", "user", hierarchy),
      ).toBeTruthy();
      expect(
        rolesModule.hasRolePermission("user", "admin", hierarchy),
      ).toBeFalsy();
      expect(
        rolesModule.hasRolePermission("guest", "user", hierarchy),
      ).toBeFalsy();
    });
  });
  ...
  describe("hasOrganizationPermission", () => {
    test("should allow owner all permissions", async () => {
      ...
      expect(
        rolesModule.hasOrganizationPermission("owner", "admin"),
      ).toBeTruthy();
      expect(
        rolesModule.hasOrganizationPermission("owner", "member"),
      ).toBeTruthy();
      expect(
        rolesModule.hasOrganizationPermission("owner", "guest"),
      ).toBeTruthy();
    });
    ...
    test("should allow admin appropriate permissions", async () => {
      ...
      expect(
        rolesModule.hasOrganizationPermission("admin", "owner"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("admin", "admin"),
      ).toBeTruthy();
      expect(
        rolesModule.hasOrganizationPermission("admin", "member"),
      ).toBeTruthy();
      expect(
        rolesModule.hasOrganizationPermission("admin", "guest"),
      ).toBeTruthy();
    });
    ...
    test("should limit member permissions", async () => {
      ...
      expect(
        rolesModule.hasOrganizationPermission("member", "owner"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("member", "admin"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("member", "member"),
      ).toBeTruthy();
      expect(
        rolesModule.hasOrganizationPermission("member", "guest"),
      ).toBeTruthy();
    });
    ...
    test("should limit guest permissions", async () => {
      ...
      expect(
        rolesModule.hasOrganizationPermission("guest", "owner"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("guest", "admin"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("guest", "member"),
      ).toBeFalsy();
      expect(
        rolesModule.hasOrganizationPermission("guest", "guest"),
      ).toBeTruthy();
    });
  });
  ...
  describe("hasUserPermission", () => {
    test("should allow super-admin all permissions", async () => {
      ...
      expect(
        rolesModule.hasUserPermission("super-admin", "admin"),
      ).toBeTruthy();
