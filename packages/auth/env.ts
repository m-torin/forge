...
export const env = createEnv({
  server: {
    ...
    // SMS providers for phone number authentication
    ...
    AUTH_FEATURES_PHONE_NUMBER: z.string().optional(),
    AUTH_FEATURES_ANONYMOUS: z.string().optional(),
    AUTH_FEATURES_EMAIL_OTP: z.string().optional(),
    AUTH_FEATURES_RATE_LIMITING: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    AUTH_FEATURES_PHONE_NUMBER: process.env.AUTH_FEATURES_PHONE_NUMBER,
    AUTH_FEATURES_ANONYMOUS: process.env.AUTH_FEATURES_ANONYMOUS,
    AUTH_FEATURES_EMAIL_OTP: process.env.AUTH_FEATURES_EMAIL_OTP,
    AUTH_FEATURES_RATE_LIMITING: process.env.AUTH_FEATURES_RATE_LIMITING,
    AUTH_FEATURES_ANALYTICS: process.env.AUTH_FEATURES_ANALYTICS,
