...
export async function listOrganizationTeams(organizationId: string): Promise<BetterAuthResponse> {
  try {
...
export async function cancelOrganizationInvitation(
  ...
  try {
    ...
    return { data: { message: 'Invitation cancelled' }, success: true };
  } catch (error) {
    return {
      data: null,
      error: error instanceof Error ? error.message : 'Unknown error',
...
export async function removeOrganizationMember(
  ...
  try {
    await auth.api.removeMember({
      body: { memberId, organizationId },
      headers: await headers(),
    });
    return { data: { message: 'Member removed' }, success: true };
  } catch (error) {
    return {
      data: null,
      error: error instanceof Error ? error.message : 'Unknown error',
...
export async function updateOrganizationMemberRole(
  ...
  try {
    ...
    return { data: { message: 'Member role updated' }, success: true };
  } catch (error) {
    return {
      data: null,
      error: error instanceof Error ? error.message : 'Unknown error',
...
export async function removeOrganizationTeam(teamId: string): Promise<BetterAuthResponse> {
  try {
    await auth.api.removeTeam({
      body: { teamId },
      headers: await headers(),
    });
    return { data: { message: 'Team removed' }, success: true };
  } catch (error) {
    return {
      data: null,
      error: error instanceof Error ? error.message : 'Unknown error',
...
export async function deleteOrganizationById(organizationId: string): Promise<BetterAuthResponse> {
  try {
    await auth.api.deleteOrganization({
      body: { organizationId },
      headers: await headers(),
