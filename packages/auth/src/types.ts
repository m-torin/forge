...
import type { auth } from './shared/auth.config';
import type { authClient } from './client/client.config';
...
export interface ConditionalAuthMethods<T = any> {
  [key: string]: any;
}

export interface ConditionalMiddleware<T = any> {
  [key: string]: any;
}

export interface ConditionalPluginConfig<T = any> {
  [key: string]: any;
}

// Better Auth compatibility types
export interface ValidateConfig<T = any> {
  [key: string]: any;
}
