    ...
    grafanaMonitoring: {
      ...
      monitoring: {
        ...
        endpoints: {
          ...
          otelHttp: process.env.OTEL_HTTP_URL || 'http://localhost:4318',
          rum: process.env.RUM_URL || 'http://localhost:12347',
        },
        service: {
        ...
        features: {
          rum: process.env.ENABLE_RUM === 'true',
          traces: process.env.ENABLE_TRACES === 'true',
          metrics: true,
          logs: true,
          healthChecks: true,
        },
    ...
    grafanaMonitoring: {
      ...
      monitoring: {
        ...
        endpoints: {
          ...
          otelHttp: process.env.OTEL_HTTP_URL!,
          rum: process.env.RUM_URL!,
        },
        service: {
...
export function createGrafanaObservabilityConfig(options: {
  ...
  if (environment !== 'development' && process.env.SENTRY_DSN) {
    config.providers.sentry = { dsn: process.env.SENTRY_DSN };
  }
