/**
 * Server-side error parsing and handling utilities
 ...
 * Server version with Node.js-specific fallback behavior
 */
export async function parseAndCaptureError(
  ...
  try {
    ...
    // Server-specific fallback with Node.js environment detection
