...
export const getRuntimeInfo = () => {
  ...
  if (typeof globalThis !== 'undefined' && globalThis.caches && typeof caches !== 'undefined') {
  ...
  if (
    ...
    return { type: 'browser', isNextJs: !!window.__NEXT_DATA__ };
  }
...
export function setObservabilityInstance(instance) {
