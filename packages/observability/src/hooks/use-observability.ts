    ...
    return {
      ...
      captureException: (error: Error, context?: ObsContext) => {
        try {
          ...
          console.error('[useObservability] Failed to capture exception:', error);
          return Promise.resolve();
        }
      },
      ...
      debug: (message: string, metadata?: any) => {
        try {
          ...
          console.error('[useObservability] Failed to log debug message:', error);
          return Promise.resolve();
        }
      },
      ...
      identify: (userId: string, traits?: any) => {
        try {
          ...
          console.error('[useObservability] Failed to identify user:', error);
        }
      },
      ...
      log: (level: string, message: string, metadata?: any) => {
        try {
          ...
          console.error('[useObservability] Failed to log message:', error);
          return Promise.resolve();
        }
      },
      ...
      setContext: (context: Record<string, any>) => {
        try {
          ...
          console.error('[useObservability] Failed to set context:', error);
        }
      },
    };
  }, [manager]);
