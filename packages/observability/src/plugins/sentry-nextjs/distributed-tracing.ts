 ...
 */
export function extractTraceparentData(sentryTrace: string): TraceparentData | undefined {
 ...
 */
export function extractW3CTraceparent(traceparent: string): TraceparentData | undefined {
 ...
 */
export function parseBaggage(baggageHeader: string): DynamicSamplingContext | undefined {
 ...
 */
export function extractTraceHeaders(headers: Headers | Record<string, string>): {
  sentryTrace?: string;
  traceparent?: string;
  baggage?: string;
} {
 ...
 */
export function continueTraceInServerComponent(headers: Headers): TraceparentData {
