...
export const env = createEnv({
  server: {
    ...
    SENTRY_REPLAYS_SESSION_SAMPLE_RATE: z.coerce
      .number()
      .min(0)
      .max(1)
      .optional(),
    SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE: z.coerce
      .number()
      .min(0)
      .max(1)
      .optional(),
  ...
  runtimeEnv: {
    ...
    SENTRY_WIDEN_CLIENT_FILE_UPLOAD:
      process.env.SENTRY_WIDEN_CLIENT_FILE_UPLOAD,
    SENTRY_AUTOMATIC_VERCEL_MONITORS:
      process.env.SENTRY_AUTOMATIC_VERCEL_MONITORS,
    SENTRY_DISABLE_SOURCEMAPS: process.env.SENTRY_DISABLE_SOURCEMAPS,
    SENTRY_DELETE_SOURCEMAPS_AFTER_UPLOAD:
      process.env.SENTRY_DELETE_SOURCEMAPS_AFTER_UPLOAD,
    ...
    NEXT_PUBLIC_SENTRY_ENABLE_TRACING:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_TRACING,
    NEXT_PUBLIC_SENTRY_ENABLE_REPLAY:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_REPLAY,
    NEXT_PUBLIC_SENTRY_ENABLE_FEEDBACK:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_FEEDBACK,
  },
...
export function safeEnv() {
  ...
  return {
    ...
    SENTRY_WIDEN_CLIENT_FILE_UPLOAD:
      process.env.SENTRY_WIDEN_CLIENT_FILE_UPLOAD === "true",
    SENTRY_AUTOMATIC_VERCEL_MONITORS:
      process.env.SENTRY_AUTOMATIC_VERCEL_MONITORS === "true",
    ...
    SENTRY_DSN: process.env.SENTRY_DSN || "",
    SENTRY_ENVIRONMENT:
      (process.env.SENTRY_ENVIRONMENT as
        | "development"
        | "preview"
    ...
    SENTRY_PROFILES_SAMPLE_RATE:
      Number(process.env.SENTRY_PROFILES_SAMPLE_RATE) || 0,
    SENTRY_REPLAYS_SESSION_SAMPLE_RATE:
    ...
    NEXT_PUBLIC_SENTRY_ENVIRONMENT:
      (process.env.NEXT_PUBLIC_SENTRY_ENVIRONMENT as
        | "development"
        | "preview"
        | "production") || "development",
    NEXT_PUBLIC_SENTRY_RELEASE: process.env.NEXT_PUBLIC_SENTRY_RELEASE || "",
    NEXT_PUBLIC_SENTRY_ENABLE_TRACING:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_TRACING === "true",
    NEXT_PUBLIC_SENTRY_ENABLE_REPLAY:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_REPLAY === "true",
    NEXT_PUBLIC_SENTRY_ENABLE_FEEDBACK:
      process.env.NEXT_PUBLIC_SENTRY_ENABLE_FEEDBACK === "true",
  };
}
