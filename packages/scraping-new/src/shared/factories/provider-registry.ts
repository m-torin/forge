...
import type { ScrapingProvider, ProviderConfig, ProviderRegistry } from '../types/scraping-types';

/**
 * Global provider registry
 */
class ScrapingProviderRegistry {
  private providers: Map<string, (config: ProviderConfig) => ScrapingProvider> = new Map();
