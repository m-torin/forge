          ...
          <Section className="mt-8 rounded-md bg-zinc-200 p-px">
            <Section className="rounded-[5px] bg-white p-8">
              ...
              <Text className="m-0 mb-6 text-zinc-500">
                We're excited to let you know that <strong>{purchaserName}</strong> has purchased an
                item from your registry "{registryTitle}"!
              </Text>
              ...
              {giftMessage && (
                <Section className="mb-6 p-4 bg-green-50 rounded-md border-l-4 border-green-500">
                  ...
                  <Text className="m-0 text-sm text-zinc-600 italic">"{giftMessage}"</Text>
                </Section>
              )}

              <Text className="m-0 mb-6 text-zinc-500">
                Don't forget to send a thank you note! You can do this directly from your registry
                dashboard.
              </Text>
