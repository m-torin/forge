          ...
          <Section className="mt-8 rounded-md bg-zinc-200 p-px">
            <Section className="rounded-[5px] bg-white p-8">
              ...
              <Text className="m-0 mb-6 text-zinc-500">
                <strong>{adderName}</strong> has added a new item to the registry "{registryTitle}".
              </Text>
              ...
              <Text className="m-0 text-sm text-zinc-500">
                You're receiving this email because you have edit access to this registry. You can
