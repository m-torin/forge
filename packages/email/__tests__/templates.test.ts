...
describe('email Templates', () => {
  ...
  describe('passwordResetTemplate', () => {
    ...
    test('should render example template', async () => {
      const ExamplePasswordResetEmail = (await import('../src/templates/password-reset')).default;
  ...
  describe('apiKeyCreatedTemplate', () => {
    ...
    test('should render example template', async () => {
      const ExampleApiKeyCreatedEmail = (await import('../src/templates/api-key-created')).default;
