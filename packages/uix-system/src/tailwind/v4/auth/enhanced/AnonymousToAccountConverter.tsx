...
const convertAnonymousToAccountAction = async (
  __prevState: any,
  formData: FormData,
) => {
  "use server";
    ...
    <div className={`mx-auto w-full max-w-2xl ${className}`}>
      <Card>
        <CardHeader>
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              {currentStep === "info" &&
                "Convert your anonymous session to a full account"}
              {currentStep === "form" &&
                "Fill in your details to create a permanent account"}
        ...
        <CardContent className="space-y-6">
          ...
          {(convertState.success || verifyState.success) &&
            currentStep !== "success" && (
                    ...
                    <div className="space-y-1">
                      ...
                      {currentSession.dataCount && (
                        <p>
                          ...
                          {currentSession.dataCount} items
                        </p>
                      )}
                ...
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-yellow-800">
                      ...
                      <p>
                        All your current session data, preferences, and progress
                        can be transferred to your new permanent account.
                        Nothing will be lost in the conversion process.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <label
                    ...
                    className="text-sm text-gray-700"
                  >
                    I'd like to receive product updates and promotional emails
                    (optional)
                  </label>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                <div className="text-sm text-blue-800">
                  ...
                  <ol className="list-inside list-decimal space-y-1 text-left">
                    ...
                    <li>
                      You'll be automatically signed in to your new account
                    </li>
                    {preserveData && (
                      <li>Your session data will be transferred</li>
                    )}
                  </ol>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                <div className="text-sm text-green-800">
                  ...
                  <ul className="list-inside list-disc space-y-1 text-left">
                    ...
                    {preserveData && (
                      <li>Your anonymous session data has been preserved</li>
                    )}
                  </ul>
                </div>
              </div>
