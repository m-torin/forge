      ...
      <Card className={`mx-auto w-full max-w-2xl ${className}`}>
        <CardContent className="p-8 text-center">
          ...
          <p className="mb-4 text-gray-600">
            Backup codes are only available when two-factor authentication is
          ...
          <div className="flex flex-wrap gap-3">
            <form action={generateAction} className="inline">
              ...
              <Button
                type="submit"
                variant="primary"
                disabled={generateState === undefined}
              >
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm text-blue-800">
              ...
              <ul className="list-inside list-disc space-y-1">
                ...
                <li>
                  Save these codes in a secure location (password manager, safe,
                  etc.)
                </li>
                <li>
                  Use backup codes only when you can't access your authenticator
                  app
                </li>
                <li>
                  Generate new codes if you're running low or if codes are
                  compromised
                </li>
