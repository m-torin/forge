...
async function removePhoneNumberAction(
  prevState: any,
  formData: FormData,
): Promise<FormState> {
  "use server";
  ...
  try {
    ...
    const { removePhoneNumberAction: authRemovePhone } = await import(
    ...
    if (error?.message?.includes("primary phone")) {
      return {
        success: false,
        error:
          "Cannot remove primary phone number. Set another number as primary first.",
      };
    }
...
async function setPrimaryPhoneAction(
  prevState: any,
  formData: FormData,
): Promise<FormState> {
  "use server";
  ...
  try {
    ...
    if (error?.message?.includes("not verified")) {
      return {
        success: false,
        error:
          "Cannot set unverified phone number as primary. Please verify it first.",
      };
    }
      ...
      <CardContent>
        ...
        {phoneNumbers.length === 0 ? (
          ...
          >
            ...
            >
              Add a phone number to enable SMS-based authentication and account
              recovery
            </p>
            <Button
              variant="primary"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    >
                      ...
                      {phone.lastUsed && (
                        <p>Last used {formatDate(phone.lastUsed)}</p>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex items-start">
            ...
            <div className={cn("text-sm text-blue-800", "dark:text-blue-200")}>
              ...
              <ul className="list-inside list-disc space-y-1 text-xs">
                <li>
                  Your primary phone number is used for critical security
                  notifications
                </li>
                <li>
                  Verified phone numbers can be used for SMS two-factor
                  authentication
                </li>
                <li>
                  Phone numbers help secure your account and enable account
                  recovery
                </li>
                <li>
                  We will never share your phone numbers with third parties
                </li>
                {allowMultiple && (
                  <li>
                    You can add up to {maxPhoneNumbers} phone numbers to your
                    account
                  </li>
                )}
              </ul>
