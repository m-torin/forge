            ...
            <form onSubmit={handleBulkInviteSubmit} className="space-y-6">
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-blue-800">
                  <li>
                    • Users will receive invitation emails with setup
                    instructions
                  </li>
                  <li>
                    • They must complete registration by setting their password
                  </li>
              ...
              {emailCount > 0 && (
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  ...
                  <div className="text-sm text-gray-700">
                    ...
                    {bulkOrganization && (
                      <p>
                        They will be added to organization:{" "}
                        <strong>{bulkOrganization}</strong>
                      </p>
                    )}
                  </div>
                </div>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              <li>
                • Users created with generated passwords will receive email
                instructions
              </li>
              <li>
              ...
              <li>
                • Moderators have limited admin access for content moderation
              </li>
