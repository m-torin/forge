...
export class EnvironmentData {
  ...
  static getTestUser(): { email: string; password: string } {
    return {
      email: process.env.TEST_USER_EMAIL || testFixtures.validUser.email,
      password: process.env.TEST_USER_PASSWORD || testFixtures.validUser.password,
    };
  }
  ...
  static getApiUrl(): string {
    return process.env.TEST_API_URL || 'http://localhost:3000/api';
  }
