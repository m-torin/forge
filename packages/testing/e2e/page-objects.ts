...
export class WaitUtils {
   ...
   */
  async forText(text: string, options?: { timeout?: number }) {
    await this.page.waitForSelector(`text=${text}`, { ...options, state: 'visible' });
  }
   ...
   */
  async forNavigation(options?: { timeout?: number }) {
