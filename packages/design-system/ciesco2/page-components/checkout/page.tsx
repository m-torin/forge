              ...
              <div className="flex-[1.5]">
                ...
                <div className="mt-1.5 flex text-sm text-neutral-600 sm:mt-2.5 dark:text-neutral-300">
                  <div className="flex items-center gap-x-2">
                    <HugeiconsIcon icon={PaintBucketIcon} strokeWidth={1.5}
                      color="currentColor"
                      size={16} />
                    <span>{color}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-x-2">
                    <HugeiconsIcon icon={Coordinate01Icon} strokeWidth={1.5}
                      color="currentColor"
                      size={16} />
                    <span>{size}</span>
                  </div>
      ...
      <main className="container py-16 lg:pt-20 lg:pb-28">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[36%]">
            ...
            <ButtonPrimary href={"/order-successful" as any} className="mt-8 w-full">
              Confirm order
            </ButtonPrimary>
