...
const data = [
  {
    id: 1,
    btnHref: route('/collections/[handle]', { handle: 'featured' }) as Route<string>,
  ...
  {
    id: 2,
    btnHref: route('/collections/[handle]', { handle: 'new-arrivals' }) as Route<string>,
    btnText: 'Explore shop now',
    heading: 'Exclusive collection <br /> for everyone',
  ...
  {
    id: 3,
    btnHref: route('/collections/[handle]', { handle: 'trending' }) as Route<string>,
    btnText: 'Explore shop now',
    heading: 'Exclusive collection <br /> for everyone',
