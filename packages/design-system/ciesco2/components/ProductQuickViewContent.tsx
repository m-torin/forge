...
const ProductQuickViewContent: FC<ProductQuickViewContentProps> = ({ className, product }) => {
  const [qualitySelected, setQualitySelected] = useState(1);

  const { handle, images, options, price, rating, reviewNumber, title } = product;
        ...
        <div className="w-full space-y-4 lg:flex-[1.5] lg:space-y-5 xl:flex-[1.3] xl:space-y-7">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center space-x-4">
              <Prices className="text-lg font-semibold" price={price || 0} />
            </div>
          </div>
          ...
          <div className="flex space-x-3.5">
            ...
            <Link
              ...
              className="text-sm font-medium text-primary-6000 hover:text-primary-500"
            >
              View full details
            </Link>
          </div>
          ...
          <Image
            ...
            src={
              typeof images?.[0] === 'string'
                ? images[0]
                : images?.[0]?.src || '/placeholder-image.jpg'
            }
          />
        </div>
      </div>
