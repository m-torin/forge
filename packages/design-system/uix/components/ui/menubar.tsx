...
import { Group, Menu, type GroupProps, type MenuProps, type MenuTargetProps, type MenuDropdownProps, type MenuItemProps, type MenuDividerProps, type MenuLabelProps } from '@mantine/core';
...
export const MenubarCheckboxItem: React.FC<{ children?: React.ReactNode; checked?: boolean; [key: string]: any }> = ({ children, checked, ...props }) => (
  <Menu.Item {...props}>
    {checked && '✓ '}{children}
  </Menu.Item>
);
...
export const MenubarRadioGroup: React.FC<{ children?: React.ReactNode; value?: string }> = ({ children }) => <>{children}</>;

export const MenubarRadioItem: React.FC<{ children?: React.ReactNode; value?: string; [key: string]: any }> = ({ children, value, ...props }) => (
  <Menu.Item {...props}>
    {children}
  </Menu.Item>
);
