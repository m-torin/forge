...
import { Carousel, type CarouselProps, type CarouselSlide } from '@mantine/carousel';
...
export const CarouselItem: React.ComponentType<React.ComponentProps<typeof CarouselSlide>> =
  Carousel.Slide;
