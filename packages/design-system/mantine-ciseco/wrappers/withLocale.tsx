 ...
 */
export function withLocale<P extends {}>(Component: React.ComponentType<P>, locale: string) {
 ...
 */
export function LocaleWrapper({ children, locale }: { children: React.ReactNode; locale: string }) {
