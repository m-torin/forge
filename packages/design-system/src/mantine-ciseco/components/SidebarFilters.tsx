          ...
          {DATA_categories.map((item: any) => (
            <div key={item.name}>
              <Checkbox
                ...
                onChange={(checked: any) => handleChangeCategories(checked, item.name)}
              />
            </div>
          ))}
        </div>
          ...
          {DATA_colors.map((item: any) => (
            <div key={item.name} className="">
              <Checkbox
                ...
                name={item.name}
                sizeClassName="w-5 h-5"
                onChange={(checked: any) => handleChangeColors(checked, item.name)}
              />
            </div>
          ))}
        </div>
          ...
          {DATA_sizes.map((item: any) => (
            <div key={item.name} className="">
              <Checkbox
                ...
                name={item.name}
                sizeClassName="w-5 h-5"
                onChange={(checked: any) => handleChangeSizes(checked, item.name)}
              />
            </div>
          ))}
        </div>
      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-y-6">
          ...
          <RangeSlider
            ...
            step={1}
            value={rangePrices}
            onChange={(value: any) => setRangePrices(value as [number, number])}
          />
        </div>
