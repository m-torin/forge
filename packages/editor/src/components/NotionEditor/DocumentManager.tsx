...
import type {
  DocumentMeta,
  SavedDocument,
} from "../../hooks/use-document-persistence";
...
export function DocumentManager({
  ...
  const [sortBy, setSortBy] = useState<
    "modified" | "created" | "title" | "wordCount"
  >("modified");
      ...
      <div className="border-b border-gray-200 bg-white p-4">
        ...
        {!useAdvancedSearch && (
          <div className="text-sm text-gray-500">
            {filteredDocuments.length} of {Object.keys(documents).length}{" "}
            documents
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-4 text-sm text-gray-500">
                      ...
                      <span>
                        {formatFileSize(doc.wordCount, doc.characterCount)}
                      </span>
