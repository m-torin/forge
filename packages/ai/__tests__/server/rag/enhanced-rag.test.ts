...
import {
  ...
  RAGService,
  createRAGSystem,
} from '../../../src/server/rag/enhanced-rag';
...
describe('enhanced RAG System', () => {
  ...
  describe('rAGService', () => {
    ...
    describe('enhanced Prompt Generation', () => {
      test('should generate enhanced prompt with context', async () => {
        const mockResults = [
          {
            id: 'test',
            score: 0.8,
        ...
        const result = await ragService.getEnhancedPrompt('test query', 'Answer the question:', {
          topK: 3,
        });
