/**
 * Advanced Streaming Backpressure and Interruption Tests
...
import {
  ...
  type StreamItem,
} from '../../../src/server/streaming/advanced/backpressure';
import {
...
describe('buffer Optimization Integration', () => {
  ...
  describe('qoS and Traffic Shaping', () => {
    ...
    test('should apply traffic shaping to prevent bandwidth overflow', async () => {
      const shapingController = new AdvancedFlowController({
        trafficShaping: {
          enableShaping: true,
