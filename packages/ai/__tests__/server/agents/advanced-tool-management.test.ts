/**
 * AI SDK v5 Advanced Tool Management Tests
...
describe('advanced Tool Management', () => {
  ...
  describe('usage Reports and Analytics', () => {
    ...
    test('should handle empty usage data', () => {
      const emptyManager = new AdvancedToolManager();
  ...
  describe('advanced Tool Utilities', () => {
    test('should initialize built-in tools in manager', () => {
      const testManager = new AdvancedToolManager();
      advancedToolUtils.initializeBuiltInTools(testManager);
    ...
    test('should create tool metadata templates', () => {
      const metadata = advancedToolUtils.createToolMetadata('test-tool', 'Test Tool', 'testing', {
    ...
    test('should filter tools by execution context', () => {
      ...
      const filteredTools = advancedToolUtils.filterToolsByContext(tools, context);
  ...
  describe('global Tool Manager', () => {
    test('should provide a global tool manager instance', () => {
      expect(globalAdvancedToolManager).toBeInstanceOf(AdvancedToolManager);

      // Should be able to use global instance
      globalAdvancedToolManager.registerTool(mockTool, {
        ...mockToolMetadata,
        id: 'global-test-tool',
      });

      const metadata = globalAdvancedToolManager.getAllToolMetadata();
  ...
  describe('error Handling and Edge Cases', () => {
    ...
    test('should handle cache cleanup when cache size limit is exceeded', async () => {
      const smallCacheManager = new AdvancedToolManager({
        cacheEnabled: true,
        maxCacheSize: 2,
        cacheTtl: 3600000,
