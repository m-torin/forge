...
import { ModelMessage, generateObject, generateText, streamText } from 'ai';
 ...
 */
export async function generateTextWithConfig(options: GenerateOptions) {
  try {
 ...
 */
export async function streamTextWithConfig(options: GenerateOptions) {
  try {
    validateGenerateOptions(options);
 ...
 */
export async function generateObjectWithConfig<T>(
