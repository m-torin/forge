 ...
 */
export const enterpriseConfig: ProductionRAGConfig = {
 ...
 */
export const productionConfig: ProductionRAGConfig = {
  modelProvider: 'openai',
 ...
 */
export const developmentConfig: ProductionRAGConfig = {
  modelProvider: 'openai',
  embeddingModel: 'text-embedding-3-small',
 ...
 */
export const economyConfig: ProductionRAGConfig = {
  modelProvider: 'openai',
 ...
 */
export const realtimeConfig: ProductionRAGConfig = {
  modelProvider: 'openai',
  embeddingModel: 'text-embedding-3-small',
