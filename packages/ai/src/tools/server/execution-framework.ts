 ...
 */
interface ToolLifecycleHooks<TParams = any, TResult = any> {
 ...
 */
function createTool<TParams extends z.ZodTypeAny, TResult>(
  definition: ToolDefinition<TParams, TResult>,
 ...
 */
const globalToolFramework = new ToolExecutionFramework();
