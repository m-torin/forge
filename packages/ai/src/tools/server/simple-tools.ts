...
const standardTools = {
  ...
  search: aiTool({
    ...
    execute: async (args: any, context?: any) => {
      const { query, limit } = args as { query: any; limit: any };
      return {
        query,
  ...
  calculator: aiTool({
    ...
    execute: async (args: any, context?: any) => {
      const { expression } = args as { expression: any };
      try {
...
const documentTools = {
  createDocument: aiTool({
    ...
    execute: async (args: any, context?: any) => {
      const { title, content, format } = args as { title: any; content: any; format: any };
      return {
        id: `doc_${Date.now()}`,
        title,
        content,
  ...
  summarizeDocument: aiTool({
    ...
    execute: async (args: any, context?: any) => {
      const { content, maxLength } = args as { content: any; maxLength: any };
 ...
 */
export function ragTools(vectorStore: any): Record<string, any> {
  return {
    addKnowledge: aiTool({
      ...
      execute: async (args: any, context?: any) => {
        const { content, metadata } = args as { content: any; metadata: any };
