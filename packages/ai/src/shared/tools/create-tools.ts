...
/**
 * Creates system tools (bash, text editor, computer) with custom configurations
 * @deprecated Use createSystemTools instead to avoid confusion with AI tools
 */
export function createTools(config?: ToolsConfig) {
  return createSystemTools(config);
}

/**
 * Creates system tools (bash, text editor, computer) with custom configurations
 */
export function createSystemTools(config?: ToolsConfig) {
  return {
...
/**
 * Creates secure system tools with workspace restrictions and safety controls
 * @deprecated Use createSecureSystemTools instead to avoid confusion with AI tools
 */
export function createSecureTools(config: SafeToolsConfig) {
  return createSecureSystemTools(config);
}

/**
 * Creates secure system tools with workspace restrictions and safety controls
 */
export function createSecureSystemTools(config: SafeToolsConfig) {
  return {
