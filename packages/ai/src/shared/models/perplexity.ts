...
export type PerplexityModelId = keyof typeof PERPLEXITY_MODELS;
...
export function getModelOutputLimit(modelId: string): number | undefined {
...
export interface PerplexityTier2Config {
  tier2?: {
...
export const DEFAULT_PERPLEXITY_TIER2_CONFIG: PerplexityTier2Config = {
  tier2: {
    enabled: false,
    return_images: false,
  },
...
export const PERPLEXITY_PRESETS = {
  academic: {
...
export interface PerplexityProviderMetadata {
  usage?: {
