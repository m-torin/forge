...
export const PdpUrlCreateArgsSchema: z.ZodType<Prisma.PdpUrlCreateArgs> = z.object({
  select: PdpUrlSelectSchema.optional(),
  include: z.lazy(() => PdpUrlIncludeSchema).optional(),
  data: z.union([ PdpUrlCreateInputSchema,PdpUrlUncheckedCreateInputSchema ]),
}).strict() ;

export default PdpUrlCreateArgsSchema;
