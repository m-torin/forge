...
export const RegistrySelectSchema: z.ZodType<Prisma.RegistrySelect> = z
  .object({
...
export const RegistryFindFirstArgsSchema: z.ZodType<Prisma.RegistryFindFirstArgs> = z
  .object({
    ...
    distinct: z
      .union([RegistryScalarFieldEnumSchema, RegistryScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default RegistryFindFirstArgsSchema;
