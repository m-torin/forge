...
export const InventoryTransactionGroupByArgsSchema: z.ZodType<Prisma.InventoryTransactionGroupByArgs> =
  z
    .object({
      where: InventoryTransactionWhereInputSchema.optional(),
      orderBy: z
        .union([
          InventoryTransactionOrderByWithAggregationInputSchema.array(),
          InventoryTransactionOrderByWithAggregationInputSchema,
        ])
        .optional(),
