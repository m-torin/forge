...
export const JrExtractionRuleFindFirstOrThrowArgsSchema: z.ZodType<Prisma.JrExtractionRuleFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          JrExtractionRuleScalarFieldEnumSchema,
          JrExtractionRuleScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();
