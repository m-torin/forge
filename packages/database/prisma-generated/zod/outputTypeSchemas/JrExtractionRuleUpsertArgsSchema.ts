...
import { JrExtractionRuleUpdateInputSchema } from '../inputTypeSchemas/JrExtractionRuleUpdateInputSchema'
import { JrExtractionRuleUncheckedUpdateInputSchema } from '../inputTypeSchemas/JrExtractionRuleUncheckedUpdateInputSchema'
...
export const JrExtractionRuleUpsertArgsSchema: z.ZodType<Prisma.JrExtractionRuleUpsertArgs> = z.object({
  select: JrExtractionRuleSelectSchema.optional(),
  include: z.lazy(() => JrExtractionRuleIncludeSchema).optional(),
  where: JrExtractionRuleWhereUniqueInputSchema,
  create: z.union([ JrExtractionRuleCreateInputSchema,JrExtractionRuleUncheckedCreateInputSchema ]),
  update: z.union([ JrExtractionRuleUpdateInputSchema,JrExtractionRuleUncheckedUpdateInputSchema ]),
}).strict() ;

export default JrExtractionRuleUpsertArgsSchema;
