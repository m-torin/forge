...
export const JrExtractionRuleUpsertArgsSchema: z.ZodType<Prisma.JrExtractionRuleUpsertArgs> = z
  .object({
    ...
    create: z.union([
      JrExtractionRuleCreateInputSchema,
      JrExtractionRuleUncheckedCreateInputSchema,
    ]),
    update: z.union([
      JrExtractionRuleUpdateInputSchema,
      JrExtractionRuleUncheckedUpdateInputSchema,
    ]),
  })
  .strict();
