...
export const PdpJoinGroupByArgsSchema: z.ZodType<Prisma.PdpJoinGroupByArgs> = z
  .object({
    where: PdpJoinWhereInputSchema.optional(),
    orderBy: z
      .union([
        PdpJoinOrderByWithAggregationInputSchema.array(),
        PdpJoinOrderByWithAggregationInputSchema,
      ])
      .optional(),
