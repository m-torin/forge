...
export const BrandSelectSchema: z.ZodType<Prisma.BrandSelect> = z
  .object({
    ...
    manufacturedProducts: z
      .union([z.boolean(), z.lazy(() => PdpJoinFindManyArgsSchema)])
      .optional(),
...
export const BrandFindUniqueArgsSchema: z.ZodType<Prisma.BrandFindUniqueArgs> = z
  .object({
...
export default BrandFindUniqueArgsSchema;
