...
export const PdpJoinUpdateArgsSchema: z.ZodType<Prisma.PdpJoinUpdateArgs> = z
  .object({
    select: PdpJoinSelectSchema.optional(),
    include: z.lazy(() => PdpJoinIncludeSchema).optional(),
    data: z.union([PdpJoinUpdateInputSchema, PdpJoinUncheckedUpdateInputSchema]),
    where: PdpJoinWhereUniqueInputSchema,
  })
  .strict();

export default PdpJoinUpdateArgsSchema;
