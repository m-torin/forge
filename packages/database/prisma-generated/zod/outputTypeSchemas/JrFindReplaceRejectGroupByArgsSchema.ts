...
export const JrFindReplaceRejectGroupByArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectGroupByArgs> = z.object({
  where: JrFindReplaceRejectWhereInputSchema.optional(),
  orderBy: z.union([ JrFindReplaceRejectOrderByWithAggregationInputSchema.array(),JrFindReplaceRejectOrderByWithAggregationInputSchema ]).optional(),
