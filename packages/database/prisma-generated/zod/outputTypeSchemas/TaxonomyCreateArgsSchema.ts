...
export const TaxonomyCreateArgsSchema: z.ZodType<Prisma.TaxonomyCreateArgs> = z.object({
  select: TaxonomySelectSchema.optional(),
  include: z.lazy(() => TaxonomyIncludeSchema).optional(),
  data: z.union([ TaxonomyCreateInputSchema,TaxonomyUncheckedCreateInputSchema ]),
}).strict() ;

export default TaxonomyCreateArgsSchema;
