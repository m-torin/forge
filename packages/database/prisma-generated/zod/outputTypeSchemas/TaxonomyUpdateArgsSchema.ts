...
export const TaxonomyUpdateArgsSchema: z.ZodType<Prisma.TaxonomyUpdateArgs> = z.object({
  select: TaxonomySelectSchema.optional(),
  include: z.lazy(() => TaxonomyIncludeSchema).optional(),
  data: z.union([ TaxonomyUpdateInputSchema,TaxonomyUncheckedUpdateInputSchema ]),
  where: TaxonomyWhereUniqueInputSchema,
}).strict() ;

export default TaxonomyUpdateArgsSchema;
