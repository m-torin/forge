...
export const TeamMemberFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TeamMemberFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([TeamMemberScalarFieldEnumSchema, TeamMemberScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();

export default TeamMemberFindFirstOrThrowArgsSchema;
