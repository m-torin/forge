...
export const WorkflowScheduleCreateArgsSchema: z.ZodType<Prisma.WorkflowScheduleCreateArgs> = z.object({
  select: WorkflowScheduleSelectSchema.optional(),
  include: z.lazy(() => WorkflowScheduleIncludeSchema).optional(),
  data: z.union([ WorkflowScheduleCreateInputSchema,WorkflowScheduleUncheckedCreateInputSchema ]),
}).strict() ;

export default WorkflowScheduleCreateArgsSchema;
