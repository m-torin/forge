...
export const JrExtractionRuleUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.JrExtractionRuleUpdateManyAndReturnArgs> = z.object({
  data: z.union([ JrExtractionRuleUpdateManyMutationInputSchema,JrExtractionRuleUncheckedUpdateManyInputSchema ]),
  where: JrExtractionRuleWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;

export default JrExtractionRuleUpdateManyAndReturnArgsSchema;
