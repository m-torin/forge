...
export const CastGroupByArgsSchema: z.ZodType<Prisma.CastGroupByArgs> = z
  .object({
    where: CastWhereInputSchema.optional(),
    orderBy: z
      .union([CastOrderByWithAggregationInputSchema.array(), CastOrderByWithAggregationInputSchema])
      .optional(),
