...
export const JrFindReplaceRejectFindFirstOrThrowArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectFindFirstOrThrowArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          JrFindReplaceRejectOrderByWithRelationInputSchema.array(),
          JrFindReplaceRejectOrderByWithRelationInputSchema,
        ])
        .optional(),
      ...
      distinct: z
        .union([
          JrFindReplaceRejectScalarFieldEnumSchema,
          JrFindReplaceRejectScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();

export default JrFindReplaceRejectFindFirstOrThrowArgsSchema;
