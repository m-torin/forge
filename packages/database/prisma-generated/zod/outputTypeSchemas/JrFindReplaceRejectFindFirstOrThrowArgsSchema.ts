...
export const JrFindReplaceRejectFindFirstOrThrowArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ JrFindReplaceRejectScalarFieldEnumSchema,JrFindReplaceRejectScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;
