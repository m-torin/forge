...
export const RegistryPurchaseJoinCreateArgsSchema: z.ZodType<Prisma.RegistryPurchaseJoinCreateArgs> = z.object({
  select: RegistryPurchaseJoinSelectSchema.optional(),
  include: z.lazy(() => RegistryPurchaseJoinIncludeSchema).optional(),
  data: z.union([ RegistryPurchaseJoinCreateInputSchema,RegistryPurchaseJoinUncheckedCreateInputSchema ]),
}).strict() ;

export default RegistryPurchaseJoinCreateArgsSchema;
