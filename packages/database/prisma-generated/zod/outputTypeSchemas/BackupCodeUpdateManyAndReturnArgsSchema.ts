...
export const BackupCodeUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.BackupCodeUpdateManyAndReturnArgs> = z.object({
  data: z.union([ BackupCodeUpdateManyMutationInputSchema,BackupCodeUncheckedUpdateManyInputSchema ]),
