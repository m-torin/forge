...
export const JrFindReplaceRejectUpsertArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectUpsertArgs> = z.object({
  ...
  create: z.union([ JrFindReplaceRejectCreateInputSchema,JrFindReplaceRejectUncheckedCreateInputSchema ]),
  update: z.union([ JrFindReplaceRejectUpdateInputSchema,JrFindReplaceRejectUncheckedUpdateInputSchema ]),
}).strict() ;
