...
export const WorkflowExecutionUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.WorkflowExecutionUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        WorkflowExecutionUpdateManyMutationInputSchema,
        WorkflowExecutionUncheckedUpdateManyInputSchema,
      ]),
