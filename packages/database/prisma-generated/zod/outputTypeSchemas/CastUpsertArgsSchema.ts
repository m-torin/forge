...
import { CastCreateInputSchema } from '../inputTypeSchemas/CastCreateInputSchema'
import { CastUncheckedCreateInputSchema } from '../inputTypeSchemas/CastUncheckedCreateInputSchema'
...
export const CastUpsertArgsSchema: z.ZodType<Prisma.CastUpsertArgs> = z.object({
  select: CastSelectSchema.optional(),
  include: z.lazy(() => CastIncludeSchema).optional(),
  where: CastWhereUniqueInputSchema,
  create: z.union([ CastCreateInputSchema,CastUncheckedCreateInputSchema ]),
  update: z.union([ CastUpdateInputSchema,CastUncheckedUpdateInputSchema ]),
}).strict() ;

export default CastUpsertArgsSchema;
