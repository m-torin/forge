...
export const PdpUrlUpdateArgsSchema: z.ZodType<Prisma.PdpUrlUpdateArgs> = z.object({
  select: PdpUrlSelectSchema.optional(),
  include: z.lazy(() => PdpUrlIncludeSchema).optional(),
  data: z.union([ PdpUrlUpdateInputSchema,PdpUrlUncheckedUpdateInputSchema ]),
  where: PdpUrlWhereUniqueInputSchema,
}).strict() ;

export default PdpUrlUpdateArgsSchema;
