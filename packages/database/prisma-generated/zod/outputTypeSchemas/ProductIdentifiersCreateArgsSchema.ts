...
export const ProductIdentifiersCreateArgsSchema: z.ZodType<Prisma.ProductIdentifiersCreateArgs> = z.object({
  select: ProductIdentifiersSelectSchema.optional(),
  include: z.lazy(() => ProductIdentifiersIncludeSchema).optional(),
  data: z.union([ ProductIdentifiersCreateInputSchema,ProductIdentifiersUncheckedCreateInputSchema ]),
}).strict() ;

export default ProductIdentifiersCreateArgsSchema;
