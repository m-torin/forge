...
export const RegistryPurchaseJoinFindFirstOrThrowArgsSchema: z.ZodType<Prisma.RegistryPurchaseJoinFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ RegistryPurchaseJoinOrderByWithRelationInputSchema.array(),RegistryPurchaseJoinOrderByWithRelationInputSchema ]).optional(),
  cursor: RegistryPurchaseJoinWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ RegistryPurchaseJoinScalarFieldEnumSchema,RegistryPurchaseJoinScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default RegistryPurchaseJoinFindFirstOrThrowArgsSchema;
