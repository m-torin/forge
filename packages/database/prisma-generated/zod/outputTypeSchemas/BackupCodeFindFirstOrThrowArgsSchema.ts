...
export const BackupCodeFindFirstOrThrowArgsSchema: z.ZodType<Prisma.BackupCodeFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([BackupCodeScalarFieldEnumSchema, BackupCodeScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();

export default BackupCodeFindFirstOrThrowArgsSchema;
