...
export const WorkflowConfigGroupByArgsSchema: z.ZodType<Prisma.WorkflowConfigGroupByArgs> = z
  .object({
    where: WorkflowConfigWhereInputSchema.optional(),
    orderBy: z
      .union([
        WorkflowConfigOrderByWithAggregationInputSchema.array(),
        WorkflowConfigOrderByWithAggregationInputSchema,
      ])
      .optional(),
