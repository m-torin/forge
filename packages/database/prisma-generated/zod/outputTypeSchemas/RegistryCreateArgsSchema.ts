...
export const RegistryCreateArgsSchema: z.ZodType<Prisma.RegistryCreateArgs> = z
  .object({
    select: RegistrySelectSchema.optional(),
    include: z.lazy(() => RegistryIncludeSchema).optional(),
    data: z.union([RegistryCreateInputSchema, RegistryUncheckedCreateInputSchema]),
  })
  .strict();

export default RegistryCreateArgsSchema;
