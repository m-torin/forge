...
export const InvitationSelectSchema: z.ZodType<Prisma.InvitationSelect> = z
  .object({
...
export const InvitationFindFirstArgsSchema: z.ZodType<Prisma.InvitationFindFirstArgs> = z
  .object({
    ...
    orderBy: z
      .union([
        InvitationOrderByWithRelationInputSchema.array(),
        InvitationOrderByWithRelationInputSchema,
      ])
      .optional(),
    ...
    distinct: z
      .union([InvitationScalarFieldEnumSchema, InvitationScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default InvitationFindFirstArgsSchema;
