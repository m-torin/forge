...
export const RegistryUserJoinUpdateManyArgsSchema: z.ZodType<Prisma.RegistryUserJoinUpdateManyArgs> = z.object({
  data: z.union([ RegistryUserJoinUpdateManyMutationInputSchema,RegistryUserJoinUncheckedUpdateManyInputSchema ]),
  where: RegistryUserJoinWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;

export default RegistryUserJoinUpdateManyArgsSchema;
