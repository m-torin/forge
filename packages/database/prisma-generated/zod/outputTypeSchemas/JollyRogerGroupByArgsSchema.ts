...
export const JollyRogerGroupByArgsSchema: z.ZodType<Prisma.JollyRogerGroupByArgs> = z.object({
  where: JollyRogerWhereInputSchema.optional(),
  orderBy: z.union([ JollyRogerOrderByWithAggregationInputSchema.array(),JollyRogerOrderByWithAggregationInputSchema ]).optional(),
