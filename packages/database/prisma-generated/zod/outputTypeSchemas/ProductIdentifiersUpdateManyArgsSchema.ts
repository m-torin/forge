...
export const ProductIdentifiersUpdateManyArgsSchema: z.ZodType<Prisma.ProductIdentifiersUpdateManyArgs> =
  z
    .object({
      data: z.union([
        ProductIdentifiersUpdateManyMutationInputSchema,
        ProductIdentifiersUncheckedUpdateManyInputSchema,
      ]),
...
export default ProductIdentifiersUpdateManyArgsSchema;
