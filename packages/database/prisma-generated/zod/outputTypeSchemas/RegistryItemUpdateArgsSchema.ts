...
export const RegistryItemUpdateArgsSchema: z.ZodType<Prisma.RegistryItemUpdateArgs> = z.object({
  select: RegistryItemSelectSchema.optional(),
  include: z.lazy(() => RegistryItemIncludeSchema).optional(),
  data: z.union([ RegistryItemUpdateInputSchema,RegistryItemUncheckedUpdateInputSchema ]),
  where: RegistryItemWhereUniqueInputSchema,
}).strict() ;

export default RegistryItemUpdateArgsSchema;
