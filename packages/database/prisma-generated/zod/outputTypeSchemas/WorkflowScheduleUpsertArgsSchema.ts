...
export const WorkflowScheduleUpsertArgsSchema: z.ZodType<Prisma.WorkflowScheduleUpsertArgs> = z.object({
  ...
  create: z.union([ WorkflowScheduleCreateInputSchema,WorkflowScheduleUncheckedCreateInputSchema ]),
  update: z.union([ WorkflowScheduleUpdateInputSchema,WorkflowScheduleUncheckedUpdateInputSchema ]),
}).strict() ;
