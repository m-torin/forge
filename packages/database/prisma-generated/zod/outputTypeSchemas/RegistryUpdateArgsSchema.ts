...
export const RegistryUpdateArgsSchema: z.ZodType<Prisma.RegistryUpdateArgs> = z
  .object({
    select: RegistrySelectSchema.optional(),
    include: z.lazy(() => RegistryIncludeSchema).optional(),
    data: z.union([RegistryUpdateInputSchema, RegistryUncheckedUpdateInputSchema]),
    where: RegistryWhereUniqueInputSchema,
  })
  .strict();

export default RegistryUpdateArgsSchema;
