...
export const RegistryUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.RegistryUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        RegistryUpdateManyMutationInputSchema,
        RegistryUncheckedUpdateManyInputSchema,
      ]),
...
export default RegistryUpdateManyAndReturnArgsSchema;
