...
export const WorkflowConfigCreateArgsSchema: z.ZodType<Prisma.WorkflowConfigCreateArgs> = z.object({
  select: WorkflowConfigSelectSchema.optional(),
  include: z.lazy(() => WorkflowConfigIncludeSchema).optional(),
  data: z.union([ WorkflowConfigCreateInputSchema,WorkflowConfigUncheckedCreateInputSchema ]),
}).strict() ;

export default WorkflowConfigCreateArgsSchema;
