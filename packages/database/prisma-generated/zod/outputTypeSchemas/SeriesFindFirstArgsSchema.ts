...
export const SeriesFindFirstArgsSchema: z.ZodType<Prisma.SeriesFindFirstArgs> = z
  .object({
    select: SeriesSelectSchema.optional(),
    include: z.lazy(() => SeriesIncludeSchema).optional(),
    where: SeriesWhereInputSchema.optional(),
    orderBy: z
      .union([SeriesOrderByWithRelationInputSchema.array(), SeriesOrderByWithRelationInputSchema])
      .optional(),
    cursor: SeriesWhereUniqueInputSchema.optional(),
    take: z.number().optional(),
    skip: z.number().optional(),
    distinct: z
      .union([SeriesScalarFieldEnumSchema, SeriesScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default SeriesFindFirstArgsSchema;
