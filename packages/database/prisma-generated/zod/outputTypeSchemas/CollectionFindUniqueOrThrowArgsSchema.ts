...
export const CollectionFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CollectionFindUniqueOrThrowArgs> =
  z
    .object({
...
export default CollectionFindUniqueOrThrowArgsSchema;
