...
export const RegistryUserJoinFindFirstArgsSchema: z.ZodType<Prisma.RegistryUserJoinFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ RegistryUserJoinOrderByWithRelationInputSchema.array(),RegistryUserJoinOrderByWithRelationInputSchema ]).optional(),
  cursor: RegistryUserJoinWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ RegistryUserJoinScalarFieldEnumSchema,RegistryUserJoinScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default RegistryUserJoinFindFirstArgsSchema;
