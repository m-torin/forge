...
export const RegistryItemUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.RegistryItemUpdateManyAndReturnArgs> = z.object({
  data: z.union([ RegistryItemUpdateManyMutationInputSchema,RegistryItemUncheckedUpdateManyInputSchema ]),
