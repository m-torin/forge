...
export const RegistryItemGroupByArgsSchema: z.ZodType<Prisma.RegistryItemGroupByArgs> = z.object({
  where: RegistryItemWhereInputSchema.optional(),
  orderBy: z.union([ RegistryItemOrderByWithAggregationInputSchema.array(),RegistryItemOrderByWithAggregationInputSchema ]).optional(),
