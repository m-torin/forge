...
export const JrFindReplaceRejectUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        JrFindReplaceRejectUpdateManyMutationInputSchema,
        JrFindReplaceRejectUncheckedUpdateManyInputSchema,
      ]),
