...
export const FavoriteJoinSelectSchema: z.ZodType<Prisma.FavoriteJoinSelect> = z.object({
...
export const FavoriteJoinFindFirstOrThrowArgsSchema: z.ZodType<Prisma.FavoriteJoinFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ FavoriteJoinScalarFieldEnumSchema,FavoriteJoinScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default FavoriteJoinFindFirstOrThrowArgsSchema;
