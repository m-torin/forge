...
import { WorkflowConfigCreateInputSchema } from '../inputTypeSchemas/WorkflowConfigCreateInputSchema'
import { WorkflowConfigUncheckedCreateInputSchema } from '../inputTypeSchemas/WorkflowConfigUncheckedCreateInputSchema'
...
export const WorkflowConfigUpsertArgsSchema: z.ZodType<Prisma.WorkflowConfigUpsertArgs> = z.object({
  ...
  create: z.union([ WorkflowConfigCreateInputSchema,WorkflowConfigUncheckedCreateInputSchema ]),
  update: z.union([ WorkflowConfigUpdateInputSchema,WorkflowConfigUncheckedUpdateInputSchema ]),
}).strict() ;

export default WorkflowConfigUpsertArgsSchema;
