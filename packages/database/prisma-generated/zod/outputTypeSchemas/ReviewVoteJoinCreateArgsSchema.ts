...
export const ReviewVoteJoinCreateArgsSchema: z.ZodType<Prisma.ReviewVoteJoinCreateArgs> = z.object({
  select: ReviewVoteJoinSelectSchema.optional(),
  include: z.lazy(() => ReviewVoteJoinIncludeSchema).optional(),
  data: z.union([ ReviewVoteJoinCreateInputSchema,ReviewVoteJoinUncheckedCreateInputSchema ]),
}).strict() ;

export default ReviewVoteJoinCreateArgsSchema;
