...
export const WorkflowScheduleFindFirstArgsSchema: z.ZodType<Prisma.WorkflowScheduleFindFirstArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          WorkflowScheduleScalarFieldEnumSchema,
          WorkflowScheduleScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();

export default WorkflowScheduleFindFirstArgsSchema;
