...
export const FandomUpdateArgsSchema: z.ZodType<Prisma.FandomUpdateArgs> = z.object({
  select: FandomSelectSchema.optional(),
  include: z.lazy(() => FandomIncludeSchema).optional(),
  data: z.union([ FandomUpdateInputSchema,FandomUncheckedUpdateInputSchema ]),
  where: FandomWhereUniqueInputSchema,
}).strict() ;

export default FandomUpdateArgsSchema;
