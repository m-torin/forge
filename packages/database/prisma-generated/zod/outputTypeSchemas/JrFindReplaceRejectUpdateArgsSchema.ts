...
export const JrFindReplaceRejectUpdateArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateArgs> = z.object({
  select: JrFindReplaceRejectSelectSchema.optional(),
  include: z.lazy(() => JrFindReplaceRejectIncludeSchema).optional(),
  data: z.union([ JrFindReplaceRejectUpdateInputSchema,JrFindReplaceRejectUncheckedUpdateInputSchema ]),
  where: JrFindReplaceRejectWhereUniqueInputSchema,
}).strict() ;

export default JrFindReplaceRejectUpdateArgsSchema;
