...
export const RegistryPurchaseJoinUpdateArgsSchema: z.ZodType<Prisma.RegistryPurchaseJoinUpdateArgs> = z.object({
  select: RegistryPurchaseJoinSelectSchema.optional(),
  include: z.lazy(() => RegistryPurchaseJoinIncludeSchema).optional(),
  data: z.union([ RegistryPurchaseJoinUpdateInputSchema,RegistryPurchaseJoinUncheckedUpdateInputSchema ]),
  where: RegistryPurchaseJoinWhereUniqueInputSchema,
}).strict() ;

export default RegistryPurchaseJoinUpdateArgsSchema;
