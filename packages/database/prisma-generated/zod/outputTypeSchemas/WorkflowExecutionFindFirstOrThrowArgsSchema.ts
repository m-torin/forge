...
export const WorkflowExecutionFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WorkflowExecutionFindFirstOrThrowArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          WorkflowExecutionOrderByWithRelationInputSchema.array(),
          WorkflowExecutionOrderByWithRelationInputSchema,
        ])
        .optional(),
      ...
      distinct: z
        .union([
          ...
          WorkflowExecutionScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();

export default WorkflowExecutionFindFirstOrThrowArgsSchema;
