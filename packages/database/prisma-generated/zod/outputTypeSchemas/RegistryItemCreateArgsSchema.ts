...
export const RegistryItemCreateArgsSchema: z.ZodType<Prisma.RegistryItemCreateArgs> = z.object({
  select: RegistryItemSelectSchema.optional(),
  include: z.lazy(() => RegistryItemIncludeSchema).optional(),
  data: z.union([ RegistryItemCreateInputSchema,RegistryItemUncheckedCreateInputSchema ]),
}).strict() ;

export default RegistryItemCreateArgsSchema;
