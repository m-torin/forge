...
export const ProductIdentifiersGroupByArgsSchema: z.ZodType<Prisma.ProductIdentifiersGroupByArgs> =
  z
    .object({
      where: ProductIdentifiersWhereInputSchema.optional(),
      orderBy: z
        .union([
          ProductIdentifiersOrderByWithAggregationInputSchema.array(),
          ProductIdentifiersOrderByWithAggregationInputSchema,
        ])
        .optional(),
