...
export const RegistryUserJoinFindManyArgsSchema: z.ZodType<Prisma.RegistryUserJoinFindManyArgs> = z
  .object({
    ...
    distinct: z
      .union([RegistryUserJoinScalarFieldEnumSchema, RegistryUserJoinScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();
