...
import { PdpJoinUpdateInputSchema } from '../inputTypeSchemas/PdpJoinUpdateInputSchema';
import { PdpJoinUncheckedUpdateInputSchema } from '../inputTypeSchemas/PdpJoinUncheckedUpdateInputSchema';
...
export const PdpJoinSelectSchema: z.ZodType<Prisma.PdpJoinSelect> = z
  .object({
...
export const PdpJoinUpsertArgsSchema: z.ZodType<Prisma.PdpJoinUpsertArgs> = z
  .object({
    select: PdpJoinSelectSchema.optional(),
    include: z.lazy(() => PdpJoinIncludeSchema).optional(),
    where: PdpJoinWhereUniqueInputSchema,
    create: z.union([PdpJoinCreateInputSchema, PdpJoinUncheckedCreateInputSchema]),
    update: z.union([PdpJoinUpdateInputSchema, PdpJoinUncheckedUpdateInputSchema]),
  })
  .strict();

export default PdpJoinUpsertArgsSchema;
