...
export const JrFindReplaceRejectCreateArgsSchema: z.ZodType<Prisma.JrFindReplaceRejectCreateArgs> = z.object({
  select: JrFindReplaceRejectSelectSchema.optional(),
  include: z.lazy(() => JrFindReplaceRejectIncludeSchema).optional(),
  data: z.union([ JrFindReplaceRejectCreateInputSchema,JrFindReplaceRejectUncheckedCreateInputSchema ]),
}).strict() ;

export default JrFindReplaceRejectCreateArgsSchema;
