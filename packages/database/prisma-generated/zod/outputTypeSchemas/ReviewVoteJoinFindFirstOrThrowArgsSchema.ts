...
export const ReviewVoteJoinFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ReviewVoteJoinFindFirstOrThrowArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          ReviewVoteJoinOrderByWithRelationInputSchema.array(),
          ReviewVoteJoinOrderByWithRelationInputSchema,
        ])
        .optional(),
      ...
      distinct: z
        .union([ReviewVoteJoinScalarFieldEnumSchema, ReviewVoteJoinScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();

export default ReviewVoteJoinFindFirstOrThrowArgsSchema;
