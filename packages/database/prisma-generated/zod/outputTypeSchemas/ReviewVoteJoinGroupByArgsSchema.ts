...
export const ReviewVoteJoinGroupByArgsSchema: z.ZodType<Prisma.ReviewVoteJoinGroupByArgs> = z.object({
  where: ReviewVoteJoinWhereInputSchema.optional(),
  orderBy: z.union([ ReviewVoteJoinOrderByWithAggregationInputSchema.array(),ReviewVoteJoinOrderByWithAggregationInputSchema ]).optional(),
