...
export const JrExtractionRuleGroupByArgsSchema: z.ZodType<Prisma.JrExtractionRuleGroupByArgs> = z.object({
  where: JrExtractionRuleWhereInputSchema.optional(),
  orderBy: z.union([ JrExtractionRuleOrderByWithAggregationInputSchema.array(),JrExtractionRuleOrderByWithAggregationInputSchema ]).optional(),
