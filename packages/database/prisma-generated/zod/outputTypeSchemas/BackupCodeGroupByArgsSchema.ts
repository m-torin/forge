...
export const BackupCodeGroupByArgsSchema: z.ZodType<Prisma.BackupCodeGroupByArgs> = z.object({
  where: BackupCodeWhereInputSchema.optional(),
  orderBy: z.union([ BackupCodeOrderByWithAggregationInputSchema.array(),BackupCodeOrderByWithAggregationInputSchema ]).optional(),
