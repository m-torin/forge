...
export const InventoryTransactionFindFirstArgsSchema: z.ZodType<Prisma.InventoryTransactionFindFirstArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          InventoryTransactionOrderByWithRelationInputSchema.array(),
          InventoryTransactionOrderByWithRelationInputSchema,
        ])
        .optional(),
      ...
      distinct: z
        .union([
          InventoryTransactionScalarFieldEnumSchema,
          InventoryTransactionScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();

export default InventoryTransactionFindFirstArgsSchema;
