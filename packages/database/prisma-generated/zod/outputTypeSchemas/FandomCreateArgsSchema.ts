...
export const FandomCreateArgsSchema: z.ZodType<Prisma.FandomCreateArgs> = z.object({
  select: FandomSelectSchema.optional(),
  include: z.lazy(() => FandomIncludeSchema).optional(),
  data: z.union([ FandomCreateInputSchema,FandomUncheckedCreateInputSchema ]),
}).strict() ;

export default FandomCreateArgsSchema;
