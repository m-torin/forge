...
export const TaxonomyUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.TaxonomyUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        TaxonomyUpdateManyMutationInputSchema,
        TaxonomyUncheckedUpdateManyInputSchema,
      ]),
