...
export const RegistryUserJoinGroupByArgsSchema: z.ZodType<Prisma.RegistryUserJoinGroupByArgs> = z
  .object({
    where: RegistryUserJoinWhereInputSchema.optional(),
    orderBy: z
      .union([
        RegistryUserJoinOrderByWithAggregationInputSchema.array(),
        RegistryUserJoinOrderByWithAggregationInputSchema,
      ])
      .optional(),
