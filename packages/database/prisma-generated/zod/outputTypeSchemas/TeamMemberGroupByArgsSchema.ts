...
export const TeamMemberGroupByArgsSchema: z.ZodType<Prisma.TeamMemberGroupByArgs> = z.object({
  where: TeamMemberWhereInputSchema.optional(),
  orderBy: z.union([ TeamMemberOrderByWithAggregationInputSchema.array(),TeamMemberOrderByWithAggregationInputSchema ]).optional(),
