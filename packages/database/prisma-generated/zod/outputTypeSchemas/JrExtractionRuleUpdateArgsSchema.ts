...
export const JrExtractionRuleUpdateArgsSchema: z.ZodType<Prisma.JrExtractionRuleUpdateArgs> = z.object({
  select: JrExtractionRuleSelectSchema.optional(),
  include: z.lazy(() => JrExtractionRuleIncludeSchema).optional(),
  data: z.union([ JrExtractionRuleUpdateInputSchema,JrExtractionRuleUncheckedUpdateInputSchema ]),
  where: JrExtractionRuleWhereUniqueInputSchema,
}).strict() ;

export default JrExtractionRuleUpdateArgsSchema;
