...
export const PdpJoinFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PdpJoinFindFirstOrThrowArgs> = z
  .object({
    ...
    distinct: z
      .union([PdpJoinScalarFieldEnumSchema, PdpJoinScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();
