...
export const PdpJoinFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PdpJoinFindFirstOrThrowArgs> = z.object({
  select: PdpJoinSelectSchema.optional(),
  include: z.lazy(() => PdpJoinIncludeSchema).optional(),
  where: PdpJoinWhereInputSchema.optional(),
  orderBy: z.union([ PdpJoinOrderByWithRelationInputSchema.array(),PdpJoinOrderByWithRelationInputSchema ]).optional(),
  cursor: PdpJoinWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ PdpJoinScalarFieldEnumSchema,PdpJoinScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default PdpJoinFindFirstOrThrowArgsSchema;
