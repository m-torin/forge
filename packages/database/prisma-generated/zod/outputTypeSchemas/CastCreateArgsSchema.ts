...
export const CastCreateArgsSchema: z.ZodType<Prisma.CastCreateArgs> = z.object({
  select: CastSelectSchema.optional(),
  include: z.lazy(() => CastIncludeSchema).optional(),
  data: z.union([ CastCreateInputSchema,CastUncheckedCreateInputSchema ]),
}).strict() ;

export default CastCreateArgsSchema;
