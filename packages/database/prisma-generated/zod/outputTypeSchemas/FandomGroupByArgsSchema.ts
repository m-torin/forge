...
export const FandomGroupByArgsSchema: z.ZodType<Prisma.FandomGroupByArgs> = z
  .object({
    where: FandomWhereInputSchema.optional(),
    orderBy: z
      .union([
        FandomOrderByWithAggregationInputSchema.array(),
        FandomOrderByWithAggregationInputSchema,
      ])
      .optional(),
