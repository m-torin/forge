...
export const TaxonomyFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TaxonomyFindUniqueOrThrowArgs> = z.object({
  select: TaxonomySelectSchema.optional(),
  include: z.lazy(() => TaxonomyIncludeSchema).optional(),
  where: TaxonomyWhereUniqueInputSchema,
}).strict() ;

export default TaxonomyFindUniqueOrThrowArgsSchema;
