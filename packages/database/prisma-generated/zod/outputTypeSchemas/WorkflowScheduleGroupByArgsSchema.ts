...
export const WorkflowScheduleGroupByArgsSchema: z.ZodType<Prisma.WorkflowScheduleGroupByArgs> = z.object({
  where: WorkflowScheduleWhereInputSchema.optional(),
  orderBy: z.union([ WorkflowScheduleOrderByWithAggregationInputSchema.array(),WorkflowScheduleOrderByWithAggregationInputSchema ]).optional(),
