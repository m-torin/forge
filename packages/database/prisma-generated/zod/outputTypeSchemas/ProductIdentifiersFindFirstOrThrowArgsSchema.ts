...
export const ProductIdentifiersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ProductIdentifiersFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ ProductIdentifiersOrderByWithRelationInputSchema.array(),ProductIdentifiersOrderByWithRelationInputSchema ]).optional(),
  cursor: ProductIdentifiersWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ ProductIdentifiersScalarFieldEnumSchema,ProductIdentifiersScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default ProductIdentifiersFindFirstOrThrowArgsSchema;
