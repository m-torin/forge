...
export const ProductIdentifiersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ProductIdentifiersFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          ProductIdentifiersScalarFieldEnumSchema,
          ProductIdentifiersScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict();
