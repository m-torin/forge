...
export const TaxonomyFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TaxonomyFindFirstOrThrowArgs> = z
  .object({
    ...
    orderBy: z
      .union([
        TaxonomyOrderByWithRelationInputSchema.array(),
        TaxonomyOrderByWithRelationInputSchema,
      ])
      .optional(),
    ...
    distinct: z
      .union([TaxonomyScalarFieldEnumSchema, TaxonomyScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default TaxonomyFindFirstOrThrowArgsSchema;
