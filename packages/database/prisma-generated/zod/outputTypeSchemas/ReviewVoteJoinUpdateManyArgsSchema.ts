...
export const ReviewVoteJoinUpdateManyArgsSchema: z.ZodType<Prisma.ReviewVoteJoinUpdateManyArgs> = z.object({
  data: z.union([ ReviewVoteJoinUpdateManyMutationInputSchema,ReviewVoteJoinUncheckedUpdateManyInputSchema ]),
  where: ReviewVoteJoinWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;

export default ReviewVoteJoinUpdateManyArgsSchema;
