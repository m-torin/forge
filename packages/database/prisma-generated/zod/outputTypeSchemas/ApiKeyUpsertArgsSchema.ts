...
import { ApiKeyCreateInputSchema } from '../inputTypeSchemas/ApiKeyCreateInputSchema';
import { ApiKeyUncheckedCreateInputSchema } from '../inputTypeSchemas/ApiKeyUncheckedCreateInputSchema';
...
export const ApiKeySelectSchema: z.ZodType<Prisma.ApiKeySelect> = z
  .object({
...
export const ApiKeyUpsertArgsSchema: z.ZodType<Prisma.ApiKeyUpsertArgs> = z
  .object({
...
export default ApiKeyUpsertArgsSchema;
