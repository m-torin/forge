...
export const ProductIdentifiersUpdateArgsSchema: z.ZodType<Prisma.ProductIdentifiersUpdateArgs> = z.object({
  select: ProductIdentifiersSelectSchema.optional(),
  include: z.lazy(() => ProductIdentifiersIncludeSchema).optional(),
  data: z.union([ ProductIdentifiersUpdateInputSchema,ProductIdentifiersUncheckedUpdateInputSchema ]),
  where: ProductIdentifiersWhereUniqueInputSchema,
}).strict() ;

export default ProductIdentifiersUpdateArgsSchema;
