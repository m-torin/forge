...
export const RegistryGroupByArgsSchema: z.ZodType<Prisma.RegistryGroupByArgs> = z.object({
  where: RegistryWhereInputSchema.optional(),
  orderBy: z.union([ RegistryOrderByWithAggregationInputSchema.array(),RegistryOrderByWithAggregationInputSchema ]).optional(),
