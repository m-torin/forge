...
export const JollyRogerUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.JollyRogerUpdateManyAndReturnArgs> = z.object({
  data: z.union([ JollyRogerUpdateManyMutationInputSchema,JollyRogerUncheckedUpdateManyInputSchema ]),
