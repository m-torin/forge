...
export const JollyRogerFindFirstOrThrowArgsSchema: z.ZodType<Prisma.JollyRogerFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([JollyRogerScalarFieldEnumSchema, JollyRogerScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();

export default JollyRogerFindFirstOrThrowArgsSchema;
