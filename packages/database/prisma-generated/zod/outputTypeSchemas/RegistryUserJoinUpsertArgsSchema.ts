...
export const RegistryUserJoinUpsertArgsSchema: z.ZodType<Prisma.RegistryUserJoinUpsertArgs> = z
  .object({
    ...
    create: z.union([
      RegistryUserJoinCreateInputSchema,
      RegistryUserJoinUncheckedCreateInputSchema,
    ]),
    update: z.union([
      RegistryUserJoinUpdateInputSchema,
      RegistryUserJoinUncheckedUpdateInputSchema,
    ]),
  })
  .strict();
