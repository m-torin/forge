...
export const PdpUrlGroupByArgsSchema: z.ZodType<Prisma.PdpUrlGroupByArgs> = z
  .object({
    where: PdpUrlWhereInputSchema.optional(),
    orderBy: z
      .union([
        PdpUrlOrderByWithAggregationInputSchema.array(),
        PdpUrlOrderByWithAggregationInputSchema,
      ])
      .optional(),
