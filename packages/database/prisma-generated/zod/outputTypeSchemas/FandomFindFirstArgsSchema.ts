...
export const FandomFindFirstArgsSchema: z.ZodType<Prisma.FandomFindFirstArgs> = z.object({
  select: FandomSelectSchema.optional(),
  include: z.lazy(() => FandomIncludeSchema).optional(),
  where: FandomWhereInputSchema.optional(),
  orderBy: z.union([ FandomOrderByWithRelationInputSchema.array(),FandomOrderByWithRelationInputSchema ]).optional(),
  cursor: FandomWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ FandomScalarFieldEnumSchema,FandomScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default FandomFindFirstArgsSchema;
