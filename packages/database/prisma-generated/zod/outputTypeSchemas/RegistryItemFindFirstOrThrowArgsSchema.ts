...
export const RegistryItemFindFirstOrThrowArgsSchema: z.ZodType<Prisma.RegistryItemFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([RegistryItemScalarFieldEnumSchema, RegistryItemScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();
