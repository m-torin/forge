...
export const RegistryItemFindFirstOrThrowArgsSchema: z.ZodType<Prisma.RegistryItemFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ RegistryItemOrderByWithRelationInputSchema.array(),RegistryItemOrderByWithRelationInputSchema ]).optional(),
  cursor: RegistryItemWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ RegistryItemScalarFieldEnumSchema,RegistryItemScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default RegistryItemFindFirstOrThrowArgsSchema;
