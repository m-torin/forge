...
export const WorkflowScheduleUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.WorkflowScheduleUpdateManyAndReturnArgs> = z.object({
  data: z.union([ WorkflowScheduleUpdateManyMutationInputSchema,WorkflowScheduleUncheckedUpdateManyInputSchema ]),
  where: WorkflowScheduleWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;

export default WorkflowScheduleUpdateManyAndReturnArgsSchema;
