...
export const PdpUrlFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PdpUrlFindFirstOrThrowArgs> = z
  .object({
    select: PdpUrlSelectSchema.optional(),
    include: z.lazy(() => PdpUrlIncludeSchema).optional(),
    where: PdpUrlWhereInputSchema.optional(),
    orderBy: z
      .union([PdpUrlOrderByWithRelationInputSchema.array(), PdpUrlOrderByWithRelationInputSchema])
      .optional(),
    cursor: PdpUrlWhereUniqueInputSchema.optional(),
    take: z.number().optional(),
    skip: z.number().optional(),
    distinct: z
      .union([PdpUrlScalarFieldEnumSchema, PdpUrlScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default PdpUrlFindFirstOrThrowArgsSchema;
