...
export const RegistryPurchaseJoinGroupByArgsSchema: z.ZodType<Prisma.RegistryPurchaseJoinGroupByArgs> = z.object({
  where: RegistryPurchaseJoinWhereInputSchema.optional(),
  orderBy: z.union([ RegistryPurchaseJoinOrderByWithAggregationInputSchema.array(),RegistryPurchaseJoinOrderByWithAggregationInputSchema ]).optional(),
