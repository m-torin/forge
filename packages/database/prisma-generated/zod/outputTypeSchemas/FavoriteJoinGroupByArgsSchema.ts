...
export const FavoriteJoinGroupByArgsSchema: z.ZodType<Prisma.FavoriteJoinGroupByArgs> = z.object({
  where: FavoriteJoinWhereInputSchema.optional(),
  orderBy: z.union([ FavoriteJoinOrderByWithAggregationInputSchema.array(),FavoriteJoinOrderByWithAggregationInputSchema ]).optional(),
