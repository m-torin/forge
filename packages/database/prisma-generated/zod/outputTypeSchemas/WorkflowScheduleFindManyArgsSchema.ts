...
export const WorkflowScheduleFindManyArgsSchema: z.ZodType<Prisma.WorkflowScheduleFindManyArgs> = z
  .object({
    ...
    orderBy: z
      .union([
        WorkflowScheduleOrderByWithRelationInputSchema.array(),
        WorkflowScheduleOrderByWithRelationInputSchema,
      ])
      .optional(),
    ...
    distinct: z
      .union([WorkflowScheduleScalarFieldEnumSchema, WorkflowScheduleScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default WorkflowScheduleFindManyArgsSchema;
