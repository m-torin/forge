...
export const WorkflowConfigFindFirstArgsSchema: z.ZodType<Prisma.WorkflowConfigFindFirstArgs> = z
  .object({
    ...
    distinct: z
      .union([WorkflowConfigScalarFieldEnumSchema, WorkflowConfigScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict();

export default WorkflowConfigFindFirstArgsSchema;
