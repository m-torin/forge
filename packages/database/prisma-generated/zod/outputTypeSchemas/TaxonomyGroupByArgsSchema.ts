...
export const TaxonomyGroupByArgsSchema: z.ZodType<Prisma.TaxonomyGroupByArgs> = z
  .object({
    where: TaxonomyWhereInputSchema.optional(),
    orderBy: z
      .union([
        TaxonomyOrderByWithAggregationInputSchema.array(),
        TaxonomyOrderByWithAggregationInputSchema,
      ])
      .optional(),
