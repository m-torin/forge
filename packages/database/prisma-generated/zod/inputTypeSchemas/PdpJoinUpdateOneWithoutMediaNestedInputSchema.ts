...
export const PdpJoinUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.PdpJoinUpdateOneWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PdpJoinUpdateToOneWithWhereWithoutMediaInputSchema),
