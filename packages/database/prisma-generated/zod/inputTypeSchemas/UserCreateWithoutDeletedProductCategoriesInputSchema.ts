...
export const UserCreateWithoutDeletedProductCategoriesInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedProductCategoriesInput> = z.object({
  id: z.string(),
  name: z.string(),
  email: z.string(),
  ...
  createdRegistries: z.lazy(() => RegistryCreateNestedManyWithoutCreatedByUserInputSchema).optional(),
