...
import { TransactionCreateNestedManyWithoutOrderInputSchema } from './TransactionCreateNestedManyWithoutOrderInputSchema';

export const OrderCreateWithoutItemsInputSchema: z.ZodType<Prisma.OrderCreateWithoutItemsInput> = z
  .object({
    ...
    shippingAddress: z
      .lazy(() => AddressCreateNestedOneWithoutOrderShippingAddressesInputSchema)
      .optional(),
    billingAddress: z
      .lazy(() => AddressCreateNestedOneWithoutOrderBillingAddressesInputSchema)
      .optional(),
    transactions: z.lazy(() => TransactionCreateNestedManyWithoutOrderInputSchema).optional(),
  })
  .strict();

export default OrderCreateWithoutItemsInputSchema;
