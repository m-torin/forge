...
export const RegistryUserJoinUpdateManyWithWhereWithoutRegistryInputSchema: z.ZodType<Prisma.RegistryUserJoinUpdateManyWithWhereWithoutRegistryInput> = z.object({
  where: z.lazy(() => RegistryUserJoinScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryUserJoinUpdateManyMutationInputSchema),z.lazy(() => RegistryUserJoinUncheckedUpdateManyWithoutRegistryInputSchema) ]),
}).strict();
