...
export const InvitationUpdateManyWithoutTeamNestedInputSchema: z.ZodType<Prisma.InvitationUpdateManyWithoutTeamNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => InvitationUpsertWithWhereUniqueWithoutTeamInputSchema),
          z.lazy(() => InvitationUpsertWithWhereUniqueWithoutTeamInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => InvitationUpdateWithWhereUniqueWithoutTeamInputSchema),
          z.lazy(() => InvitationUpdateWithWhereUniqueWithoutTeamInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => InvitationUpdateManyWithWhereWithoutTeamInputSchema),
          z.lazy(() => InvitationUpdateManyWithWhereWithoutTeamInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default InvitationUpdateManyWithoutTeamNestedInputSchema;
