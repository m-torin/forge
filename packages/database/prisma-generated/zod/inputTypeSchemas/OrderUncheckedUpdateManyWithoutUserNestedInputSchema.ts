    ...
    .object({
      ...
      upsert: z
        .union([
          ...
          z.lazy(() => OrderUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          ...
          z.lazy(() => OrderUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
...
export default OrderUncheckedUpdateManyWithoutUserNestedInputSchema;
