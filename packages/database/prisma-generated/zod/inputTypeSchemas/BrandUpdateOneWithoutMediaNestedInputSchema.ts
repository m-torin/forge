...
export const BrandUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.BrandUpdateOneWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => BrandUpdateToOneWithWhereWithoutMediaInputSchema),
