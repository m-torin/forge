...
export const UserUpsertWithoutDeletedReviewsInputSchema: z.ZodType<Prisma.UserUpsertWithoutDeletedReviewsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutDeletedReviewsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedReviewsInputSchema) ]),
