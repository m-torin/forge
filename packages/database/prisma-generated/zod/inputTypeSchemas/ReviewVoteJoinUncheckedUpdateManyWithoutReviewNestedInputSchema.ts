...
export const ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInputSchema: z.ZodType<Prisma.ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInput> =
  z
    .object({
      create: z
        .union([
