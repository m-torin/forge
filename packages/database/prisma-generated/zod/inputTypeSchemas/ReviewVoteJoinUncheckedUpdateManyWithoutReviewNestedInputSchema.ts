...
export const ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInputSchema: z.ZodType<Prisma.ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReviewVoteJoinUpsertWithWhereUniqueWithoutReviewInputSchema),z.lazy(() => ReviewVoteJoinUpsertWithWhereUniqueWithoutReviewInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReviewVoteJoinCreateManyReviewInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema),z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema),z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema),z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema),z.lazy(() => ReviewVoteJoinWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ReviewVoteJoinUpdateWithWhereUniqueWithoutReviewInputSchema),z.lazy(() => ReviewVoteJoinUpdateWithWhereUniqueWithoutReviewInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReviewVoteJoinUpdateManyWithWhereWithoutReviewInputSchema),z.lazy(() => ReviewVoteJoinUpdateManyWithWhereWithoutReviewInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReviewVoteJoinScalarWhereInputSchema),z.lazy(() => ReviewVoteJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInputSchema;
