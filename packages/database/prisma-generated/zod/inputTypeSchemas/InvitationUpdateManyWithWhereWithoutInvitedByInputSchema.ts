...
export const InvitationUpdateManyWithWhereWithoutInvitedByInputSchema: z.ZodType<Prisma.InvitationUpdateManyWithWhereWithoutInvitedByInput> =
  z
    .object({
      where: z.lazy(() => InvitationScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => InvitationUpdateManyMutationInputSchema),
        z.lazy(() => InvitationUncheckedUpdateManyWithoutInvitedByInputSchema),
      ]),
    })
    .strict();
