...
export const ProductUpdateManyWithoutCastsNestedInputSchema: z.ZodType<Prisma.ProductUpdateManyWithoutCastsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutCastsInputSchema),z.lazy(() => ProductCreateWithoutCastsInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutCastsInputSchema),z.lazy(() => ProductUncheckedCreateWithoutCastsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutCastsInputSchema),z.lazy(() => ProductCreateOrConnectWithoutCastsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductUpsertWithWhereUniqueWithoutCastsInputSchema),z.lazy(() => ProductUpsertWithWhereUniqueWithoutCastsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductUpdateWithWhereUniqueWithoutCastsInputSchema),z.lazy(() => ProductUpdateWithWhereUniqueWithoutCastsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductUpdateManyWithWhereWithoutCastsInputSchema),z.lazy(() => ProductUpdateManyWithWhereWithoutCastsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProductScalarWhereInputSchema),z.lazy(() => ProductScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ProductUpdateManyWithoutCastsNestedInputSchema;
