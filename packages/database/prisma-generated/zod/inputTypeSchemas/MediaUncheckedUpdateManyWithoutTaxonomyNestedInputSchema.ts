...
export const MediaUncheckedUpdateManyWithoutTaxonomyNestedInputSchema: z.ZodType<Prisma.MediaUncheckedUpdateManyWithoutTaxonomyNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => MediaCreateWithoutTaxonomyInputSchema),
          z.lazy(() => MediaCreateWithoutTaxonomyInputSchema).array(),
          z.lazy(() => MediaUncheckedCreateWithoutTaxonomyInputSchema),
          z.lazy(() => MediaUncheckedCreateWithoutTaxonomyInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => MediaCreateOrConnectWithoutTaxonomyInputSchema),
          z.lazy(() => MediaCreateOrConnectWithoutTaxonomyInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutTaxonomyInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutTaxonomyInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutTaxonomyInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutTaxonomyInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutTaxonomyInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutTaxonomyInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUncheckedUpdateManyWithoutTaxonomyNestedInputSchema;
