...
export const MediaUpdateManyWithoutBrandNestedInputSchema: z.ZodType<Prisma.MediaUpdateManyWithoutBrandNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutBrandInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutBrandInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutBrandInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutBrandInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutBrandInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutBrandInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUpdateManyWithoutBrandNestedInputSchema;
