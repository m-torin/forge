...
export const ApiKeyUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.ApiKeyUpdateManyWithWhereWithoutUserInput> =
  z
    .object({
      where: z.lazy(() => ApiKeyScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ApiKeyUpdateManyMutationInputSchema),
        z.lazy(() => ApiKeyUncheckedUpdateManyWithoutUserInputSchema),
      ]),
    })
    .strict();
