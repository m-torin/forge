...
export const ProductIdentifiersWhereInputSchema: z.ZodType<Prisma.ProductIdentifiersWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => ProductIdentifiersWhereInputSchema),
        z.lazy(() => ProductIdentifiersWhereInputSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => ProductIdentifiersWhereInputSchema)
      .array()
      .optional(),
    NOT: z
      .union([
