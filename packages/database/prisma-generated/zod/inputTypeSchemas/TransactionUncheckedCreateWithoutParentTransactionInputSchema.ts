...
export const TransactionUncheckedCreateWithoutParentTransactionInputSchema: z.ZodType<Prisma.TransactionUncheckedCreateWithoutParentTransactionInput> = z.object({
  ...
  refunds: z.lazy(() => TransactionUncheckedCreateNestedManyWithoutParentTransactionInputSchema).optional()
}).strict();

export default TransactionUncheckedCreateWithoutParentTransactionInputSchema;
