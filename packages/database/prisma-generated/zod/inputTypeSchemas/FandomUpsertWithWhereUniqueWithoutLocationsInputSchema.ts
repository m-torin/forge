...
export const FandomUpsertWithWhereUniqueWithoutLocationsInputSchema: z.ZodType<Prisma.FandomUpsertWithWhereUniqueWithoutLocationsInput> =
  z
    .object({
      where: z.lazy(() => FandomWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => FandomUpdateWithoutLocationsInputSchema),
        z.lazy(() => FandomUncheckedUpdateWithoutLocationsInputSchema),
      ]),
      create: z.union([
