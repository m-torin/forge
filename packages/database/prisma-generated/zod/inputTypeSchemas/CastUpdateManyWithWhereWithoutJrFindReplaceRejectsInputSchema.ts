...
export const CastUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.CastUpdateManyWithWhereWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      where: z.lazy(() => CastScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CastUpdateManyMutationInputSchema),
        z.lazy(() => CastUncheckedUpdateManyWithoutJrFindReplaceRejectsInputSchema),
      ]),
    })
    .strict();
