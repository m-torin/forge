...
export const UserUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutMediaInputSchema),
