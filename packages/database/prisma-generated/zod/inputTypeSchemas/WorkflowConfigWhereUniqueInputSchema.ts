...
export const WorkflowConfigWhereUniqueInputSchema: z.ZodType<Prisma.WorkflowConfigWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
        workflowSlug_organizationId: z.lazy(
          () => WorkflowConfigWorkflowSlugOrganizationIdCompoundUniqueInputSchema,
        ),
        workflowSlug_userId: z.lazy(
          () => WorkflowConfigWorkflowSlugUserIdCompoundUniqueInputSchema,
        ),
      }),
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        .object({
          ...
          workflowSlug_organizationId: z
            .lazy(() => WorkflowConfigWorkflowSlugOrganizationIdCompoundUniqueInputSchema)
            .optional(),
          workflowSlug_userId: z
            .lazy(() => WorkflowConfigWorkflowSlugUserIdCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
