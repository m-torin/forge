...
export const ApiKeyUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.ApiKeyUncheckedCreateWithoutUserInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default ApiKeyUncheckedCreateWithoutUserInputSchema;
