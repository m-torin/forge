...
export const PdpJoinUpdateWithWhereUniqueWithoutLocationsInputSchema: z.ZodType<Prisma.PdpJoinUpdateWithWhereUniqueWithoutLocationsInput> = z.object({
  where: z.lazy(() => PdpJoinWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => PdpJoinUpdateWithoutLocationsInputSchema),z.lazy(() => PdpJoinUncheckedUpdateWithoutLocationsInputSchema) ]),
}).strict();
