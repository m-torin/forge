...
export const StoryUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.StoryUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => StoryUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => StoryUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => StoryUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => StoryUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StoryUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => StoryUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StoryScalarWhereInputSchema),z.lazy(() => StoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default StoryUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema;
