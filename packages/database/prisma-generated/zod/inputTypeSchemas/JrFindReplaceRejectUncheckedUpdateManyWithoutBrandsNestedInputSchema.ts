...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutBrandsNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutBrandsNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => JrFindReplaceRejectCreateWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectCreateWithoutBrandsInputSchema).array(),
          z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutBrandsInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutBrandsInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutBrandsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutBrandsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutBrandsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutBrandsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default JrFindReplaceRejectUncheckedUpdateManyWithoutBrandsNestedInputSchema;
