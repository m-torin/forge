...
export const ProductUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutTaxonomiesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutTaxonomiesInputSchema),
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutTaxonomiesInputSchema),
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ProductUpdateManyWithWhereWithoutTaxonomiesInputSchema),
          z.lazy(() => ProductUpdateManyWithWhereWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default ProductUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema;
