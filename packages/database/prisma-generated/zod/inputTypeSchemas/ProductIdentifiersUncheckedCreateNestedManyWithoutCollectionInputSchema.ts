...
export const ProductIdentifiersUncheckedCreateNestedManyWithoutCollectionInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedCreateNestedManyWithoutCollectionInput> =
  z
    .object({
      create: z
        .union([
