...
export const UserUpdateOneWithoutDeletedMediaNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedMediaNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedMediaInputSchema),z.lazy(() => UserUpdateWithoutDeletedMediaInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedMediaInputSchema) ]).optional(),
}).strict();
