...
export const StoryUpdateManyWithWhereWithoutSeriesInputSchema: z.ZodType<Prisma.StoryUpdateManyWithWhereWithoutSeriesInput> = z.object({
  where: z.lazy(() => StoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => StoryUpdateManyMutationInputSchema),z.lazy(() => StoryUncheckedUpdateManyWithoutSeriesInputSchema) ]),
}).strict();
