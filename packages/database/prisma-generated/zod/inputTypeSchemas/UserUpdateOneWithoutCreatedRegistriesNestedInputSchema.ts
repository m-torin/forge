...
export const UserUpdateOneWithoutCreatedRegistriesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutCreatedRegistriesNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutCreatedRegistriesInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutCreatedRegistriesInputSchema),
