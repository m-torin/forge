...
export const BrandUncheckedUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.BrandUncheckedUpdateManyWithoutCollectionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => BrandCreateWithoutCollectionsInputSchema),z.lazy(() => BrandCreateWithoutCollectionsInputSchema).array(),z.lazy(() => BrandUncheckedCreateWithoutCollectionsInputSchema),z.lazy(() => BrandUncheckedCreateWithoutCollectionsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BrandCreateOrConnectWithoutCollectionsInputSchema),z.lazy(() => BrandCreateOrConnectWithoutCollectionsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => BrandUpsertWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => BrandUpsertWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BrandUpdateWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => BrandUpdateWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BrandUpdateManyWithWhereWithoutCollectionsInputSchema),z.lazy(() => BrandUpdateManyWithWhereWithoutCollectionsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BrandScalarWhereInputSchema),z.lazy(() => BrandScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BrandUncheckedUpdateManyWithoutCollectionsNestedInputSchema;
