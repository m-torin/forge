    ...
    .object({
      ...
      upsert: z
        .union([
          ...
          z.lazy(() => MemberUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          ...
          z.lazy(() => MemberUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
...
export default MemberUncheckedUpdateManyWithoutUserNestedInputSchema;
