...
export const BrandUncheckedCreateNestedManyWithoutManufacturedProductsInputSchema: z.ZodType<Prisma.BrandUncheckedCreateNestedManyWithoutManufacturedProductsInput> =
  z
    .object({
      create: z
        .union([
