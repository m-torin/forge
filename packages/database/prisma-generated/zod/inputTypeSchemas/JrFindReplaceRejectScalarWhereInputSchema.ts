...
export const JrFindReplaceRejectScalarWhereInputSchema: z.ZodType<Prisma.JrFindReplaceRejectScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => JrFindReplaceRejectScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
