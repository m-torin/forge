...
export const WorkflowScheduleScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.WorkflowScheduleScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => WorkflowScheduleScalarWhereWithAggregatesInputSchema),z.lazy(() => WorkflowScheduleScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => WorkflowScheduleScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WorkflowScheduleScalarWhereWithAggregatesInputSchema),z.lazy(() => WorkflowScheduleScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  configId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  cronExpression: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  ...
  lastRunStatus: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
