...
export const ArticleUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.ArticleUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export default ArticleUncheckedCreateNestedManyWithoutUserInputSchema;
