...
import { UserUpdateOneWithoutAddressesNestedInputSchema } from './UserUpdateOneWithoutAddressesNestedInputSchema';
import { OrderUpdateManyWithoutShippingAddressNestedInputSchema } from './OrderUpdateManyWithoutShippingAddressNestedInputSchema';
import { OrderUpdateManyWithoutBillingAddressNestedInputSchema } from './OrderUpdateManyWithoutBillingAddressNestedInputSchema';
...
export const AddressUpdateInputSchema: z.ZodType<Prisma.AddressUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneWithoutAddressesNestedInputSchema).optional(),
  orderShippingAddresses: z.lazy(() => OrderUpdateManyWithoutShippingAddressNestedInputSchema).optional(),
  orderBillingAddresses: z.lazy(() => OrderUpdateManyWithoutBillingAddressNestedInputSchema).optional()
}).strict();
