...
export const JrFindReplaceRejectUpdateManyWithWhereWithoutStoriesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithWhereWithoutStoriesInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateManyMutationInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutStoriesInputSchema),
      ]),
    })
    .strict();
