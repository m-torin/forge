...
export const ProductUpdateManyWithoutFandomsNestedInputSchema: z.ZodType<Prisma.ProductUpdateManyWithoutFandomsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ProductUpdateManyWithWhereWithoutFandomsInputSchema),
          z.lazy(() => ProductUpdateManyWithWhereWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default ProductUpdateManyWithoutFandomsNestedInputSchema;
