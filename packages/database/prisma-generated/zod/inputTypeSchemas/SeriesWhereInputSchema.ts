...
export const SeriesWhereInputSchema: z.ZodType<Prisma.SeriesWhereInput> = z
  .object({
    AND: z
      .union([z.lazy(() => SeriesWhereInputSchema), z.lazy(() => SeriesWhereInputSchema).array()])
      .optional(),
    OR: z
...
export default SeriesWhereInputSchema;
