...
export const SeriesUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.SeriesUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      create: z
        .union([
