...
export const SeriesUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.SeriesUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => SeriesWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SeriesUpdateWithoutDeletedByInputSchema),z.lazy(() => SeriesUncheckedUpdateWithoutDeletedByInputSchema) ]),
  create: z.union([ z.lazy(() => SeriesCreateWithoutDeletedByInputSchema),z.lazy(() => SeriesUncheckedCreateWithoutDeletedByInputSchema) ]),
}).strict();
