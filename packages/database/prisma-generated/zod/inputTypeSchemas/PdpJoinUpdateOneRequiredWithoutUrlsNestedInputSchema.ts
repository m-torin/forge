...
export const PdpJoinUpdateOneRequiredWithoutUrlsNestedInputSchema: z.ZodType<Prisma.PdpJoinUpdateOneRequiredWithoutUrlsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PdpJoinUpdateToOneWithWhereWithoutUrlsInputSchema),
