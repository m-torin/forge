...
export const ProductUpdateOneWithoutOrderItemVariantsNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutOrderItemVariantsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateToOneWithWhereWithoutOrderItemVariantsInputSchema),
          z.lazy(() => ProductUpdateWithoutOrderItemVariantsInputSchema),
          z.lazy(() => ProductUncheckedUpdateWithoutOrderItemVariantsInputSchema),
        ])
        .optional(),
    })
    .strict();
