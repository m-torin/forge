...
export const CastUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.CastUncheckedUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => CastCreateWithoutDeletedByInputSchema),
          z.lazy(() => CastCreateWithoutDeletedByInputSchema).array(),
          z.lazy(() => CastUncheckedCreateWithoutDeletedByInputSchema),
          z.lazy(() => CastUncheckedCreateWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => CastCreateOrConnectWithoutDeletedByInputSchema),
          z.lazy(() => CastCreateOrConnectWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => CastUpsertWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => CastUpsertWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CastUpdateWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => CastUpdateWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CastUpdateManyWithWhereWithoutDeletedByInputSchema),
          z.lazy(() => CastUpdateManyWithWhereWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
