...
export const BackupCodeUpsertWithWhereUniqueWithoutTwoFactorInputSchema: z.ZodType<Prisma.BackupCodeUpsertWithWhereUniqueWithoutTwoFactorInput> = z.object({
  where: z.lazy(() => BackupCodeWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => BackupCodeUpdateWithoutTwoFactorInputSchema),z.lazy(() => BackupCodeUncheckedUpdateWithoutTwoFactorInputSchema) ]),
