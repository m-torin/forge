...
export const PdpJoinUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithoutTaxonomiesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutTaxonomiesInputSchema),
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutTaxonomiesInputSchema),
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutTaxonomiesInputSchema),
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default PdpJoinUpdateManyWithoutTaxonomiesNestedInputSchema;
