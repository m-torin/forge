...
export const InvitationUncheckedUpdateManyWithoutInvitedByNestedInputSchema: z.ZodType<Prisma.InvitationUncheckedUpdateManyWithoutInvitedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default InvitationUncheckedUpdateManyWithoutInvitedByNestedInputSchema;
