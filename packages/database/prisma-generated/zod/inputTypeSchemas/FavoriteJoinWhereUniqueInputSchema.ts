...
export const FavoriteJoinWhereUniqueInputSchema: z.ZodType<Prisma.FavoriteJoinWhereUniqueInput> = z
  .union([
    z.object({
      id: z.string().cuid(),
      userId_productId_collectionId: z.lazy(
        () => FavoriteJoinUserIdProductIdCollectionIdCompoundUniqueInputSchema,
      ),
    }),
    z.object({
      id: z.string().cuid(),
  ...
  .and(
    z
      .object({
        ...
        userId_productId_collectionId: z
          .lazy(() => FavoriteJoinUserIdProductIdCollectionIdCompoundUniqueInputSchema)
          .optional(),
        AND: z
          .union([
