...
export const PdpJoinScalarWhereInputSchema: z.ZodType<Prisma.PdpJoinScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => PdpJoinScalarWhereInputSchema),z.lazy(() => PdpJoinScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PdpJoinScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PdpJoinScalarWhereInputSchema),z.lazy(() => PdpJoinScalarWhereInputSchema).array() ]).optional(),
