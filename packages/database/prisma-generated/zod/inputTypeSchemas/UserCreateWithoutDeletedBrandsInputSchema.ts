...
export const UserCreateWithoutDeletedBrandsInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedBrandsInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedBrandsInputSchema;
