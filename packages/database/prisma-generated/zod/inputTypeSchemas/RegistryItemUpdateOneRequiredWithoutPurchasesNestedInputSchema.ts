...
export const RegistryItemUpdateOneRequiredWithoutPurchasesNestedInputSchema: z.ZodType<Prisma.RegistryItemUpdateOneRequiredWithoutPurchasesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => RegistryItemUpdateToOneWithWhereWithoutPurchasesInputSchema),z.lazy(() => RegistryItemUpdateWithoutPurchasesInputSchema),z.lazy(() => RegistryItemUncheckedUpdateWithoutPurchasesInputSchema) ]).optional(),
}).strict();
