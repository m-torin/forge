...
export const UserUpsertWithoutDeletedCastsInputSchema: z.ZodType<Prisma.UserUpsertWithoutDeletedCastsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutDeletedCastsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedCastsInputSchema) ]),
