...
export const RegistryItemUpdateManyWithWhereWithoutRegistryInputSchema: z.ZodType<Prisma.RegistryItemUpdateManyWithWhereWithoutRegistryInput> = z.object({
  where: z.lazy(() => RegistryItemScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryItemUpdateManyMutationInputSchema),z.lazy(() => RegistryItemUncheckedUpdateManyWithoutRegistryInputSchema) ]),
}).strict();
