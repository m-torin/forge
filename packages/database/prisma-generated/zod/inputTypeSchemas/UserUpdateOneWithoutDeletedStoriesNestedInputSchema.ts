...
export const UserUpdateOneWithoutDeletedStoriesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedStoriesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedStoriesInputSchema),z.lazy(() => UserUpdateWithoutDeletedStoriesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedStoriesInputSchema) ]).optional(),
}).strict();
