...
export const CastUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.CastUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => CastScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CastUpdateManyMutationInputSchema),
        z.lazy(() => CastUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
