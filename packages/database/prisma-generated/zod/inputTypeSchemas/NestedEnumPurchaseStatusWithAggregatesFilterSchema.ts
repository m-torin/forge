...
export const NestedEnumPurchaseStatusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumPurchaseStatusWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          ...
          z.lazy(() => NestedEnumPurchaseStatusWithAggregatesFilterSchema),
        ])
        .optional(),
