...
export const BrandUpdateManyWithWhereWithoutCollectionsInputSchema: z.ZodType<Prisma.BrandUpdateManyWithWhereWithoutCollectionsInput> =
  z
    .object({
      where: z.lazy(() => BrandScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => BrandUpdateManyMutationInputSchema),
        z.lazy(() => BrandUncheckedUpdateManyWithoutCollectionsInputSchema),
      ]),
    })
    .strict();
