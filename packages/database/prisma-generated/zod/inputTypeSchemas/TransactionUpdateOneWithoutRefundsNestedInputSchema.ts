...
export const TransactionUpdateOneWithoutRefundsNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneWithoutRefundsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => TransactionUpdateToOneWithWhereWithoutRefundsInputSchema),z.lazy(() => TransactionUpdateWithoutRefundsInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutRefundsInputSchema) ]).optional(),
}).strict();
