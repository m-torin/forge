...
export const WorkflowConfigUncheckedCreateInputSchema: z.ZodType<Prisma.WorkflowConfigUncheckedCreateInput> =
  z
    .object({
      ...
      schedules: z
        .lazy(() => WorkflowScheduleUncheckedCreateNestedManyWithoutConfigInputSchema)
        .optional(),
    })
    .strict();
