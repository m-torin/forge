...
export const RegistryItemUpdateWithWhereUniqueWithoutRegistryInputSchema: z.ZodType<Prisma.RegistryItemUpdateWithWhereUniqueWithoutRegistryInput> = z.object({
  where: z.lazy(() => RegistryItemWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RegistryItemUpdateWithoutRegistryInputSchema),z.lazy(() => RegistryItemUncheckedUpdateWithoutRegistryInputSchema) ]),
}).strict();
