...
export const TaxonomyUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.TaxonomyUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      create: z
        .union([
