...
export const ProductUncheckedCreateNestedManyWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutDeletedByInput> =
  z
    .object({
      create: z
        .union([
...
export default ProductUncheckedCreateNestedManyWithoutDeletedByInputSchema;
