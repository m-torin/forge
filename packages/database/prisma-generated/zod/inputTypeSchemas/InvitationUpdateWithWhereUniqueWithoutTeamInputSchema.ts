...
export const InvitationUpdateWithWhereUniqueWithoutTeamInputSchema: z.ZodType<Prisma.InvitationUpdateWithWhereUniqueWithoutTeamInput> = z.object({
  where: z.lazy(() => InvitationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InvitationUpdateWithoutTeamInputSchema),z.lazy(() => InvitationUncheckedUpdateWithoutTeamInputSchema) ]),
}).strict();
