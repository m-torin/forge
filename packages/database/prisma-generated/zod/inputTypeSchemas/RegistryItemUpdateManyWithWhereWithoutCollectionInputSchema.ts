...
export const RegistryItemUpdateManyWithWhereWithoutCollectionInputSchema: z.ZodType<Prisma.RegistryItemUpdateManyWithWhereWithoutCollectionInput> = z.object({
  where: z.lazy(() => RegistryItemScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryItemUpdateManyMutationInputSchema),z.lazy(() => RegistryItemUncheckedUpdateManyWithoutCollectionInputSchema) ]),
}).strict();
