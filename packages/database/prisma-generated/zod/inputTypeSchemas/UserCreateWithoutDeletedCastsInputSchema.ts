...
export const UserCreateWithoutDeletedCastsInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedCastsInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedCastsInputSchema;
