...
export const StoryUncheckedUpdateManyWithoutFandomNestedInputSchema: z.ZodType<Prisma.StoryUncheckedUpdateManyWithoutFandomNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => StoryUpsertWithWhereUniqueWithoutFandomInputSchema),z.lazy(() => StoryUpsertWithWhereUniqueWithoutFandomInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => StoryUpdateWithWhereUniqueWithoutFandomInputSchema),z.lazy(() => StoryUpdateWithWhereUniqueWithoutFandomInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StoryUpdateManyWithWhereWithoutFandomInputSchema),z.lazy(() => StoryUpdateManyWithWhereWithoutFandomInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StoryScalarWhereInputSchema),z.lazy(() => StoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default StoryUncheckedUpdateManyWithoutFandomNestedInputSchema;
