...
export const CastWhereUniqueInputSchema: z.ZodType<Prisma.CastWhereUniqueInput> = z
  .union([
    z.object({
      id: z.string().cuid(),
      slug: z.string(),
  ...
  .and(
    z
      .object({
        ...
        AND: z
          .union([z.lazy(() => CastWhereInputSchema), z.lazy(() => CastWhereInputSchema).array()])
          .optional(),
        OR: z
          .lazy(() => CastWhereInputSchema)
          .array()
          .optional(),
        NOT: z
          .union([z.lazy(() => CastWhereInputSchema), z.lazy(() => CastWhereInputSchema).array()])
