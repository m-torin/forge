...
export const RegistryItemUpdateToOneWithWhereWithoutPurchasesInputSchema: z.ZodType<Prisma.RegistryItemUpdateToOneWithWhereWithoutPurchasesInput> = z.object({
  where: z.lazy(() => RegistryItemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => RegistryItemUpdateWithoutPurchasesInputSchema),z.lazy(() => RegistryItemUncheckedUpdateWithoutPurchasesInputSchema) ]),
}).strict();
