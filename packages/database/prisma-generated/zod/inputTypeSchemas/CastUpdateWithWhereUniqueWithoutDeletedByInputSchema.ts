...
export const CastUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.CastUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => CastWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CastUpdateWithoutDeletedByInputSchema),z.lazy(() => CastUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
