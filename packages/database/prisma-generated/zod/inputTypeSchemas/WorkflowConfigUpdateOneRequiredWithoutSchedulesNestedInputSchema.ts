...
export const WorkflowConfigUpdateOneRequiredWithoutSchedulesNestedInputSchema: z.ZodType<Prisma.WorkflowConfigUpdateOneRequiredWithoutSchedulesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => WorkflowConfigUpdateToOneWithWhereWithoutSchedulesInputSchema),
