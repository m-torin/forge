...
export const SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInput> =
  z
    .object({
      create: z
        .union([
