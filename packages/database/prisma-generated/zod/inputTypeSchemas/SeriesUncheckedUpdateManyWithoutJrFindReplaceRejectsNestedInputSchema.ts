...
export const SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => SeriesUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => SeriesUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => SeriesUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => SeriesUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SeriesUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => SeriesUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SeriesScalarWhereInputSchema),z.lazy(() => SeriesScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema;
