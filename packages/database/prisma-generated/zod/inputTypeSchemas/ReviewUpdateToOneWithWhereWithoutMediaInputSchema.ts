...
export const ReviewUpdateToOneWithWhereWithoutMediaInputSchema: z.ZodType<Prisma.ReviewUpdateToOneWithWhereWithoutMediaInput> = z.object({
  where: z.lazy(() => ReviewWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ReviewUpdateWithoutMediaInputSchema),z.lazy(() => ReviewUncheckedUpdateWithoutMediaInputSchema) ]),
}).strict();
