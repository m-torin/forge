...
export const MediaUpdateManyWithWhereWithoutTaxonomyInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutTaxonomyInput> = z.object({
  where: z.lazy(() => MediaScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateManyMutationInputSchema),z.lazy(() => MediaUncheckedUpdateManyWithoutTaxonomyInputSchema) ]),
}).strict();
