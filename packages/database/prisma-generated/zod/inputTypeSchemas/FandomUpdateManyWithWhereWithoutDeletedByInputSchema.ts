...
export const FandomUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.FandomUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => FandomScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => FandomUpdateManyMutationInputSchema),
        z.lazy(() => FandomUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
