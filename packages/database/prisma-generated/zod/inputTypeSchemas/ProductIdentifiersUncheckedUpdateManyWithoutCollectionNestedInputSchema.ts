...
export const ProductIdentifiersUncheckedUpdateManyWithoutCollectionNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutCollectionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutCollectionInputSchema),z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutCollectionInputSchema).array() ]).optional(),
...
export default ProductIdentifiersUncheckedUpdateManyWithoutCollectionNestedInputSchema;
