...
export const ProductIdentifiersUncheckedUpdateManyWithoutCollectionNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutCollectionNestedInput> =
  z
    .object({
      create: z
        .union([
