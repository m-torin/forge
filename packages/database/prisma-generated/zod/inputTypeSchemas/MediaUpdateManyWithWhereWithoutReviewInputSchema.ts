...
export const MediaUpdateManyWithWhereWithoutReviewInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutReviewInput> =
  z
    .object({
      where: z.lazy(() => MediaScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MediaUpdateManyMutationInputSchema),
        z.lazy(() => MediaUncheckedUpdateManyWithoutReviewInputSchema),
      ]),
    })
    .strict();
