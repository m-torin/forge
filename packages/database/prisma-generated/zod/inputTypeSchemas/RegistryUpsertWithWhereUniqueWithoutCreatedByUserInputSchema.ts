...
export const RegistryUpsertWithWhereUniqueWithoutCreatedByUserInputSchema: z.ZodType<Prisma.RegistryUpsertWithWhereUniqueWithoutCreatedByUserInput> = z.object({
  where: z.lazy(() => RegistryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RegistryUpdateWithoutCreatedByUserInputSchema),z.lazy(() => RegistryUncheckedUpdateWithoutCreatedByUserInputSchema) ]),
