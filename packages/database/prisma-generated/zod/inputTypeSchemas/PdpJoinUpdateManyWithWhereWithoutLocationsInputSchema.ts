...
export const PdpJoinUpdateManyWithWhereWithoutLocationsInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutLocationsInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => PdpJoinUpdateManyMutationInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateManyWithoutLocationsInputSchema),
      ]),
    })
    .strict();
