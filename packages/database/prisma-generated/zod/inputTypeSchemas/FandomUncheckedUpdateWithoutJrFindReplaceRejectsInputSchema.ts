...
export const FandomUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.FandomUncheckedUpdateWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      id: z
      ...
      locations: z
        .lazy(() => LocationUncheckedUpdateManyWithoutFandomsNestedInputSchema)
        .optional(),
    })
    .strict();

export default FandomUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema;
