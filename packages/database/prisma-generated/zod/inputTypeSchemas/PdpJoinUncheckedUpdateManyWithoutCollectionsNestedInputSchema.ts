...
export const PdpJoinUncheckedUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.PdpJoinUncheckedUpdateManyWithoutCollectionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutCollectionsInputSchema),
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutCollectionsInputSchema),
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutCollectionsInputSchema),
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default PdpJoinUncheckedUpdateManyWithoutCollectionsNestedInputSchema;
