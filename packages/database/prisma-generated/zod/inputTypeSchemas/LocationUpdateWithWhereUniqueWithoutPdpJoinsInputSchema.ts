...
export const LocationUpdateWithWhereUniqueWithoutPdpJoinsInputSchema: z.ZodType<Prisma.LocationUpdateWithWhereUniqueWithoutPdpJoinsInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateWithoutPdpJoinsInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutPdpJoinsInputSchema) ]),
}).strict();
