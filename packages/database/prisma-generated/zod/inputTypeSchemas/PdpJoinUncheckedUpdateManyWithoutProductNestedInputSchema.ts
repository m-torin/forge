...
export const PdpJoinUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.PdpJoinUncheckedUpdateManyWithoutProductNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutProductInputSchema),z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutProductInputSchema),z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PdpJoinUpdateManyWithWhereWithoutProductInputSchema),z.lazy(() => PdpJoinUpdateManyWithWhereWithoutProductInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PdpJoinScalarWhereInputSchema),z.lazy(() => PdpJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PdpJoinUncheckedUpdateManyWithoutProductNestedInputSchema;
