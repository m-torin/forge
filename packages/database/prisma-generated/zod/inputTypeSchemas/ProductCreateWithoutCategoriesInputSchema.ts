...
export const ProductCreateWithoutCategoriesInputSchema: z.ZodType<Prisma.ProductCreateWithoutCategoriesInput> =
  z
    .object({
...
export default ProductCreateWithoutCategoriesInputSchema;
