...
export const StoryUncheckedUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.StoryUncheckedUpdateManyWithoutProductsNestedInput> = z.object({
  create: z.union([ z.lazy(() => StoryCreateWithoutProductsInputSchema),z.lazy(() => StoryCreateWithoutProductsInputSchema).array(),z.lazy(() => StoryUncheckedCreateWithoutProductsInputSchema),z.lazy(() => StoryUncheckedCreateWithoutProductsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => StoryCreateOrConnectWithoutProductsInputSchema),z.lazy(() => StoryCreateOrConnectWithoutProductsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => StoryUpsertWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => StoryUpsertWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => StoryUpdateWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => StoryUpdateWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StoryUpdateManyWithWhereWithoutProductsInputSchema),z.lazy(() => StoryUpdateManyWithWhereWithoutProductsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StoryScalarWhereInputSchema),z.lazy(() => StoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default StoryUncheckedUpdateManyWithoutProductsNestedInputSchema;
