...
export const RegistryPurchaseJoinScalarWhereInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => RegistryPurchaseJoinScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
      ...
      status: z
        .union([z.lazy(() => EnumPurchaseStatusFilterSchema), z.lazy(() => PurchaseStatusSchema)])
        .optional(),
      transactionId: z
