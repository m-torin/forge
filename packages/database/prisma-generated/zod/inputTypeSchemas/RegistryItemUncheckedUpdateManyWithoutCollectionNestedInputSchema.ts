...
export const RegistryItemUncheckedUpdateManyWithoutCollectionNestedInputSchema: z.ZodType<Prisma.RegistryItemUncheckedUpdateManyWithoutCollectionNestedInput> =
  z
    .object({
      create: z
        .union([
