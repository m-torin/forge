...
export const CollectionUncheckedUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutProductsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutProductsInputSchema),
          z.lazy(() => CollectionUpdateManyWithWhereWithoutProductsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default CollectionUncheckedUpdateManyWithoutProductsNestedInputSchema;
