...
export const PdpJoinUncheckedUpdateManyWithoutBrandNestedInputSchema: z.ZodType<Prisma.PdpJoinUncheckedUpdateManyWithoutBrandNestedInput> = z.object({
  create: z.union([ z.lazy(() => PdpJoinCreateWithoutBrandInputSchema),z.lazy(() => PdpJoinCreateWithoutBrandInputSchema).array(),z.lazy(() => PdpJoinUncheckedCreateWithoutBrandInputSchema),z.lazy(() => PdpJoinUncheckedCreateWithoutBrandInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PdpJoinCreateOrConnectWithoutBrandInputSchema),z.lazy(() => PdpJoinCreateOrConnectWithoutBrandInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutBrandInputSchema),z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutBrandInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutBrandInputSchema),z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutBrandInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PdpJoinUpdateManyWithWhereWithoutBrandInputSchema),z.lazy(() => PdpJoinUpdateManyWithWhereWithoutBrandInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PdpJoinScalarWhereInputSchema),z.lazy(() => PdpJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PdpJoinUncheckedUpdateManyWithoutBrandNestedInputSchema;
