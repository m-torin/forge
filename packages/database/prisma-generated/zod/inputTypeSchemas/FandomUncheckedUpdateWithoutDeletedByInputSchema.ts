...
export const FandomUncheckedUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.FandomUncheckedUpdateWithoutDeletedByInput> = z.object({
  ...
  jrFindReplaceRejects: z.lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutFandomsNestedInputSchema).optional()
}).strict();

export default FandomUncheckedUpdateWithoutDeletedByInputSchema;
