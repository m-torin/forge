...
export const MediaUpdateManyWithWhereWithoutCollectionInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutCollectionInput> =
  z
    .object({
      where: z.lazy(() => MediaScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MediaUpdateManyMutationInputSchema),
        z.lazy(() => MediaUncheckedUpdateManyWithoutCollectionInputSchema),
      ]),
    })
    .strict();
