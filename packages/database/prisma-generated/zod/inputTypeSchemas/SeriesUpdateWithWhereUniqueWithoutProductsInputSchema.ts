...
export const SeriesUpdateWithWhereUniqueWithoutProductsInputSchema: z.ZodType<Prisma.SeriesUpdateWithWhereUniqueWithoutProductsInput> = z.object({
  where: z.lazy(() => SeriesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SeriesUpdateWithoutProductsInputSchema),z.lazy(() => SeriesUncheckedUpdateWithoutProductsInputSchema) ]),
}).strict();
