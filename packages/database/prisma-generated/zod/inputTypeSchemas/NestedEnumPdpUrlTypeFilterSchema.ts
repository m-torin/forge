...
export const NestedEnumPdpUrlTypeFilterSchema: z.ZodType<Prisma.NestedEnumPdpUrlTypeFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => PdpUrlTypeSchema),z.lazy(() => NestedEnumPdpUrlTypeFilterSchema) ]).optional(),
}).strict();
