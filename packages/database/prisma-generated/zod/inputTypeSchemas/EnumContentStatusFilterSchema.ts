...
export const EnumContentStatusFilterSchema: z.ZodType<Prisma.EnumContentStatusFilter> = z
  .object({
    ...
    notIn: z
      ...
      .optional(),
    not: z
      .union([z.lazy(() => ContentStatusSchema), z.lazy(() => NestedEnumContentStatusFilterSchema)])
      .optional(),
  })
  .strict();
