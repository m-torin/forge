...
export const StoryUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.StoryUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => StoryScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => StoryUpdateManyMutationInputSchema),
        z.lazy(() => StoryUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
