...
export const LocationUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.LocationUpdateManyWithoutJrFindReplaceRejectsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LocationUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => LocationUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LocationUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => LocationUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LocationUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => LocationUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LocationScalarWhereInputSchema),z.lazy(() => LocationScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LocationUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema;
