...
export const ProductUpdateOneWithoutCartItemVariantsNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutCartItemVariantsNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => ProductCreateOrConnectWithoutCartItemVariantsInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateToOneWithWhereWithoutCartItemVariantsInputSchema),
