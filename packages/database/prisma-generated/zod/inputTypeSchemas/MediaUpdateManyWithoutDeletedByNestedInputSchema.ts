...
export const MediaUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.MediaUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutDeletedByInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUpdateManyWithoutDeletedByNestedInputSchema;
