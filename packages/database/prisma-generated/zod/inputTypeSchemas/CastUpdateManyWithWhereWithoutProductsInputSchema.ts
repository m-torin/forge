...
export const CastUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.CastUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => CastScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CastUpdateManyMutationInputSchema),
        z.lazy(() => CastUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
