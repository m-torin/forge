...
export const JrExtractionRuleCreateWithoutJollyRogerInputSchema: z.ZodType<Prisma.JrExtractionRuleCreateWithoutJollyRogerInput> =
  z
    .object({
      ...
      findReplaceRules: z
        .lazy(() => JrFindReplaceRejectCreateNestedManyWithoutExtractionRulesInputSchema)
        .optional(),
    })
    .strict();
