...
export const PdpUrlScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PdpUrlScalarWhereWithAggregatesInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(() => PdpUrlScalarWhereWithAggregatesInputSchema),
          z.lazy(() => PdpUrlScalarWhereWithAggregatesInputSchema).array(),
        ])
        .optional(),
      OR: z
        .lazy(() => PdpUrlScalarWhereWithAggregatesInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
      ...
      urlType: z
        .union([
          z.lazy(() => EnumPdpUrlTypeWithAggregatesFilterSchema),
