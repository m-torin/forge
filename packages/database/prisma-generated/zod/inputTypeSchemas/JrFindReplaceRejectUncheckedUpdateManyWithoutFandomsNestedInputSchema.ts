...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutFandomsNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutFandomsNestedInput> =
  z
    .object({
      create: z
        .union([
