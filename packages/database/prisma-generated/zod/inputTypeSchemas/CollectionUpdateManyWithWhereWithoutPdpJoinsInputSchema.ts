...
export const CollectionUpdateManyWithWhereWithoutPdpJoinsInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutPdpJoinsInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutPdpJoinsInputSchema),
      ]),
    })
    .strict();
