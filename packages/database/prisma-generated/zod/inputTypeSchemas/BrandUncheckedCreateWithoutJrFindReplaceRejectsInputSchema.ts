...
export const BrandUncheckedCreateWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.BrandUncheckedCreateWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      ...
      manufacturedProducts: z
        .lazy(() => PdpJoinUncheckedCreateNestedManyWithoutManufacturerBrandsInputSchema)
        .optional(),
    })
    .strict();

export default BrandUncheckedCreateWithoutJrFindReplaceRejectsInputSchema;
