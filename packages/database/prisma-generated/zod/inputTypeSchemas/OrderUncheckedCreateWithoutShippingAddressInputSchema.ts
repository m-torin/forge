...
export const OrderUncheckedCreateWithoutShippingAddressInputSchema: z.ZodType<Prisma.OrderUncheckedCreateWithoutShippingAddressInput> =
  z
    .object({
      ...
      transactions: z
        .lazy(() => TransactionUncheckedCreateNestedManyWithoutOrderInputSchema)
        .optional(),
    })
    .strict();

export default OrderUncheckedCreateWithoutShippingAddressInputSchema;
