...
export const UserUpdateOneRequiredWithoutTwoFactorNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutTwoFactorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutTwoFactorInputSchema),
          z.lazy(() => UserUpdateWithoutTwoFactorInputSchema),
          z.lazy(() => UserUncheckedUpdateWithoutTwoFactorInputSchema),
        ])
        .optional(),
    })
    .strict();
