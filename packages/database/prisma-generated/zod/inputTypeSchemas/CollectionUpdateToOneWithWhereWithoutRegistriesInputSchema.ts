...
export const CollectionUpdateToOneWithWhereWithoutRegistriesInputSchema: z.ZodType<Prisma.CollectionUpdateToOneWithWhereWithoutRegistriesInput> = z.object({
  where: z.lazy(() => CollectionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => CollectionUpdateWithoutRegistriesInputSchema),z.lazy(() => CollectionUncheckedUpdateWithoutRegistriesInputSchema) ]),
}).strict();
