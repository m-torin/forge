...
export const TaxonomyUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => TaxonomyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => TaxonomyUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
