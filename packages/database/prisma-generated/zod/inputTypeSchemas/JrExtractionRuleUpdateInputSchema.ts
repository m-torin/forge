...
import { JollyRogerUpdateOneRequiredWithoutExtractionRulesNestedInputSchema } from './JollyRogerUpdateOneRequiredWithoutExtractionRulesNestedInputSchema';
import { JrFindReplaceRejectUpdateManyWithoutExtractionRulesNestedInputSchema } from './JrFindReplaceRejectUpdateManyWithoutExtractionRulesNestedInputSchema';

export const JrExtractionRuleUpdateInputSchema: z.ZodType<Prisma.JrExtractionRuleUpdateInput> = z.object({
  ...
  jollyRoger: z.lazy(() => JollyRogerUpdateOneRequiredWithoutExtractionRulesNestedInputSchema).optional(),
  findReplaceRules: z.lazy(() => JrFindReplaceRejectUpdateManyWithoutExtractionRulesNestedInputSchema).optional()
}).strict();

export default JrExtractionRuleUpdateInputSchema;
