...
export const BrandUpdateToOneWithWhereWithoutIdentifiersInputSchema: z.ZodType<Prisma.BrandUpdateToOneWithWhereWithoutIdentifiersInput> = z.object({
  where: z.lazy(() => BrandWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BrandUpdateWithoutIdentifiersInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutIdentifiersInputSchema) ]),
}).strict();
