...
export const JrFindReplaceRejectUncheckedCreateNestedManyWithoutExtractionRulesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedCreateNestedManyWithoutExtractionRulesInput> =
  z
    .object({
      create: z
        .union([
