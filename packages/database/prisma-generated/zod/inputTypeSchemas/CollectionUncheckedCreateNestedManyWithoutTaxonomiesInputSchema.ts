...
export const CollectionUncheckedCreateNestedManyWithoutTaxonomiesInputSchema: z.ZodType<Prisma.CollectionUncheckedCreateNestedManyWithoutTaxonomiesInput> =
  z
    .object({
      create: z
        .union([
