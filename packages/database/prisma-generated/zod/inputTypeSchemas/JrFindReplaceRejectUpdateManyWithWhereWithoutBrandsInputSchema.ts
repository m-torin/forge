...
export const JrFindReplaceRejectUpdateManyWithWhereWithoutBrandsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithWhereWithoutBrandsInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateManyMutationInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutBrandsInputSchema),
      ]),
    })
    .strict();
