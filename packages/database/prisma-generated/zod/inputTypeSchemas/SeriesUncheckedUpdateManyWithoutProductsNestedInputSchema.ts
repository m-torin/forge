...
export const SeriesUncheckedUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.SeriesUncheckedUpdateManyWithoutProductsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => SeriesUpsertWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => SeriesUpsertWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => SeriesUpdateWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => SeriesUpdateWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => SeriesUpdateManyWithWhereWithoutProductsInputSchema),
          z.lazy(() => SeriesUpdateManyWithWhereWithoutProductsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default SeriesUncheckedUpdateManyWithoutProductsNestedInputSchema;
