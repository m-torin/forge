    ...
    .object({
      ...
      upsert: z
        .union([
          ...
          z.lazy(() => ReviewUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          ...
          z.lazy(() => ReviewUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
...
export default ReviewUpdateManyWithoutUserNestedInputSchema;
