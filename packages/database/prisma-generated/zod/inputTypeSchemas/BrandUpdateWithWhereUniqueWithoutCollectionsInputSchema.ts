...
export const BrandUpdateWithWhereUniqueWithoutCollectionsInputSchema: z.ZodType<Prisma.BrandUpdateWithWhereUniqueWithoutCollectionsInput> = z.object({
  where: z.lazy(() => BrandWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BrandUpdateWithoutCollectionsInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutCollectionsInputSchema) ]),
}).strict();
