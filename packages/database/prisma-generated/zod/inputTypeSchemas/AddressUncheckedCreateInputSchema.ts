...
export const AddressUncheckedCreateInputSchema: z.ZodType<Prisma.AddressUncheckedCreateInput> = z
  .object({
    ...
    orderShippingAddresses: z
      .lazy(() => OrderUncheckedCreateNestedManyWithoutShippingAddressInputSchema)
      .optional(),
