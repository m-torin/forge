...
export const ProductCategoryUpdateOneWithoutChildrenNestedInputSchema: z.ZodType<Prisma.ProductCategoryUpdateOneWithoutChildrenNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductCategoryUpdateToOneWithWhereWithoutChildrenInputSchema),
