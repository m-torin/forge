...
export const RegistryUserJoinUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.RegistryUserJoinUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => RegistryUserJoinUpsertWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => RegistryUserJoinUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => RegistryUserJoinUpdateWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => RegistryUserJoinUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => RegistryUserJoinUpdateManyWithWhereWithoutUserInputSchema),
          z.lazy(() => RegistryUserJoinUpdateManyWithWhereWithoutUserInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default RegistryUserJoinUncheckedUpdateManyWithoutUserNestedInputSchema;
