...
export const CollectionUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
