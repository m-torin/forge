...
export const UserCreateWithoutTwoFactorInputSchema: z.ZodType<Prisma.UserCreateWithoutTwoFactorInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutTwoFactorInputSchema;
