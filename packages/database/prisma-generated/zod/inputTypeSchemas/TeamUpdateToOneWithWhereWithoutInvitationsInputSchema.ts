...
export const TeamUpdateToOneWithWhereWithoutInvitationsInputSchema: z.ZodType<Prisma.TeamUpdateToOneWithWhereWithoutInvitationsInput> = z.object({
  where: z.lazy(() => TeamWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TeamUpdateWithoutInvitationsInputSchema),z.lazy(() => TeamUncheckedUpdateWithoutInvitationsInputSchema) ]),
}).strict();
