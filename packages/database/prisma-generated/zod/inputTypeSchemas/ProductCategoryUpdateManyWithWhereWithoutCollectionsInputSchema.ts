...
export const ProductCategoryUpdateManyWithWhereWithoutCollectionsInputSchema: z.ZodType<Prisma.ProductCategoryUpdateManyWithWhereWithoutCollectionsInput> = z.object({
  where: z.lazy(() => ProductCategoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProductCategoryUpdateManyMutationInputSchema),z.lazy(() => ProductCategoryUncheckedUpdateManyWithoutCollectionsInputSchema) ]),
}).strict();
