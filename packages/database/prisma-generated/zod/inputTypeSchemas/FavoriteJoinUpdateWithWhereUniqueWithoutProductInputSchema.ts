...
export const FavoriteJoinUpdateWithWhereUniqueWithoutProductInputSchema: z.ZodType<Prisma.FavoriteJoinUpdateWithWhereUniqueWithoutProductInput> = z.object({
  where: z.lazy(() => FavoriteJoinWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => FavoriteJoinUpdateWithoutProductInputSchema),z.lazy(() => FavoriteJoinUncheckedUpdateWithoutProductInputSchema) ]),
}).strict();
