...
export const ProductCategoryUncheckedUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedUpdateManyWithoutCollectionsNestedInput> =
  z
    .object({
      create: z
        .union([
