...
export const ProductCategoryUncheckedUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedUpdateManyWithoutCollectionsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutCollectionsInputSchema),z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutCollectionsInputSchema).array() ]).optional(),
...
export default ProductCategoryUncheckedUpdateManyWithoutCollectionsNestedInputSchema;
