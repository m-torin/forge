...
export const TaxonomyUpdateManyWithWhereWithoutCollectionsInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithWhereWithoutCollectionsInput> = z.object({
  where: z.lazy(() => TaxonomyScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateManyMutationInputSchema),z.lazy(() => TaxonomyUncheckedUpdateManyWithoutCollectionsInputSchema) ]),
}).strict();
