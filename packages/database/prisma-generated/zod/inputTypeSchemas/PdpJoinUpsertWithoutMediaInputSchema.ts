...
export const PdpJoinUpsertWithoutMediaInputSchema: z.ZodType<Prisma.PdpJoinUpsertWithoutMediaInput> = z.object({
  update: z.union([ z.lazy(() => PdpJoinUpdateWithoutMediaInputSchema),z.lazy(() => PdpJoinUncheckedUpdateWithoutMediaInputSchema) ]),
  create: z.union([ z.lazy(() => PdpJoinCreateWithoutMediaInputSchema),z.lazy(() => PdpJoinUncheckedCreateWithoutMediaInputSchema) ]),
