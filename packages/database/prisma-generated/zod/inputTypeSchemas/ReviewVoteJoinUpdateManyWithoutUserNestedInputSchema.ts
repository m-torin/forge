...
export const ReviewVoteJoinUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ReviewVoteJoinUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReviewVoteJoinUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReviewVoteJoinUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ReviewVoteJoinUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReviewVoteJoinUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReviewVoteJoinUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => ReviewVoteJoinUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
...
export default ReviewVoteJoinUpdateManyWithoutUserNestedInputSchema;
