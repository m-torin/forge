...
export const OrderUpdateManyWithoutShippingAddressNestedInputSchema: z.ZodType<Prisma.OrderUpdateManyWithoutShippingAddressNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default OrderUpdateManyWithoutShippingAddressNestedInputSchema;
