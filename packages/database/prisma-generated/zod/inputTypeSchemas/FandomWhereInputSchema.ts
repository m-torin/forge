...
export const FandomWhereInputSchema: z.ZodType<Prisma.FandomWhereInput> = z
  .object({
    AND: z
      .union([z.lazy(() => FandomWhereInputSchema), z.lazy(() => FandomWhereInputSchema).array()])
      .optional(),
    OR: z
      .lazy(() => FandomWhereInputSchema)
      .array()
      .optional(),
    NOT: z
      .union([z.lazy(() => FandomWhereInputSchema), z.lazy(() => FandomWhereInputSchema).array()])
...
export default FandomWhereInputSchema;
