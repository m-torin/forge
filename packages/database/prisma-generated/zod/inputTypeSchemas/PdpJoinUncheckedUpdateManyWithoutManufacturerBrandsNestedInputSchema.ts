...
export const PdpJoinUncheckedUpdateManyWithoutManufacturerBrandsNestedInputSchema: z.ZodType<Prisma.PdpJoinUncheckedUpdateManyWithoutManufacturerBrandsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutManufacturerBrandsInputSchema),
          z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutManufacturerBrandsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutManufacturerBrandsInputSchema),
          z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutManufacturerBrandsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutManufacturerBrandsInputSchema),
          z.lazy(() => PdpJoinUpdateManyWithWhereWithoutManufacturerBrandsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default PdpJoinUncheckedUpdateManyWithoutManufacturerBrandsNestedInputSchema;
