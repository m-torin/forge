...
export const PdpJoinUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => PdpJoinScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PdpJoinUpdateManyMutationInputSchema),z.lazy(() => PdpJoinUncheckedUpdateManyWithoutProductInputSchema) ]),
}).strict();
