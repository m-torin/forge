...
export const JrFindReplaceRejectUpdateWithWhereUniqueWithoutCastsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateWithWhereUniqueWithoutCastsInput> = z.object({
  where: z.lazy(() => JrFindReplaceRejectWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => JrFindReplaceRejectUpdateWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedUpdateWithoutCastsInputSchema) ]),
}).strict();
