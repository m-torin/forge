...
export const CollectionUncheckedUpdateManyWithoutPdpJoinsNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutPdpJoinsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CollectionUpsertWithWhereUniqueWithoutPdpJoinsInputSchema),z.lazy(() => CollectionUpsertWithWhereUniqueWithoutPdpJoinsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CollectionUpdateWithWhereUniqueWithoutPdpJoinsInputSchema),z.lazy(() => CollectionUpdateWithWhereUniqueWithoutPdpJoinsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CollectionUpdateManyWithWhereWithoutPdpJoinsInputSchema),z.lazy(() => CollectionUpdateManyWithWhereWithoutPdpJoinsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CollectionScalarWhereInputSchema),z.lazy(() => CollectionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CollectionUncheckedUpdateManyWithoutPdpJoinsNestedInputSchema;
