...
export const JrFindReplaceRejectUncheckedCreateNestedManyWithoutStoriesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedCreateNestedManyWithoutStoriesInput> =
  z
    .object({
      create: z
        .union([
