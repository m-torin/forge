...
import { ArticleUpdateManyWithoutDeletedByNestedInputSchema } from './ArticleUpdateManyWithoutDeletedByNestedInputSchema';
...
export const UserUpdateWithoutTeamMembershipsInputSchema: z.ZodType<Prisma.UserUpdateWithoutTeamMembershipsInput> =
  z
    .object({
      ...
      createdRegistries: z
        .lazy(() => RegistryUpdateManyWithoutCreatedByUserNestedInputSchema)
        .optional(),
      registries: z.lazy(() => RegistryUserJoinUpdateManyWithoutUserNestedInputSchema).optional(),
      purchases: z
        .lazy(() => RegistryPurchaseJoinUpdateManyWithoutPurchaserNestedInputSchema)
        .optional(),
      ...
      invitationsSent: z
        .lazy(() => InvitationUpdateManyWithoutInvitedByNestedInputSchema)
        .optional(),
      deletedArticles: z.lazy(() => ArticleUpdateManyWithoutDeletedByNestedInputSchema).optional(),
      deletedBrands: z.lazy(() => BrandUpdateManyWithoutDeletedByNestedInputSchema).optional(),
      deletedCollections: z
        .lazy(() => CollectionUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedProducts: z.lazy(() => ProductUpdateManyWithoutDeletedByNestedInputSchema).optional(),
      deletedTaxonomies: z
        .lazy(() => TaxonomyUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedReviews: z.lazy(() => ReviewUpdateManyWithoutDeletedByNestedInputSchema).optional(),
      deletedRegistries: z
        .lazy(() => RegistryUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedRegistryItems: z
        .lazy(() => RegistryItemUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedMedia: z.lazy(() => MediaUpdateManyWithoutDeletedByNestedInputSchema).optional(),
      deletedProductCategories: z
        .lazy(() => ProductCategoryUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedLocations: z
        .lazy(() => LocationUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
...
export default UserUpdateWithoutTeamMembershipsInputSchema;
