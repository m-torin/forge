...
export const TransactionUpdateWithoutRefundsInputSchema: z.ZodType<Prisma.TransactionUpdateWithoutRefundsInput> =
  z
    .object({
      id: z
      ...
      parentTransaction: z
        .lazy(() => TransactionUpdateOneWithoutRefundsNestedInputSchema)
        .optional(),
    })
    .strict();
