...
import { RegistryCreateNestedManyWithoutCreatedByUserInputSchema } from './RegistryCreateNestedManyWithoutCreatedByUserInputSchema';
...
export const UserCreateWithoutDeletedProductsInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedProductsInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
      ...
      createdRegistries: z
        .lazy(() => RegistryCreateNestedManyWithoutCreatedByUserInputSchema)
        .optional(),
      registries: z.lazy(() => RegistryUserJoinCreateNestedManyWithoutUserInputSchema).optional(),
      purchases: z
        .lazy(() => RegistryPurchaseJoinCreateNestedManyWithoutPurchaserInputSchema)
        .optional(),
      ...
      invitationsSent: z
        .lazy(() => InvitationCreateNestedManyWithoutInvitedByInputSchema)
        .optional(),
      ...
      deletedCollections: z
        .lazy(() => CollectionCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
      deletedTaxonomies: z
        .lazy(() => TaxonomyCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
      deletedReviews: z.lazy(() => ReviewCreateNestedManyWithoutDeletedByInputSchema).optional(),
      deletedRegistries: z
        .lazy(() => RegistryCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
      deletedRegistryItems: z
        .lazy(() => RegistryItemCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
      deletedMedia: z.lazy(() => MediaCreateNestedManyWithoutDeletedByInputSchema).optional(),
      deletedProductCategories: z
        .lazy(() => ProductCategoryCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
      deletedLocations: z
        .lazy(() => LocationCreateNestedManyWithoutDeletedByInputSchema)
        .optional(),
...
export default UserCreateWithoutDeletedProductsInputSchema;
