...
export const CastUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.CastUncheckedCreateNestedManyWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      create: z
        .union([
