...
export const RegistryItemUpsertWithWhereUniqueWithoutProductInputSchema: z.ZodType<Prisma.RegistryItemUpsertWithWhereUniqueWithoutProductInput> = z.object({
  where: z.lazy(() => RegistryItemWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RegistryItemUpdateWithoutProductInputSchema),z.lazy(() => RegistryItemUncheckedUpdateWithoutProductInputSchema) ]),
