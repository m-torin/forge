...
export const SeriesUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.SeriesUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => SeriesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SeriesUpdateWithoutDeletedByInputSchema),z.lazy(() => SeriesUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
