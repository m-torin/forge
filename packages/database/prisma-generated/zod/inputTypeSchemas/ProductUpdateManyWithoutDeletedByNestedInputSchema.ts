...
export const ProductUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.ProductUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => ProductCreateWithoutDeletedByInputSchema),
          z.lazy(() => ProductCreateWithoutDeletedByInputSchema).array(),
          z.lazy(() => ProductUncheckedCreateWithoutDeletedByInputSchema),
          z.lazy(() => ProductUncheckedCreateWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => ProductCreateOrConnectWithoutDeletedByInputSchema),
          z.lazy(() => ProductCreateOrConnectWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => ProductUpsertWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => ProductUpdateWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ProductUpdateManyWithWhereWithoutDeletedByInputSchema),
          z.lazy(() => ProductUpdateManyWithWhereWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default ProductUpdateManyWithoutDeletedByNestedInputSchema;
