...
export const BrandUpdateManyWithWhereWithoutManufacturedProductsInputSchema: z.ZodType<Prisma.BrandUpdateManyWithWhereWithoutManufacturedProductsInput> =
  z
    .object({
      where: z.lazy(() => BrandScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => BrandUpdateManyMutationInputSchema),
        z.lazy(() => BrandUncheckedUpdateManyWithoutManufacturedProductsInputSchema),
      ]),
    })
    .strict();
