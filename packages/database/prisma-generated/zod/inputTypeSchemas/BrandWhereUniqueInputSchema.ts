...
export const BrandWhereUniqueInputSchema: z.ZodType<Prisma.BrandWhereUniqueInput> = z
  .union([
    z.object({
      id: z.string().cuid(),
      slug: z.string(),
  ...
  .and(
    z
      .object({
        ...
        AND: z
          .union([z.lazy(() => BrandWhereInputSchema), z.lazy(() => BrandWhereInputSchema).array()])
          .optional(),
        OR: z
          .lazy(() => BrandWhereInputSchema)
          .array()
          .optional(),
        NOT: z
          .union([z.lazy(() => BrandWhereInputSchema), z.lazy(() => BrandWhereInputSchema).array()])
        ...
        jollyRoger: z
          .union([
            z.lazy(() => JollyRogerNullableScalarRelationFilterSchema),
