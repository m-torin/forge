...
export const CollectionUncheckedUpdateManyWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutCategoriesNestedInput> =
  z
    .object({
      create: z
        .union([
