...
export const CollectionUncheckedUpdateManyWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutCategoriesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CollectionUpsertWithWhereUniqueWithoutCategoriesInputSchema),z.lazy(() => CollectionUpsertWithWhereUniqueWithoutCategoriesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CollectionUpdateWithWhereUniqueWithoutCategoriesInputSchema),z.lazy(() => CollectionUpdateWithWhereUniqueWithoutCategoriesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CollectionUpdateManyWithWhereWithoutCategoriesInputSchema),z.lazy(() => CollectionUpdateManyWithWhereWithoutCategoriesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CollectionScalarWhereInputSchema),z.lazy(() => CollectionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CollectionUncheckedUpdateManyWithoutCategoriesNestedInputSchema;
