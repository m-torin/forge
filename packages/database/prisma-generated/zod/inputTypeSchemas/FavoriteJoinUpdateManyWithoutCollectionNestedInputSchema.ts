...
export const FavoriteJoinUpdateManyWithoutCollectionNestedInputSchema: z.ZodType<Prisma.FavoriteJoinUpdateManyWithoutCollectionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => FavoriteJoinUpsertWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => FavoriteJoinUpsertWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => FavoriteJoinUpdateWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => FavoriteJoinUpdateWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => FavoriteJoinUpdateManyWithWhereWithoutCollectionInputSchema),z.lazy(() => FavoriteJoinUpdateManyWithWhereWithoutCollectionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => FavoriteJoinScalarWhereInputSchema),z.lazy(() => FavoriteJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default FavoriteJoinUpdateManyWithoutCollectionNestedInputSchema;
