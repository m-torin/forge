...
export const ProductCategoryUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductCategoryUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => ProductCategoryScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductCategoryUpdateManyMutationInputSchema),
        z.lazy(() => ProductCategoryUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
