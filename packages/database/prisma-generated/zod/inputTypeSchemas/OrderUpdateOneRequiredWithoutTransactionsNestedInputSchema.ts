...
export const OrderUpdateOneRequiredWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.OrderUpdateOneRequiredWithoutTransactionsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => OrderUpdateToOneWithWhereWithoutTransactionsInputSchema),z.lazy(() => OrderUpdateWithoutTransactionsInputSchema),z.lazy(() => OrderUncheckedUpdateWithoutTransactionsInputSchema) ]).optional(),
}).strict();
