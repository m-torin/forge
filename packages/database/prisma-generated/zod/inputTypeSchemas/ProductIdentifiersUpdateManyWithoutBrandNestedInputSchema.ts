...
export const ProductIdentifiersUpdateManyWithoutBrandNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUpdateManyWithoutBrandNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutBrandInputSchema),
          z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutBrandInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutBrandInputSchema),
          z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutBrandInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutBrandInputSchema),
          z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutBrandInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default ProductIdentifiersUpdateManyWithoutBrandNestedInputSchema;
