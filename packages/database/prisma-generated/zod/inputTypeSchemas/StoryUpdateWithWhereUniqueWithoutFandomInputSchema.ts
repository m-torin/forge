...
export const StoryUpdateWithWhereUniqueWithoutFandomInputSchema: z.ZodType<Prisma.StoryUpdateWithWhereUniqueWithoutFandomInput> = z.object({
  where: z.lazy(() => StoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => StoryUpdateWithoutFandomInputSchema),z.lazy(() => StoryUncheckedUpdateWithoutFandomInputSchema) ]),
}).strict();
