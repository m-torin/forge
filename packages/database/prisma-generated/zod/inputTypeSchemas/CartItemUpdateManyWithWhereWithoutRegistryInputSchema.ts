...
export const CartItemUpdateManyWithWhereWithoutRegistryInputSchema: z.ZodType<Prisma.CartItemUpdateManyWithWhereWithoutRegistryInput> =
  z
    .object({
      where: z.lazy(() => CartItemScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CartItemUpdateManyMutationInputSchema),
        z.lazy(() => CartItemUncheckedUpdateManyWithoutRegistryInputSchema),
      ]),
    })
    .strict();
