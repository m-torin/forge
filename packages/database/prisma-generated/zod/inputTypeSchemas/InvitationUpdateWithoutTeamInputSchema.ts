...
export const InvitationUpdateWithoutTeamInputSchema: z.ZodType<Prisma.InvitationUpdateWithoutTeamInput> = z.object({
  ...
  invitedBy: z.lazy(() => UserUpdateOneRequiredWithoutInvitationsSentNestedInputSchema).optional()
}).strict();
