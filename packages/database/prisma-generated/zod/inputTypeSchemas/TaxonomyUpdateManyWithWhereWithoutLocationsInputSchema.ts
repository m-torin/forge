...
export const TaxonomyUpdateManyWithWhereWithoutLocationsInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithWhereWithoutLocationsInput> =
  z
    .object({
      where: z.lazy(() => TaxonomyScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => TaxonomyUpdateManyMutationInputSchema),
        z.lazy(() => TaxonomyUncheckedUpdateManyWithoutLocationsInputSchema),
      ]),
    })
    .strict();
