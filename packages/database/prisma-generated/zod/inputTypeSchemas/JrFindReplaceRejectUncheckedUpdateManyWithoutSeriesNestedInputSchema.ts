...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutSeriesNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutSeriesNestedInput> = z.object({
  create: z.union([ z.lazy(() => JrFindReplaceRejectCreateWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectCreateWithoutSeriesInputSchema).array(),z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutSeriesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutSeriesInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutSeriesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutSeriesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutSeriesInputSchema),z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutSeriesInputSchema).array() ]).optional(),
...
export default JrFindReplaceRejectUncheckedUpdateManyWithoutSeriesNestedInputSchema;
