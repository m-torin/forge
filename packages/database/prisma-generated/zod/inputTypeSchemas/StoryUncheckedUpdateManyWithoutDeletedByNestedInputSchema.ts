...
export const StoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.StoryUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => StoryUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => StoryUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => StoryUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => StoryUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StoryUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => StoryUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StoryScalarWhereInputSchema),z.lazy(() => StoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default StoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
