...
export const BrandUpdateWithWhereUniqueWithoutParentInputSchema: z.ZodType<Prisma.BrandUpdateWithWhereUniqueWithoutParentInput> = z.object({
  where: z.lazy(() => BrandWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BrandUpdateWithoutParentInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutParentInputSchema) ]),
}).strict();
