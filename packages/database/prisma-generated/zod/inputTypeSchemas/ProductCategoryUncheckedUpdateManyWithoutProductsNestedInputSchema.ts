...
export const ProductCategoryUncheckedUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedUpdateManyWithoutProductsNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => ProductCategoryCreateWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryCreateWithoutProductsInputSchema).array(),
          z.lazy(() => ProductCategoryUncheckedCreateWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryUncheckedCreateWithoutProductsInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => ProductCategoryCreateOrConnectWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryCreateOrConnectWithoutProductsInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutProductsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutProductsInputSchema),
          z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutProductsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default ProductCategoryUncheckedUpdateManyWithoutProductsNestedInputSchema;
