...
export const RegistryUpsertWithoutItemsInputSchema: z.ZodType<Prisma.RegistryUpsertWithoutItemsInput> = z.object({
  update: z.union([ z.lazy(() => RegistryUpdateWithoutItemsInputSchema),z.lazy(() => RegistryUncheckedUpdateWithoutItemsInputSchema) ]),
