...
export const StoryUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.StoryUpdateManyWithWhereWithoutDeletedByInput> = z.object({
  where: z.lazy(() => StoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => StoryUpdateManyMutationInputSchema),z.lazy(() => StoryUncheckedUpdateManyWithoutDeletedByInputSchema) ]),
}).strict();
