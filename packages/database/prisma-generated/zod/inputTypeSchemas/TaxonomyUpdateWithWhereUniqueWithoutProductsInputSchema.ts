...
export const TaxonomyUpdateWithWhereUniqueWithoutProductsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithWhereUniqueWithoutProductsInput> = z.object({
  where: z.lazy(() => TaxonomyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateWithoutProductsInputSchema),z.lazy(() => TaxonomyUncheckedUpdateWithoutProductsInputSchema) ]),
}).strict();
