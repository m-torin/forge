...
import { NestedEnumJrChartRuleForWithAggregatesFilterSchema } from './NestedEnumJrChartRuleForWithAggregatesFilterSchema';
import { NestedIntFilterSchema } from './NestedIntFilterSchema';
import { NestedEnumJrChartRuleForFilterSchema } from './NestedEnumJrChartRuleForFilterSchema';

export const EnumJrChartRuleForWithAggregatesFilterSchema: z.ZodType<Prisma.EnumJrChartRuleForWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          ...
          z.lazy(() => NestedEnumJrChartRuleForWithAggregatesFilterSchema),
        ])
        .optional(),
...
export default EnumJrChartRuleForWithAggregatesFilterSchema;
