...
export const MediaUncheckedUpdateManyWithoutCollectionNestedInputSchema: z.ZodType<Prisma.MediaUncheckedUpdateManyWithoutCollectionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => MediaUpsertWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => MediaUpsertWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => MediaUpdateWithWhereUniqueWithoutCollectionInputSchema),z.lazy(() => MediaUpdateWithWhereUniqueWithoutCollectionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => MediaUpdateManyWithWhereWithoutCollectionInputSchema),z.lazy(() => MediaUpdateManyWithWhereWithoutCollectionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => MediaScalarWhereInputSchema),z.lazy(() => MediaScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default MediaUncheckedUpdateManyWithoutCollectionNestedInputSchema;
