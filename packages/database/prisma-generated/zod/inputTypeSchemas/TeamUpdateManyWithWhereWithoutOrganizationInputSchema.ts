...
export const TeamUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.TeamUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      where: z.lazy(() => TeamScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => TeamUpdateManyMutationInputSchema),
        z.lazy(() => TeamUncheckedUpdateManyWithoutOrganizationInputSchema),
      ]),
    })
    .strict();
