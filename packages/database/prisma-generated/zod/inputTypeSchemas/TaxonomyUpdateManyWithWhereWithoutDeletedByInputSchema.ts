...
export const TaxonomyUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => TaxonomyScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => TaxonomyUpdateManyMutationInputSchema),
        z.lazy(() => TaxonomyUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
