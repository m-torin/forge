...
export const CastUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.CastUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => CastWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CastUpdateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => CastUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema) ]),
  create: z.union([ z.lazy(() => CastCreateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => CastUncheckedCreateWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
