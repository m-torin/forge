...
export const PdpJoinUncheckedCreateNestedManyWithoutManufacturerBrandsInputSchema: z.ZodType<Prisma.PdpJoinUncheckedCreateNestedManyWithoutManufacturerBrandsInput> =
  z
    .object({
      create: z
        .union([
