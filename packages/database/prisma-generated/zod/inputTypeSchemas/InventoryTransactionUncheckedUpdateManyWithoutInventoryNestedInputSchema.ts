...
export const InventoryTransactionUncheckedUpdateManyWithoutInventoryNestedInputSchema: z.ZodType<Prisma.InventoryTransactionUncheckedUpdateManyWithoutInventoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => InventoryTransactionUpsertWithWhereUniqueWithoutInventoryInputSchema),
          z
            .lazy(() => InventoryTransactionUpsertWithWhereUniqueWithoutInventoryInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => InventoryTransactionUpdateWithWhereUniqueWithoutInventoryInputSchema),
          z
            .lazy(() => InventoryTransactionUpdateWithWhereUniqueWithoutInventoryInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => InventoryTransactionUpdateManyWithWhereWithoutInventoryInputSchema),
          z.lazy(() => InventoryTransactionUpdateManyWithWhereWithoutInventoryInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default InventoryTransactionUncheckedUpdateManyWithoutInventoryNestedInputSchema;
