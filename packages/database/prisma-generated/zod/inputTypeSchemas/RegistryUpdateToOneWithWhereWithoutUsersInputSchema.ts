...
export const RegistryUpdateToOneWithWhereWithoutUsersInputSchema: z.ZodType<Prisma.RegistryUpdateToOneWithWhereWithoutUsersInput> = z.object({
  where: z.lazy(() => RegistryWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => RegistryUpdateWithoutUsersInputSchema),z.lazy(() => RegistryUncheckedUpdateWithoutUsersInputSchema) ]),
}).strict();
