...
export const BackupCodeUncheckedUpdateManyWithoutTwoFactorNestedInputSchema: z.ZodType<Prisma.BackupCodeUncheckedUpdateManyWithoutTwoFactorNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => BackupCodeUpsertWithWhereUniqueWithoutTwoFactorInputSchema),z.lazy(() => BackupCodeUpsertWithWhereUniqueWithoutTwoFactorInputSchema).array() ]).optional(),
  createMany: z.lazy(() => BackupCodeCreateManyTwoFactorInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => BackupCodeWhereUniqueInputSchema),z.lazy(() => BackupCodeWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => BackupCodeWhereUniqueInputSchema),z.lazy(() => BackupCodeWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => BackupCodeWhereUniqueInputSchema),z.lazy(() => BackupCodeWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => BackupCodeWhereUniqueInputSchema),z.lazy(() => BackupCodeWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => BackupCodeUpdateWithWhereUniqueWithoutTwoFactorInputSchema),z.lazy(() => BackupCodeUpdateWithWhereUniqueWithoutTwoFactorInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BackupCodeUpdateManyWithWhereWithoutTwoFactorInputSchema),z.lazy(() => BackupCodeUpdateManyWithWhereWithoutTwoFactorInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BackupCodeScalarWhereInputSchema),z.lazy(() => BackupCodeScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BackupCodeUncheckedUpdateManyWithoutTwoFactorNestedInputSchema;
