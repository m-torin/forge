...
export const LocationUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.LocationUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LocationUpdateWithoutDeletedByInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutDeletedByInputSchema) ]),
  create: z.union([ z.lazy(() => LocationCreateWithoutDeletedByInputSchema),z.lazy(() => LocationUncheckedCreateWithoutDeletedByInputSchema) ]),
}).strict();
