...
export const ProductIdentifiersUpdateWithWhereUniqueWithoutPdpJoinInputSchema: z.ZodType<Prisma.ProductIdentifiersUpdateWithWhereUniqueWithoutPdpJoinInput> = z.object({
  where: z.lazy(() => ProductIdentifiersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProductIdentifiersUpdateWithoutPdpJoinInputSchema),z.lazy(() => ProductIdentifiersUncheckedUpdateWithoutPdpJoinInputSchema) ]),
}).strict();
