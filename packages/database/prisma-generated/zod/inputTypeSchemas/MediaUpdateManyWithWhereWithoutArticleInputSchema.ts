...
export const MediaUpdateManyWithWhereWithoutArticleInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutArticleInput> =
  z
    .object({
      where: z.lazy(() => MediaScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MediaUpdateManyMutationInputSchema),
        z.lazy(() => MediaUncheckedUpdateManyWithoutArticleInputSchema),
      ]),
    })
    .strict();
