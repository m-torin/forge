...
export const UserUpdateOneWithoutDeletedArticlesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedArticlesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedArticlesInputSchema),
