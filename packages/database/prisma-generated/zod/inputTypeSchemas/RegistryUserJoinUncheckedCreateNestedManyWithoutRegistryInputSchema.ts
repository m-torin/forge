...
export const RegistryUserJoinUncheckedCreateNestedManyWithoutRegistryInputSchema: z.ZodType<Prisma.RegistryUserJoinUncheckedCreateNestedManyWithoutRegistryInput> =
  z
    .object({
      create: z
        .union([
