...
export const RegistryItemUncheckedUpdateManyWithoutRegistryNestedInputSchema: z.ZodType<Prisma.RegistryItemUncheckedUpdateManyWithoutRegistryNestedInput> =
  z
    .object({
      create: z
        .union([
