...
export const OrderItemScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.OrderItemScalarWhereWithAggregatesInput> = z.object({
  ...
  variantName: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  status: z.union([ z.lazy(() => EnumOrderItemStatusWithAggregatesFilterSchema),z.lazy(() => OrderItemStatusSchema) ]).optional(),
  fulfilledAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
