...
export const FavoriteJoinUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.FavoriteJoinUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
      where: z.lazy(() => FavoriteJoinScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => FavoriteJoinUpdateManyMutationInputSchema),
        z.lazy(() => FavoriteJoinUncheckedUpdateManyWithoutProductInputSchema),
      ]),
    })
    .strict();
