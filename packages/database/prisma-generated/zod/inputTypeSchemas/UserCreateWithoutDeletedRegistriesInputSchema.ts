...
export const UserCreateWithoutDeletedRegistriesInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedRegistriesInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedRegistriesInputSchema;
