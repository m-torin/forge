...
export const UserUpdateOneWithoutDeletedBrandsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedBrandsNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutDeletedBrandsInputSchema),z.lazy(() => UserUncheckedCreateWithoutDeletedBrandsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedBrandsInputSchema),z.lazy(() => UserUpdateWithoutDeletedBrandsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedBrandsInputSchema) ]).optional(),
}).strict();
