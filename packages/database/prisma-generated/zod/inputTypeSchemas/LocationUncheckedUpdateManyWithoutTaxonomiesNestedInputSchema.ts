...
export const LocationUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutTaxonomiesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LocationUpsertWithWhereUniqueWithoutTaxonomiesInputSchema),z.lazy(() => LocationUpsertWithWhereUniqueWithoutTaxonomiesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LocationUpdateWithWhereUniqueWithoutTaxonomiesInputSchema),z.lazy(() => LocationUpdateWithWhereUniqueWithoutTaxonomiesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LocationUpdateManyWithWhereWithoutTaxonomiesInputSchema),z.lazy(() => LocationUpdateManyWithWhereWithoutTaxonomiesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LocationScalarWhereInputSchema),z.lazy(() => LocationScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LocationUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema;
