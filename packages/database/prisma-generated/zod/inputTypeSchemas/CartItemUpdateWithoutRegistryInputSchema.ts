...
import { ProductUpdateOneWithoutCartItemsNestedInputSchema } from './ProductUpdateOneWithoutCartItemsNestedInputSchema';
...
export const CartItemUpdateWithoutRegistryInputSchema: z.ZodType<Prisma.CartItemUpdateWithoutRegistryInput> = z.object({
  ...
  product: z.lazy(() => ProductUpdateOneWithoutCartItemsNestedInputSchema).optional(),
  variant: z.lazy(() => ProductUpdateOneWithoutCartItemVariantsNestedInputSchema).optional()
}).strict();

export default CartItemUpdateWithoutRegistryInputSchema;
