...
export const WorkflowExecutionWhereUniqueInputSchema: z.ZodType<Prisma.WorkflowExecutionWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
...
.and(z.object({
  ...
  OR: z.lazy(() => WorkflowExecutionWhereInputSchema).array().optional(),
  ...
  inputPayloadHash: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  errorType: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  triggerSource: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  parentExecutionId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
