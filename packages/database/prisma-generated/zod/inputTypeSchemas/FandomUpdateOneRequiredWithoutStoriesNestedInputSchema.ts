...
export const FandomUpdateOneRequiredWithoutStoriesNestedInputSchema: z.ZodType<Prisma.FandomUpdateOneRequiredWithoutStoriesNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => FandomCreateWithoutStoriesInputSchema),
          z.lazy(() => FandomUncheckedCreateWithoutStoriesInputSchema),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => FandomUpdateToOneWithWhereWithoutStoriesInputSchema),
