...
export const ProductIdentifiersUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.ProductIdentifiersUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
      where: z.lazy(() => ProductIdentifiersScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductIdentifiersUpdateManyMutationInputSchema),
        z.lazy(() => ProductIdentifiersUncheckedUpdateManyWithoutProductInputSchema),
      ]),
    })
    .strict();
