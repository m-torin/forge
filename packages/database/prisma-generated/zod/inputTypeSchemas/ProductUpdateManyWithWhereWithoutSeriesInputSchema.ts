...
export const ProductUpdateManyWithWhereWithoutSeriesInputSchema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutSeriesInput> =
  z
    .object({
      where: z.lazy(() => ProductScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductUpdateManyMutationInputSchema),
        z.lazy(() => ProductUncheckedUpdateManyWithoutSeriesInputSchema),
      ]),
    })
    .strict();
