...
import { CollectionUncheckedCreateNestedManyWithoutUserInputSchema } from './CollectionUncheckedCreateNestedManyWithoutUserInputSchema';
...
export const UserUncheckedCreateWithoutTwoFactorInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutTwoFactorInput> = z.object({
  id: z.string(),
  name: z.string(),
  email: z.string(),
  ...
  favorites: z.lazy(() => FavoriteJoinUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  reviews: z.lazy(() => ReviewUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  createdRegistries: z.lazy(() => RegistryUncheckedCreateNestedManyWithoutCreatedByUserInputSchema).optional(),
  registries: z.lazy(() => RegistryUserJoinUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  purchases: z.lazy(() => RegistryPurchaseJoinUncheckedCreateNestedManyWithoutPurchaserInputSchema).optional(),
  reviewVotes: z.lazy(() => ReviewVoteJoinUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  ...
  invitationsSent: z.lazy(() => InvitationUncheckedCreateNestedManyWithoutInvitedByInputSchema).optional(),
  teamMemberships: z.lazy(() => TeamMemberUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  deletedArticles: z.lazy(() => ArticleUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedBrands: z.lazy(() => BrandUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedCollections: z.lazy(() => CollectionUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedProducts: z.lazy(() => ProductUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedTaxonomies: z.lazy(() => TaxonomyUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedReviews: z.lazy(() => ReviewUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedRegistries: z.lazy(() => RegistryUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedRegistryItems: z.lazy(() => RegistryItemUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedMedia: z.lazy(() => MediaUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedProductCategories: z.lazy(() => ProductCategoryUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedLocations: z.lazy(() => LocationUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedCasts: z.lazy(() => CastUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedFandoms: z.lazy(() => FandomUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedSeries: z.lazy(() => SeriesUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional(),
  deletedStories: z.lazy(() => StoryUncheckedCreateNestedManyWithoutDeletedByInputSchema).optional()
}).strict();

export default UserUncheckedCreateWithoutTwoFactorInputSchema;
