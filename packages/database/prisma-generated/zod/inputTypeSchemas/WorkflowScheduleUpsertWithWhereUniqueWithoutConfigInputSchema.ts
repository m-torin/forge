...
export const WorkflowScheduleUpsertWithWhereUniqueWithoutConfigInputSchema: z.ZodType<Prisma.WorkflowScheduleUpsertWithWhereUniqueWithoutConfigInput> = z.object({
  where: z.lazy(() => WorkflowScheduleWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => WorkflowScheduleUpdateWithoutConfigInputSchema),z.lazy(() => WorkflowScheduleUncheckedUpdateWithoutConfigInputSchema) ]),
