...
export const MediaUpsertWithWhereUniqueWithoutBrandInputSchema: z.ZodType<Prisma.MediaUpsertWithWhereUniqueWithoutBrandInput> = z.object({
  where: z.lazy(() => MediaWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => MediaUpdateWithoutBrandInputSchema),z.lazy(() => MediaUncheckedUpdateWithoutBrandInputSchema) ]),
