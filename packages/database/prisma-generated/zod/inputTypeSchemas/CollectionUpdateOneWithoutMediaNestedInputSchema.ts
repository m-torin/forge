...
export const CollectionUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.CollectionUpdateOneWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateToOneWithWhereWithoutMediaInputSchema),
