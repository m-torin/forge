...
export const MediaUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => MediaScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateManyMutationInputSchema),z.lazy(() => MediaUncheckedUpdateManyWithoutProductInputSchema) ]),
}).strict();
