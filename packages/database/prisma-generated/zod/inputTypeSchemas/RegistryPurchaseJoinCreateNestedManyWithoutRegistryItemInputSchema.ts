...
export const RegistryPurchaseJoinCreateNestedManyWithoutRegistryItemInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinCreateNestedManyWithoutRegistryItemInput> =
  z
    .object({
      create: z
        .union([
