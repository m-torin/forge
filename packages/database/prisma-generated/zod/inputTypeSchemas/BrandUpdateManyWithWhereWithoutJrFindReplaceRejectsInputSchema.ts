...
export const BrandUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.BrandUpdateManyWithWhereWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => BrandScalarWhereInputSchema),
  data: z.union([ z.lazy(() => BrandUpdateManyMutationInputSchema),z.lazy(() => BrandUncheckedUpdateManyWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
