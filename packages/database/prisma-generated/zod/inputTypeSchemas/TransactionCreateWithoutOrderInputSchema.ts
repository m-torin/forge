...
export const TransactionCreateWithoutOrderInputSchema: z.ZodType<Prisma.TransactionCreateWithoutOrderInput> =
  z
    .object({
      ...
      parentTransaction: z
        ...
        .optional(),
      refunds: z
        .lazy(() => TransactionCreateNestedManyWithoutParentTransactionInputSchema)
        .optional(),
    })
    .strict();

export default TransactionCreateWithoutOrderInputSchema;
