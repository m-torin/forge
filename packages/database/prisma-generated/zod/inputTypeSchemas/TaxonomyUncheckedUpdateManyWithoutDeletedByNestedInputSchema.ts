...
export const TaxonomyUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.TaxonomyUncheckedUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutDeletedByInputSchema),
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TaxonomyUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
