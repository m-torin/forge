...
export const PasskeyCountOrderByAggregateInputSchema: z.ZodType<Prisma.PasskeyCountOrderByAggregateInput> =
  z
    .object({
...
export default PasskeyCountOrderByAggregateInputSchema;
