...
export const MediaUpdateWithWhereUniqueWithoutCollectionInputSchema: z.ZodType<Prisma.MediaUpdateWithWhereUniqueWithoutCollectionInput> = z.object({
  where: z.lazy(() => MediaWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateWithoutCollectionInputSchema),z.lazy(() => MediaUncheckedUpdateWithoutCollectionInputSchema) ]),
}).strict();
