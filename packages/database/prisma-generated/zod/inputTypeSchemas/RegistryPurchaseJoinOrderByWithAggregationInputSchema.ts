...
import { RegistryPurchaseJoinCountOrderByAggregateInputSchema } from './RegistryPurchaseJoinCountOrderByAggregateInputSchema';
import { RegistryPurchaseJoinAvgOrderByAggregateInputSchema } from './RegistryPurchaseJoinAvgOrderByAggregateInputSchema';
import { RegistryPurchaseJoinMaxOrderByAggregateInputSchema } from './RegistryPurchaseJoinMaxOrderByAggregateInputSchema';
import { RegistryPurchaseJoinMinOrderByAggregateInputSchema } from './RegistryPurchaseJoinMinOrderByAggregateInputSchema';
import { RegistryPurchaseJoinSumOrderByAggregateInputSchema } from './RegistryPurchaseJoinSumOrderByAggregateInputSchema';

export const RegistryPurchaseJoinOrderByWithAggregationInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinOrderByWithAggregationInput> = z.object({
  ...
  _count: z.lazy(() => RegistryPurchaseJoinCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => RegistryPurchaseJoinAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => RegistryPurchaseJoinMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => RegistryPurchaseJoinMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => RegistryPurchaseJoinSumOrderByAggregateInputSchema).optional()
}).strict();

export default RegistryPurchaseJoinOrderByWithAggregationInputSchema;
