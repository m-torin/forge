...
export const LocationUpdateWithoutProductsInputSchema: z.ZodType<Prisma.LocationUpdateWithoutProductsInput> =
  z
    .object({
      id: z
...
export default LocationUpdateWithoutProductsInputSchema;
