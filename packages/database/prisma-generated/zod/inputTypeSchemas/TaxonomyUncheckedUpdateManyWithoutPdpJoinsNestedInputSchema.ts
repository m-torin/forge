...
export const TaxonomyUncheckedUpdateManyWithoutPdpJoinsNestedInputSchema: z.ZodType<Prisma.TaxonomyUncheckedUpdateManyWithoutPdpJoinsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutPdpJoinsInputSchema),
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutPdpJoinsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutPdpJoinsInputSchema),
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutPdpJoinsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutPdpJoinsInputSchema),
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutPdpJoinsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TaxonomyUncheckedUpdateManyWithoutPdpJoinsNestedInputSchema;
