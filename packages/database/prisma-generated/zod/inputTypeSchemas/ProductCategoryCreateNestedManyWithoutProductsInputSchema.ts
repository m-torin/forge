...
export const ProductCategoryCreateNestedManyWithoutProductsInputSchema: z.ZodType<Prisma.ProductCategoryCreateNestedManyWithoutProductsInput> =
  z
    .object({
      create: z
        .union([
...
export default ProductCategoryCreateNestedManyWithoutProductsInputSchema;
