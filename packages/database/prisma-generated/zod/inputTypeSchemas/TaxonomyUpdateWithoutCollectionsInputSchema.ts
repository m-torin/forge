...
export const TaxonomyUpdateWithoutCollectionsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithoutCollectionsInput> =
  z
    .object({
      id: z
      ...
      jrFindReplaceRejects: z
        .lazy(() => JrFindReplaceRejectUpdateManyWithoutTaxonomiesNestedInputSchema)
        .optional(),
      deletedBy: z.lazy(() => UserUpdateOneWithoutDeletedTaxonomiesNestedInputSchema).optional(),
    })
    .strict();

export default TaxonomyUpdateWithoutCollectionsInputSchema;
