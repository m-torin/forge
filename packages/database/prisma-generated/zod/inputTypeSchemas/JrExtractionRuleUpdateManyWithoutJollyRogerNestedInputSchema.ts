...
export const JrExtractionRuleUpdateManyWithoutJollyRogerNestedInputSchema: z.ZodType<Prisma.JrExtractionRuleUpdateManyWithoutJollyRogerNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => JrExtractionRuleUpsertWithWhereUniqueWithoutJollyRogerInputSchema),z.lazy(() => JrExtractionRuleUpsertWithWhereUniqueWithoutJollyRogerInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => JrExtractionRuleUpdateWithWhereUniqueWithoutJollyRogerInputSchema),z.lazy(() => JrExtractionRuleUpdateWithWhereUniqueWithoutJollyRogerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => JrExtractionRuleUpdateManyWithWhereWithoutJollyRogerInputSchema),z.lazy(() => JrExtractionRuleUpdateManyWithWhereWithoutJollyRogerInputSchema).array() ]).optional(),
...
export default JrExtractionRuleUpdateManyWithoutJollyRogerNestedInputSchema;
