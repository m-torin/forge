...
export const CollectionUncheckedCreateWithoutIdentifiersInputSchema: z.ZodType<Prisma.CollectionUncheckedCreateWithoutIdentifiersInput> =
  z
    .object({
      ...
      taxonomies: z
        ...
        .optional(),
      categories: z
        .lazy(() => ProductCategoryUncheckedCreateNestedManyWithoutCollectionsInputSchema)
        .optional(),
      pdpJoins: z
