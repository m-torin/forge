...
export const BackupCodeWhereUniqueInputSchema: z.ZodType<Prisma.BackupCodeWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => BackupCodeWhereInputSchema),z.lazy(() => BackupCodeWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BackupCodeWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BackupCodeWhereInputSchema),z.lazy(() => BackupCodeWhereInputSchema).array() ]).optional(),
  ...
  twoFactor: z.union([ z.lazy(() => TwoFactorScalarRelationFilterSchema),z.lazy(() => TwoFactorWhereInputSchema) ]).optional(),
}).strict());
