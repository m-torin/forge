...
export const RegistryPurchaseJoinUpdateManyWithoutRegistryItemNestedInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinUpdateManyWithoutRegistryItemNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => RegistryPurchaseJoinUpsertWithWhereUniqueWithoutRegistryItemInputSchema),
          z
            .lazy(() => RegistryPurchaseJoinUpsertWithWhereUniqueWithoutRegistryItemInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => RegistryPurchaseJoinUpdateWithWhereUniqueWithoutRegistryItemInputSchema),
          z
            .lazy(() => RegistryPurchaseJoinUpdateWithWhereUniqueWithoutRegistryItemInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => RegistryPurchaseJoinUpdateManyWithWhereWithoutRegistryItemInputSchema),
          z
            .lazy(() => RegistryPurchaseJoinUpdateManyWithWhereWithoutRegistryItemInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export default RegistryPurchaseJoinUpdateManyWithoutRegistryItemNestedInputSchema;
