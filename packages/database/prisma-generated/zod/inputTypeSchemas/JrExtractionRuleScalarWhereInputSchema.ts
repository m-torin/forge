...
export const JrExtractionRuleScalarWhereInputSchema: z.ZodType<Prisma.JrExtractionRuleScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => JrExtractionRuleScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
      ...
      fieldName: z
        .union([z.lazy(() => EnumJrChartRuleForFilterSchema), z.lazy(() => JrChartRuleForSchema)])
        .optional(),
