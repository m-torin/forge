...
export const PdpJoinUpsertWithoutUrlsInputSchema: z.ZodType<Prisma.PdpJoinUpsertWithoutUrlsInput> = z.object({
  update: z.union([ z.lazy(() => PdpJoinUpdateWithoutUrlsInputSchema),z.lazy(() => PdpJoinUncheckedUpdateWithoutUrlsInputSchema) ]),
  create: z.union([ z.lazy(() => PdpJoinCreateWithoutUrlsInputSchema),z.lazy(() => PdpJoinUncheckedCreateWithoutUrlsInputSchema) ]),
