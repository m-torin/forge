...
export const RegistryUserJoinWhereUniqueInputSchema: z.ZodType<Prisma.RegistryUserJoinWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        .object({
          ...
          userId_registryId: z
            .lazy(() => RegistryUserJoinUserIdRegistryIdCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
