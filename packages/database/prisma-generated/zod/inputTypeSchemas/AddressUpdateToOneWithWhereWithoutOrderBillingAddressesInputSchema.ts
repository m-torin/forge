...
export const AddressUpdateToOneWithWhereWithoutOrderBillingAddressesInputSchema: z.ZodType<Prisma.AddressUpdateToOneWithWhereWithoutOrderBillingAddressesInput> =
  z
    .object({
