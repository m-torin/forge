...
export const PasskeyUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.PasskeyUncheckedCreateWithoutUserInput> =
  z
    .object({
      id: z.string(),
...
export default PasskeyUncheckedCreateWithoutUserInputSchema;
