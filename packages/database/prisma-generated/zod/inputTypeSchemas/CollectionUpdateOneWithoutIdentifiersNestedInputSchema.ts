...
export const CollectionUpdateOneWithoutIdentifiersNestedInputSchema: z.ZodType<Prisma.CollectionUpdateOneWithoutIdentifiersNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => CollectionCreateOrConnectWithoutIdentifiersInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateToOneWithWhereWithoutIdentifiersInputSchema),
