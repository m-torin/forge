...
export const CollectionUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
