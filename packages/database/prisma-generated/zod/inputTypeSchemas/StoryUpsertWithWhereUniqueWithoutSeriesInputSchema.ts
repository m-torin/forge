...
export const StoryUpsertWithWhereUniqueWithoutSeriesInputSchema: z.ZodType<Prisma.StoryUpsertWithWhereUniqueWithoutSeriesInput> = z.object({
  where: z.lazy(() => StoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => StoryUpdateWithoutSeriesInputSchema),z.lazy(() => StoryUncheckedUpdateWithoutSeriesInputSchema) ]),
  create: z.union([ z.lazy(() => StoryCreateWithoutSeriesInputSchema),z.lazy(() => StoryUncheckedCreateWithoutSeriesInputSchema) ]),
}).strict();
