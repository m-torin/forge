...
export const MediaUpsertWithWhereUniqueWithoutTaxonomyInputSchema: z.ZodType<Prisma.MediaUpsertWithWhereUniqueWithoutTaxonomyInput> = z.object({
  where: z.lazy(() => MediaWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => MediaUpdateWithoutTaxonomyInputSchema),z.lazy(() => MediaUncheckedUpdateWithoutTaxonomyInputSchema) ]),
  create: z.union([ z.lazy(() => MediaCreateWithoutTaxonomyInputSchema),z.lazy(() => MediaUncheckedCreateWithoutTaxonomyInputSchema) ]),
}).strict();
