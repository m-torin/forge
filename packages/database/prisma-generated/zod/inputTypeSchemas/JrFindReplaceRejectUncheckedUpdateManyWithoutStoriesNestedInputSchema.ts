...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutStoriesNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutStoriesNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => JrFindReplaceRejectCreateWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectCreateWithoutStoriesInputSchema).array(),
          z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutStoriesInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutStoriesInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutStoriesInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutStoriesInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutStoriesInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutStoriesInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default JrFindReplaceRejectUncheckedUpdateManyWithoutStoriesNestedInputSchema;
