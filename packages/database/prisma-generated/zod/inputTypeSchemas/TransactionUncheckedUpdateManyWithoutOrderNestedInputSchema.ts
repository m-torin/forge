...
export const TransactionUncheckedUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutOrderNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => TransactionCreateWithoutOrderInputSchema),
          z.lazy(() => TransactionCreateWithoutOrderInputSchema).array(),
          z.lazy(() => TransactionUncheckedCreateWithoutOrderInputSchema),
          z.lazy(() => TransactionUncheckedCreateWithoutOrderInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => TransactionCreateOrConnectWithoutOrderInputSchema),
          z.lazy(() => TransactionCreateOrConnectWithoutOrderInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => TransactionUpsertWithWhereUniqueWithoutOrderInputSchema),
          z.lazy(() => TransactionUpsertWithWhereUniqueWithoutOrderInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => TransactionUpdateWithWhereUniqueWithoutOrderInputSchema),
          z.lazy(() => TransactionUpdateWithWhereUniqueWithoutOrderInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TransactionUpdateManyWithWhereWithoutOrderInputSchema),
          z.lazy(() => TransactionUpdateManyWithWhereWithoutOrderInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TransactionUncheckedUpdateManyWithoutOrderNestedInputSchema;
