...
export const TransactionWhereInputSchema: z.ZodType<Prisma.TransactionWhereInput> = z
  .object({
    AND: z
      .union([
    ...
    type: z
      .union([z.lazy(() => EnumTransactionTypeFilterSchema), z.lazy(() => TransactionTypeSchema)])
      .optional(),
    status: z
      .union([
    ...
    order: z
      .union([z.lazy(() => OrderScalarRelationFilterSchema), z.lazy(() => OrderWhereInputSchema)])
      .optional(),
    parentTransaction: z
      .union([
