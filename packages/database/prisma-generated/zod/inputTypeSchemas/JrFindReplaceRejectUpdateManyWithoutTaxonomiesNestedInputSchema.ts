...
export const JrFindReplaceRejectUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithoutTaxonomiesNestedInput> =
  z
    .object({
      create: z
        .union([
