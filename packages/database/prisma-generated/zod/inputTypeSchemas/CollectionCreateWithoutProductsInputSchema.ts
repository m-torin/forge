...
export const CollectionCreateWithoutProductsInputSchema: z.ZodType<Prisma.CollectionCreateWithoutProductsInput> =
  z
    .object({
...
export default CollectionCreateWithoutProductsInputSchema;
