...
export const InventoryUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.InventoryUncheckedUpdateManyWithoutProductNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => InventoryUpsertWithWhereUniqueWithoutProductInputSchema),z.lazy(() => InventoryUpsertWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InventoryUpdateWithWhereUniqueWithoutProductInputSchema),z.lazy(() => InventoryUpdateWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InventoryUpdateManyWithWhereWithoutProductInputSchema),z.lazy(() => InventoryUpdateManyWithWhereWithoutProductInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InventoryScalarWhereInputSchema),z.lazy(() => InventoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InventoryUncheckedUpdateManyWithoutProductNestedInputSchema;
