...
export const RegistryUncheckedCreateWithoutCreatedByUserInputSchema: z.ZodType<Prisma.RegistryUncheckedCreateWithoutCreatedByUserInput> =
  z
    .object({
      ...
      users: z
        ...
        .optional(),
      cartItems: z
        .lazy(() => CartItemUncheckedCreateNestedManyWithoutRegistryInputSchema)
        .optional(),
      orderItems: z
...
export default RegistryUncheckedCreateWithoutCreatedByUserInputSchema;
