...
export const JrFindReplaceRejectCreateWithoutStoriesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectCreateWithoutStoriesInput> = z.object({
  lookFor: z.string(),
  ...
  locations: z.lazy(() => LocationCreateNestedManyWithoutJrFindReplaceRejectsInputSchema).optional(),
  taxonomies: z.lazy(() => TaxonomyCreateNestedManyWithoutJrFindReplaceRejectsInputSchema).optional(),
  fandoms: z.lazy(() => FandomCreateNestedManyWithoutJrFindReplaceRejectsInputSchema).optional(),
  ...
  extractionRules: z.lazy(() => JrExtractionRuleCreateNestedManyWithoutFindReplaceRulesInputSchema).optional()
}).strict();

export default JrFindReplaceRejectCreateWithoutStoriesInputSchema;
