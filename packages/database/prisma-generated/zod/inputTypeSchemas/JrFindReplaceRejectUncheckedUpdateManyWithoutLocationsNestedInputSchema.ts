...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutLocationsNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutLocationsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutLocationsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default JrFindReplaceRejectUncheckedUpdateManyWithoutLocationsNestedInputSchema;
