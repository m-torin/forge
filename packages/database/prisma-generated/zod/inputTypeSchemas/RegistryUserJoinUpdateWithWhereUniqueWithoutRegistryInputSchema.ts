...
export const RegistryUserJoinUpdateWithWhereUniqueWithoutRegistryInputSchema: z.ZodType<Prisma.RegistryUserJoinUpdateWithWhereUniqueWithoutRegistryInput> = z.object({
  where: z.lazy(() => RegistryUserJoinWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RegistryUserJoinUpdateWithoutRegistryInputSchema),z.lazy(() => RegistryUserJoinUncheckedUpdateWithoutRegistryInputSchema) ]),
}).strict();
