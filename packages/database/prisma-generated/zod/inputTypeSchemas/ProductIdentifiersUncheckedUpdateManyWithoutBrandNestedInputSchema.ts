...
export const ProductIdentifiersUncheckedUpdateManyWithoutBrandNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutBrandNestedInput> =
  z
    .object({
      create: z
        .union([
