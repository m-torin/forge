...
export const WorkflowScheduleUncheckedUpdateManyWithoutConfigNestedInputSchema: z.ZodType<Prisma.WorkflowScheduleUncheckedUpdateManyWithoutConfigNestedInput> =
  z
    .object({
      create: z
        .union([
