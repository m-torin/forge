...
export const MediaUpdateManyWithWhereWithoutPdpJoinInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutPdpJoinInput> =
  z
    .object({
      where: z.lazy(() => MediaScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MediaUpdateManyMutationInputSchema),
        z.lazy(() => MediaUncheckedUpdateManyWithoutPdpJoinInputSchema),
      ]),
    })
    .strict();
