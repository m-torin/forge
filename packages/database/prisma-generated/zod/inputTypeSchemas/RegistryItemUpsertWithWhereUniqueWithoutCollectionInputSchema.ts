...
export const RegistryItemUpsertWithWhereUniqueWithoutCollectionInputSchema: z.ZodType<Prisma.RegistryItemUpsertWithWhereUniqueWithoutCollectionInput> = z.object({
  where: z.lazy(() => RegistryItemWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RegistryItemUpdateWithoutCollectionInputSchema),z.lazy(() => RegistryItemUncheckedUpdateWithoutCollectionInputSchema) ]),
  create: z.union([ z.lazy(() => RegistryItemCreateWithoutCollectionInputSchema),z.lazy(() => RegistryItemUncheckedCreateWithoutCollectionInputSchema) ]),
}).strict();
