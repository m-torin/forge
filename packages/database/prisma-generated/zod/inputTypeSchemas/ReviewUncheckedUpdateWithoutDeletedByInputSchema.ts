...
export const ReviewUncheckedUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.ReviewUncheckedUpdateWithoutDeletedByInput> =
  z
    .object({
      id: z
      ...
      votes: z
        .lazy(() => ReviewVoteJoinUncheckedUpdateManyWithoutReviewNestedInputSchema)
        .optional(),
    })
    .strict();

export default ReviewUncheckedUpdateWithoutDeletedByInputSchema;
