...
export const CartItemUpdateManyWithWhereWithoutVariantInputSchema: z.ZodType<Prisma.CartItemUpdateManyWithWhereWithoutVariantInput> =
  z
    .object({
      where: z.lazy(() => CartItemScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CartItemUpdateManyMutationInputSchema),
        z.lazy(() => CartItemUncheckedUpdateManyWithoutVariantInputSchema),
      ]),
    })
    .strict();
