...
export const JrExtractionRuleUpdateManyWithoutFindReplaceRulesNestedInputSchema: z.ZodType<Prisma.JrExtractionRuleUpdateManyWithoutFindReplaceRulesNestedInput> =
  z
    .object({
      create: z
        .union([
