...
export const JollyRogerUpdateToOneWithWhereWithoutExtractionRulesInputSchema: z.ZodType<Prisma.JollyRogerUpdateToOneWithWhereWithoutExtractionRulesInput> = z.object({
  where: z.lazy(() => JollyRogerWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => JollyRogerUpdateWithoutExtractionRulesInputSchema),z.lazy(() => JollyRogerUncheckedUpdateWithoutExtractionRulesInputSchema) ]),
}).strict();
