...
export const UserCreateWithoutDeletedArticlesInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedArticlesInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedArticlesInputSchema;
