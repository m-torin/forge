...
export const TaxonomyUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithoutDeletedByInput> =
  z
    .object({
      id: z
...
export default TaxonomyUpdateWithoutDeletedByInputSchema;
