...
export const ProductUpdateOneWithoutRegistriesNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutRegistriesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProductUpdateToOneWithWhereWithoutRegistriesInputSchema),z.lazy(() => ProductUpdateWithoutRegistriesInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutRegistriesInputSchema) ]).optional(),
}).strict();
