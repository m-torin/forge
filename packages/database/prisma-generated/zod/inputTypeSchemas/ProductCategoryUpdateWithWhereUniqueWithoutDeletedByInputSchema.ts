...
export const ProductCategoryUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductCategoryUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => ProductCategoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProductCategoryUpdateWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
