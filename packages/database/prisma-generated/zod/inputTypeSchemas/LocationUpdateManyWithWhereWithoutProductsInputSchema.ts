...
export const LocationUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => LocationScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => LocationUpdateManyMutationInputSchema),
        z.lazy(() => LocationUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
