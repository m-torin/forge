...
export const JollyRogerUpdateToOneWithWhereWithoutBrandInputSchema: z.ZodType<Prisma.JollyRogerUpdateToOneWithWhereWithoutBrandInput> = z.object({
  where: z.lazy(() => JollyRogerWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => JollyRogerUpdateWithoutBrandInputSchema),z.lazy(() => JollyRogerUncheckedUpdateWithoutBrandInputSchema) ]),
}).strict();
