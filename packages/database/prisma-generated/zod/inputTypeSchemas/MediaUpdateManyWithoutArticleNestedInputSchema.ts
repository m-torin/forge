...
export const MediaUpdateManyWithoutArticleNestedInputSchema: z.ZodType<Prisma.MediaUpdateManyWithoutArticleNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutArticleInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutArticleInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutArticleInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutArticleInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutArticleInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutArticleInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUpdateManyWithoutArticleNestedInputSchema;
