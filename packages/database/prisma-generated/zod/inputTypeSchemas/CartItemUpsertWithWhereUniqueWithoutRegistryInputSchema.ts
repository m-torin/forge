...
export const CartItemUpsertWithWhereUniqueWithoutRegistryInputSchema: z.ZodType<Prisma.CartItemUpsertWithWhereUniqueWithoutRegistryInput> = z.object({
  where: z.lazy(() => CartItemWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CartItemUpdateWithoutRegistryInputSchema),z.lazy(() => CartItemUncheckedUpdateWithoutRegistryInputSchema) ]),
  create: z.union([ z.lazy(() => CartItemCreateWithoutRegistryInputSchema),z.lazy(() => CartItemUncheckedCreateWithoutRegistryInputSchema) ]),
}).strict();
