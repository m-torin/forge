...
export const ProductCategoryUncheckedCreateNestedManyWithoutProductsInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedCreateNestedManyWithoutProductsInput> =
  z
    .object({
      create: z
        .union([
