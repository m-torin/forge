...
export const AddressUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => AddressUpsertWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => AddressUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => AddressUpdateWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => AddressUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => AddressUpdateManyWithWhereWithoutUserInputSchema),
          z.lazy(() => AddressUpdateManyWithWhereWithoutUserInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => AddressScalarWhereInputSchema),
          z.lazy(() => AddressScalarWhereInputSchema).array(),
        ])
        .optional(),
    })
    .strict();

export default AddressUncheckedUpdateManyWithoutUserNestedInputSchema;
