...
import { FandomUpdateOneRequiredWithoutStoriesNestedInputSchema } from './FandomUpdateOneRequiredWithoutStoriesNestedInputSchema';
...
export const StoryUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.StoryUpdateWithoutDeletedByInput> = z.object({
  ...
  fandom: z.lazy(() => FandomUpdateOneRequiredWithoutStoriesNestedInputSchema).optional(),
  products: z.lazy(() => ProductUpdateManyWithoutStoriesNestedInputSchema).optional(),
  jrFindReplaceRejects: z.lazy(() => JrFindReplaceRejectUpdateManyWithoutStoriesNestedInputSchema).optional()
}).strict();

export default StoryUpdateWithoutDeletedByInputSchema;
