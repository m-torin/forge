...
export const BrandUpdateToOneWithWhereWithoutMediaInputSchema: z.ZodType<Prisma.BrandUpdateToOneWithWhereWithoutMediaInput> = z.object({
  where: z.lazy(() => BrandWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BrandUpdateWithoutMediaInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutMediaInputSchema) ]),
}).strict();
