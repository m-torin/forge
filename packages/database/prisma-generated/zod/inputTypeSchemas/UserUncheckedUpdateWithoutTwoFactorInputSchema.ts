...
export const UserUncheckedUpdateWithoutTwoFactorInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutTwoFactorInput> =
  z
    .object({
      ...
      bio: z
        ...
        .nullable(),
      expertise: z
        .union([z.lazy(() => UserUpdateexpertiseInputSchema), z.string().array()])
        .optional(),
      isVerifiedAuthor: z
        .union([z.boolean(), z.lazy(() => BoolFieldUpdateOperationsInputSchema)])
        .optional(),
      ...
      favorites: z
        .lazy(() => FavoriteJoinUncheckedUpdateManyWithoutUserNestedInputSchema)
        .optional(),
      reviews: z.lazy(() => ReviewUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
      createdRegistries: z
        .lazy(() => RegistryUncheckedUpdateManyWithoutCreatedByUserNestedInputSchema)
        .optional(),
      registries: z
        .lazy(() => RegistryUserJoinUncheckedUpdateManyWithoutUserNestedInputSchema)
        .optional(),
      purchases: z
        .lazy(() => RegistryPurchaseJoinUncheckedUpdateManyWithoutPurchaserNestedInputSchema)
        .optional(),
      reviewVotes: z
        .lazy(() => ReviewVoteJoinUncheckedUpdateManyWithoutUserNestedInputSchema)
        .optional(),
      ...
      invitationsSent: z
        .lazy(() => InvitationUncheckedUpdateManyWithoutInvitedByNestedInputSchema)
        .optional(),
      teamMemberships: z
        .lazy(() => TeamMemberUncheckedUpdateManyWithoutUserNestedInputSchema)
        .optional(),
      deletedArticles: z
        .lazy(() => ArticleUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedBrands: z
        .lazy(() => BrandUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedCollections: z
        .lazy(() => CollectionUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedProducts: z
        .lazy(() => ProductUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedTaxonomies: z
        .lazy(() => TaxonomyUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedReviews: z
        .lazy(() => ReviewUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedRegistries: z
        .lazy(() => RegistryUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedRegistryItems: z
        .lazy(() => RegistryItemUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedMedia: z
        .lazy(() => MediaUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedProductCategories: z
        .lazy(() => ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedLocations: z
        .lazy(() => LocationUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedCasts: z
        .lazy(() => CastUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedFandoms: z
        .lazy(() => FandomUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedSeries: z
        .lazy(() => SeriesUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
      deletedStories: z
        .lazy(() => StoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema)
        .optional(),
    })
    .strict();

export default UserUncheckedUpdateWithoutTwoFactorInputSchema;
