...
export const UserUpdateOneWithoutDeletedLocationsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedLocationsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedLocationsInputSchema),
