...
export const FandomUncheckedUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.FandomUncheckedUpdateManyWithoutProductsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => FandomUpsertWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => FandomUpsertWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => FandomUpdateWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => FandomUpdateWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => FandomUpdateManyWithWhereWithoutProductsInputSchema),z.lazy(() => FandomUpdateManyWithWhereWithoutProductsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => FandomScalarWhereInputSchema),z.lazy(() => FandomScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default FandomUncheckedUpdateManyWithoutProductsNestedInputSchema;
