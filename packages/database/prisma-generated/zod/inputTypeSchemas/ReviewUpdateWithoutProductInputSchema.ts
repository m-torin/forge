...
export const ReviewUpdateWithoutProductInputSchema: z.ZodType<Prisma.ReviewUpdateWithoutProductInput> =
  z
    .object({
      id: z
...
export default ReviewUpdateWithoutProductInputSchema;
