...
export const UserCreateWithoutDeletedMediaInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedMediaInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedMediaInputSchema;
