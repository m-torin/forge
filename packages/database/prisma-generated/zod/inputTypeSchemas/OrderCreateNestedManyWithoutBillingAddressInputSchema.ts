...
export const OrderCreateNestedManyWithoutBillingAddressInputSchema: z.ZodType<Prisma.OrderCreateNestedManyWithoutBillingAddressInput> =
  z
    .object({
      create: z
        .union([
...
export default OrderCreateNestedManyWithoutBillingAddressInputSchema;
