...
export const SeriesUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.SeriesUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => SeriesScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => SeriesUpdateManyMutationInputSchema),
        z.lazy(() => SeriesUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
