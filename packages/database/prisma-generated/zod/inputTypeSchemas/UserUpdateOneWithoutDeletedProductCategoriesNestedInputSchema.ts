...
export const UserUpdateOneWithoutDeletedProductCategoriesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedProductCategoriesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedProductCategoriesInputSchema),z.lazy(() => UserUpdateWithoutDeletedProductCategoriesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedProductCategoriesInputSchema) ]).optional(),
}).strict();
