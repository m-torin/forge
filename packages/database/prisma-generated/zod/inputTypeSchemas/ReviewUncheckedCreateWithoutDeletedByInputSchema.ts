...
export const ReviewUncheckedCreateWithoutDeletedByInputSchema: z.ZodType<Prisma.ReviewUncheckedCreateWithoutDeletedByInput> = z.object({
  ...
  votes: z.lazy(() => ReviewVoteJoinUncheckedCreateNestedManyWithoutReviewInputSchema).optional()
}).strict();

export default ReviewUncheckedCreateWithoutDeletedByInputSchema;
