...
export const MediaUpdateWithWhereUniqueWithoutArticleInputSchema: z.ZodType<Prisma.MediaUpdateWithWhereUniqueWithoutArticleInput> = z.object({
  where: z.lazy(() => MediaWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateWithoutArticleInputSchema),z.lazy(() => MediaUncheckedUpdateWithoutArticleInputSchema) ]),
}).strict();
