...
export const ReviewUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.ReviewUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => ReviewWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ReviewUpdateWithoutDeletedByInputSchema),z.lazy(() => ReviewUncheckedUpdateWithoutDeletedByInputSchema) ]),
