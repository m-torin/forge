...
export const InventoryWhereUniqueInputSchema: z.ZodType<Prisma.InventoryWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    productId_variantId_locationId: z.lazy(() => InventoryProductIdVariantIdLocationIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  productId_variantId_locationId: z.lazy(() => InventoryProductIdVariantIdLocationIdCompoundUniqueInputSchema).optional(),
  ...
  lowStockThreshold: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
