...
export const RegistryPurchaseJoinUncheckedCreateNestedManyWithoutPurchaserInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinUncheckedCreateNestedManyWithoutPurchaserInput> =
  z
    .object({
      create: z
        .union([
