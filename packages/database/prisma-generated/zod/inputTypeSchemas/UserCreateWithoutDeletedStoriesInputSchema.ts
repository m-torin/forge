...
export const UserCreateWithoutDeletedStoriesInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedStoriesInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedStoriesInputSchema;
