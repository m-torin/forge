...
export const RegistryUpdateOneWithoutCartItemsNestedInputSchema: z.ZodType<Prisma.RegistryUpdateOneWithoutCartItemsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => RegistryUpdateToOneWithWhereWithoutCartItemsInputSchema),z.lazy(() => RegistryUpdateWithoutCartItemsInputSchema),z.lazy(() => RegistryUncheckedUpdateWithoutCartItemsInputSchema) ]).optional(),
}).strict();
