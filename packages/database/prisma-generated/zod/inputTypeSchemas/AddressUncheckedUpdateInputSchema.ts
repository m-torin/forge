...
export const AddressUncheckedUpdateInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateInput> = z.object({
  ...
  orderShippingAddresses: z.lazy(() => OrderUncheckedUpdateManyWithoutShippingAddressNestedInputSchema).optional(),
  orderBillingAddresses: z.lazy(() => OrderUncheckedUpdateManyWithoutBillingAddressNestedInputSchema).optional()
}).strict();
