...
import { UserCreateNestedOneWithoutApiKeysInputSchema } from './UserCreateNestedOneWithoutApiKeysInputSchema';

export const ApiKeyCreateInputSchema: z.ZodType<Prisma.ApiKeyCreateInput> = z
  .object({
    id: z.string(),
    name: z.string(),
    ...
    metadata: z
      ...
      .optional(),
    user: z.lazy(() => UserCreateNestedOneWithoutApiKeysInputSchema),
  })
  .strict();
