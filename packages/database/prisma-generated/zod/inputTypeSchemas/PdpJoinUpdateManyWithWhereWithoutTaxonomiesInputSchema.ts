...
export const PdpJoinUpdateManyWithWhereWithoutTaxonomiesInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutTaxonomiesInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => PdpJoinUpdateManyMutationInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateManyWithoutTaxonomiesInputSchema),
      ]),
    })
    .strict();
