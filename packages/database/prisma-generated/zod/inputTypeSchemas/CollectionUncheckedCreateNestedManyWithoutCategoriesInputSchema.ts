...
export const CollectionUncheckedCreateNestedManyWithoutCategoriesInputSchema: z.ZodType<Prisma.CollectionUncheckedCreateNestedManyWithoutCategoriesInput> =
  z
    .object({
      create: z
        .union([
