...
import { RegistryItemCreateNestedOneWithoutPurchasesInputSchema } from './RegistryItemCreateNestedOneWithoutPurchasesInputSchema';

export const RegistryPurchaseJoinCreateWithoutPurchaserInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinCreateWithoutPurchaserInput> = z.object({
  ...
  registryItem: z.lazy(() => RegistryItemCreateNestedOneWithoutPurchasesInputSchema)
}).strict();

export default RegistryPurchaseJoinCreateWithoutPurchaserInputSchema;
