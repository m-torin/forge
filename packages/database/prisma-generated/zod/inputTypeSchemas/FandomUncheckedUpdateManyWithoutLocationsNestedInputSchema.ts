...
export const FandomUncheckedUpdateManyWithoutLocationsNestedInputSchema: z.ZodType<Prisma.FandomUncheckedUpdateManyWithoutLocationsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => FandomUpsertWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => FandomUpsertWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => FandomUpdateWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => FandomUpdateWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => FandomUpdateManyWithWhereWithoutLocationsInputSchema),
          z.lazy(() => FandomUpdateManyWithWhereWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default FandomUncheckedUpdateManyWithoutLocationsNestedInputSchema;
