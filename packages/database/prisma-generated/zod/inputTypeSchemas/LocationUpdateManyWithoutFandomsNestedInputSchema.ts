...
export const LocationUpdateManyWithoutFandomsNestedInputSchema: z.ZodType<Prisma.LocationUpdateManyWithoutFandomsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => LocationUpsertWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => LocationUpsertWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => LocationUpdateWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => LocationUpdateWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => LocationUpdateManyWithWhereWithoutFandomsInputSchema),
          z.lazy(() => LocationUpdateManyWithWhereWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default LocationUpdateManyWithoutFandomsNestedInputSchema;
