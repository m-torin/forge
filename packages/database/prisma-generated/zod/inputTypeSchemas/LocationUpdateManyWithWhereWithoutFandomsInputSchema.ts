...
export const LocationUpdateManyWithWhereWithoutFandomsInputSchema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutFandomsInput> = z.object({
  where: z.lazy(() => LocationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateManyMutationInputSchema),z.lazy(() => LocationUncheckedUpdateManyWithoutFandomsInputSchema) ]),
}).strict();
