...
export const UserCreateWithoutInvitationsSentInputSchema: z.ZodType<Prisma.UserCreateWithoutInvitationsSentInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutInvitationsSentInputSchema;
