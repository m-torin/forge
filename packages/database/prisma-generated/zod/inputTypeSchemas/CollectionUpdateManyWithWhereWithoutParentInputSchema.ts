...
export const CollectionUpdateManyWithWhereWithoutParentInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutParentInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutParentInputSchema),
      ]),
    })
    .strict();
