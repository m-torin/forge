...
export const JrFindReplaceRejectUpsertWithWhereUniqueWithoutStoriesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpsertWithWhereUniqueWithoutStoriesInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateWithoutStoriesInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateWithoutStoriesInputSchema),
      ]),
      create: z.union([
