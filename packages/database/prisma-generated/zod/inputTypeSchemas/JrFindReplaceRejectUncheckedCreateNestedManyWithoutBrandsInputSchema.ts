...
export const JrFindReplaceRejectUncheckedCreateNestedManyWithoutBrandsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedCreateNestedManyWithoutBrandsInput> =
  z
    .object({
      create: z
        .union([
