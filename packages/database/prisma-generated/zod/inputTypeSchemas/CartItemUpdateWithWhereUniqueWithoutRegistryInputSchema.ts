...
export const CartItemUpdateWithWhereUniqueWithoutRegistryInputSchema: z.ZodType<Prisma.CartItemUpdateWithWhereUniqueWithoutRegistryInput> = z.object({
  where: z.lazy(() => CartItemWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CartItemUpdateWithoutRegistryInputSchema),z.lazy(() => CartItemUncheckedUpdateWithoutRegistryInputSchema) ]),
}).strict();
