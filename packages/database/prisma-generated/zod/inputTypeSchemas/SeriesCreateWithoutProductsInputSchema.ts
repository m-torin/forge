...
export const SeriesCreateWithoutProductsInputSchema: z.ZodType<Prisma.SeriesCreateWithoutProductsInput> =
  z
    .object({
      ...
      jrFindReplaceRejects: z
        .lazy(() => JrFindReplaceRejectCreateNestedManyWithoutSeriesInputSchema)
        .optional(),
      deletedBy: z.lazy(() => UserCreateNestedOneWithoutDeletedSeriesInputSchema).optional(),
    })
    .strict();

export default SeriesCreateWithoutProductsInputSchema;
