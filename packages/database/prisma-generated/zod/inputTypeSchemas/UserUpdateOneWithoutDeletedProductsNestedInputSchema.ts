...
export const UserUpdateOneWithoutDeletedProductsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedProductsNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutDeletedProductsInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedProductsInputSchema),
