...
export const ProductCategoryUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductCategoryUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => ProductCategoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProductCategoryUpdateWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUncheckedUpdateWithoutDeletedByInputSchema) ]),
  create: z.union([ z.lazy(() => ProductCategoryCreateWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUncheckedCreateWithoutDeletedByInputSchema) ]),
}).strict();
