...
export const ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutProductInputSchema),z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutProductInputSchema),z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutProductInputSchema),z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutProductInputSchema).array() ]).optional(),
...
export default ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInputSchema;
