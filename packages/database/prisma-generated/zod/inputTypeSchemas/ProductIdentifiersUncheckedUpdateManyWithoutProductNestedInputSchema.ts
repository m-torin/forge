...
export const ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
