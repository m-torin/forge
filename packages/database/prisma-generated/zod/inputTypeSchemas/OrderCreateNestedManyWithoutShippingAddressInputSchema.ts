...
export const OrderCreateNestedManyWithoutShippingAddressInputSchema: z.ZodType<Prisma.OrderCreateNestedManyWithoutShippingAddressInput> =
  z
    .object({
      create: z
        .union([
...
export default OrderCreateNestedManyWithoutShippingAddressInputSchema;
