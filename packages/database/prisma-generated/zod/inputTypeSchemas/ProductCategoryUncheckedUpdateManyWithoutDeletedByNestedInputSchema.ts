...
export const ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCategoryCreateWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryCreateWithoutDeletedByInputSchema).array(),z.lazy(() => ProductCategoryUncheckedCreateWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUncheckedCreateWithoutDeletedByInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCategoryCreateOrConnectWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryCreateOrConnectWithoutDeletedByInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => ProductCategoryUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
...
export default ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
