...
export const ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.ProductCategoryUncheckedUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
