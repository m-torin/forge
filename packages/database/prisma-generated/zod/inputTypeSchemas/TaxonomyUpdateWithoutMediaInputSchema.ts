...
export const TaxonomyUpdateWithoutMediaInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithoutMediaInput> =
  z
    .object({
      id: z
...
export default TaxonomyUpdateWithoutMediaInputSchema;
