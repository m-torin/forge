...
export const SeriesUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.SeriesUpdateManyWithWhereWithoutDeletedByInput> = z.object({
  where: z.lazy(() => SeriesScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SeriesUpdateManyMutationInputSchema),z.lazy(() => SeriesUncheckedUpdateManyWithoutDeletedByInputSchema) ]),
}).strict();
