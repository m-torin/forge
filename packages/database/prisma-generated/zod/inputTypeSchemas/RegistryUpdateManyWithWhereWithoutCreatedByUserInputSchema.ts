...
export const RegistryUpdateManyWithWhereWithoutCreatedByUserInputSchema: z.ZodType<Prisma.RegistryUpdateManyWithWhereWithoutCreatedByUserInput> = z.object({
  where: z.lazy(() => RegistryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryUpdateManyMutationInputSchema),z.lazy(() => RegistryUncheckedUpdateManyWithoutCreatedByUserInputSchema) ]),
}).strict();
