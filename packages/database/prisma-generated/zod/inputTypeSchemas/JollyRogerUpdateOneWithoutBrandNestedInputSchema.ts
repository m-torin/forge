...
export const JollyRogerUpdateOneWithoutBrandNestedInputSchema: z.ZodType<Prisma.JollyRogerUpdateOneWithoutBrandNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => JollyRogerUpdateToOneWithWhereWithoutBrandInputSchema),
...
export default JollyRogerUpdateOneWithoutBrandNestedInputSchema;
