...
export const JrFindReplaceRejectUpsertWithWhereUniqueWithoutCastsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpsertWithWhereUniqueWithoutCastsInput> = z.object({
  where: z.lazy(() => JrFindReplaceRejectWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => JrFindReplaceRejectUpdateWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedUpdateWithoutCastsInputSchema) ]),
  create: z.union([ z.lazy(() => JrFindReplaceRejectCreateWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutCastsInputSchema) ]),
}).strict();
