...
import { CollectionUpdateManyWithoutParentNestedInputSchema } from './CollectionUpdateManyWithoutParentNestedInputSchema';
...
export const CollectionUpdateWithoutTaxonomiesInputSchema: z.ZodType<Prisma.CollectionUpdateWithoutTaxonomiesInput> =
  z
    .object({
      id: z
      ...
      children: z.lazy(() => CollectionUpdateManyWithoutParentNestedInputSchema).optional(),
      ...
      categories: z
        .lazy(() => ProductCategoryUpdateManyWithoutCollectionsNestedInputSchema)
        .optional(),
      ...
      identifiers: z
        .lazy(() => ProductIdentifiersUpdateManyWithoutCollectionNestedInputSchema)
        .optional(),
      deletedBy: z.lazy(() => UserUpdateOneWithoutDeletedCollectionsNestedInputSchema).optional(),
    })
    .strict();

export default CollectionUpdateWithoutTaxonomiesInputSchema;
