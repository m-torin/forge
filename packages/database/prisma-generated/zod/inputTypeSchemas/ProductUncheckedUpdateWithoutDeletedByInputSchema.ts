...
import { FandomUncheckedUpdateManyWithoutProductsNestedInputSchema } from './FandomUncheckedUpdateManyWithoutProductsNestedInputSchema';
...
export const ProductUncheckedUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutDeletedByInput> = z.object({
  ...
  variantPrice: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => NullableDecimalFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  compareAtPrice: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => NullableDecimalFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  aiGenerated: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  aiConfidence: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  aiSources: z.union([ z.lazy(() => ProductUpdateaiSourcesInputSchema),z.string().array() ]).optional(),
  ...
  collections: z.lazy(() => CollectionUncheckedUpdateManyWithoutProductsNestedInputSchema).optional(),
  taxonomies: z.lazy(() => TaxonomyUncheckedUpdateManyWithoutProductsNestedInputSchema).optional(),
  categories: z.lazy(() => ProductCategoryUncheckedUpdateManyWithoutProductsNestedInputSchema).optional(),
  media: z.lazy(() => MediaUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  favorites: z.lazy(() => FavoriteJoinUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  registries: z.lazy(() => RegistryItemUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  fandoms: z.lazy(() => FandomUncheckedUpdateManyWithoutProductsNestedInputSchema).optional(),
  ...
  locations: z.lazy(() => LocationUncheckedUpdateManyWithoutProductsNestedInputSchema).optional(),
  ...
  cartItemVariants: z.lazy(() => CartItemUncheckedUpdateManyWithoutVariantNestedInputSchema).optional(),
  orderItems: z.lazy(() => OrderItemUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  orderItemVariants: z.lazy(() => OrderItemUncheckedUpdateManyWithoutVariantNestedInputSchema).optional(),
  inventory: z.lazy(() => InventoryUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  inventoryVariants: z.lazy(() => InventoryUncheckedUpdateManyWithoutVariantNestedInputSchema).optional(),
  identifiers: z.lazy(() => ProductIdentifiersUncheckedUpdateManyWithoutProductNestedInputSchema).optional(),
  reviews: z.lazy(() => ReviewUncheckedUpdateManyWithoutProductNestedInputSchema).optional()
}).strict();

export default ProductUncheckedUpdateWithoutDeletedByInputSchema;
