...
export const PdpJoinUpdateOneWithoutIdentifiersNestedInputSchema: z.ZodType<Prisma.PdpJoinUpdateOneWithoutIdentifiersNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PdpJoinUpdateToOneWithWhereWithoutIdentifiersInputSchema),z.lazy(() => PdpJoinUpdateWithoutIdentifiersInputSchema),z.lazy(() => PdpJoinUncheckedUpdateWithoutIdentifiersInputSchema) ]).optional(),
}).strict();
