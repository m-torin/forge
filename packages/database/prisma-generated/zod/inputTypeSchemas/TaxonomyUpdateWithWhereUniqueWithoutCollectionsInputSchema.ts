...
export const TaxonomyUpdateWithWhereUniqueWithoutCollectionsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithWhereUniqueWithoutCollectionsInput> = z.object({
  where: z.lazy(() => TaxonomyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateWithoutCollectionsInputSchema),z.lazy(() => TaxonomyUncheckedUpdateWithoutCollectionsInputSchema) ]),
}).strict();
