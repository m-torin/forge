...
import { NestedEnumInventoryTransactionTypeWithAggregatesFilterSchema } from './NestedEnumInventoryTransactionTypeWithAggregatesFilterSchema';
import { NestedIntFilterSchema } from './NestedIntFilterSchema';
import { NestedEnumInventoryTransactionTypeFilterSchema } from './NestedEnumInventoryTransactionTypeFilterSchema';

export const EnumInventoryTransactionTypeWithAggregatesFilterSchema: z.ZodType<Prisma.EnumInventoryTransactionTypeWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => InventoryTransactionTypeSchema),z.lazy(() => NestedEnumInventoryTransactionTypeWithAggregatesFilterSchema) ]).optional(),
...
export default EnumInventoryTransactionTypeWithAggregatesFilterSchema;
