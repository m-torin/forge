...
export const ProductUpdateWithWhereUniqueWithoutStoriesInputSchema: z.ZodType<Prisma.ProductUpdateWithWhereUniqueWithoutStoriesInput> =
  z
    .object({
      where: z.lazy(() => ProductWhereUniqueInputSchema),
      data: z.union([
        z.lazy(() => ProductUpdateWithoutStoriesInputSchema),
        z.lazy(() => ProductUncheckedUpdateWithoutStoriesInputSchema),
      ]),
    })
    .strict();
