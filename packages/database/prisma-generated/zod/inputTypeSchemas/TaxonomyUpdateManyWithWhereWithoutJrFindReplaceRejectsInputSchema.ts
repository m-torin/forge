...
export const TaxonomyUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithWhereWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => TaxonomyScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateManyMutationInputSchema),z.lazy(() => TaxonomyUncheckedUpdateManyWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
