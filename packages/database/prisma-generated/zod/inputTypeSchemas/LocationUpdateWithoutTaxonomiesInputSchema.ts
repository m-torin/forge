...
export const LocationUpdateWithoutTaxonomiesInputSchema: z.ZodType<Prisma.LocationUpdateWithoutTaxonomiesInput> =
  z
    .object({
      id: z
      ...
      jrFindReplaceRejects: z
        .lazy(() => JrFindReplaceRejectUpdateManyWithoutLocationsNestedInputSchema)
        .optional(),
      deletedBy: z.lazy(() => UserUpdateOneWithoutDeletedLocationsNestedInputSchema).optional(),
    })
    .strict();

export default LocationUpdateWithoutTaxonomiesInputSchema;
