...
export const BrandUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.BrandUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => BrandWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BrandUpdateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
