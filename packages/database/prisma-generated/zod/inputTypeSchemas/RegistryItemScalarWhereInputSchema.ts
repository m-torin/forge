...
export const RegistryItemScalarWhereInputSchema: z.ZodType<Prisma.RegistryItemScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => RegistryItemScalarWhereInputSchema),z.lazy(() => RegistryItemScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => RegistryItemScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => RegistryItemScalarWhereInputSchema),z.lazy(() => RegistryItemScalarWhereInputSchema).array() ]).optional(),
