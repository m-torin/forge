...
export const TeamMemberWhereUniqueInputSchema: z.ZodType<Prisma.TeamMemberWhereUniqueInput> = z
  .union([
    z.object({
      id: z.string().cuid(),
  ...
  .and(
    z
      .object({
        ...
        AND: z
          .union([
            z.lazy(() => TeamMemberWhereInputSchema),
            z.lazy(() => TeamMemberWhereInputSchema).array(),
          ])
          .optional(),
        OR: z
          .lazy(() => TeamMemberWhereInputSchema)
          .array()
          .optional(),
        NOT: z
          .union([
        ...
        user: z
          ...
          .optional(),
        team: z
          .union([z.lazy(() => TeamScalarRelationFilterSchema), z.lazy(() => TeamWhereInputSchema)])
          .optional(),
      })
      .strict(),
  );
