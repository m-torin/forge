...
export const InventoryTransactionUpdateManyWithoutInventoryNestedInputSchema: z.ZodType<Prisma.InventoryTransactionUpdateManyWithoutInventoryNestedInput> =
  z
    .object({
      create: z
        .union([
