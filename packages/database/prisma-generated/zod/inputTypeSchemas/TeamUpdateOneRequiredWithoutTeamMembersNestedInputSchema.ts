...
export const TeamUpdateOneRequiredWithoutTeamMembersNestedInputSchema: z.ZodType<Prisma.TeamUpdateOneRequiredWithoutTeamMembersNestedInput> = z.object({
  create: z.union([ z.lazy(() => TeamCreateWithoutTeamMembersInputSchema),z.lazy(() => TeamUncheckedCreateWithoutTeamMembersInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => TeamUpdateToOneWithWhereWithoutTeamMembersInputSchema),z.lazy(() => TeamUpdateWithoutTeamMembersInputSchema),z.lazy(() => TeamUncheckedUpdateWithoutTeamMembersInputSchema) ]).optional(),
}).strict();
