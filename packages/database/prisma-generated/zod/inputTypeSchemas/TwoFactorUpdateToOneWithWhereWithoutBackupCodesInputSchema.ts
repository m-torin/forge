...
export const TwoFactorUpdateToOneWithWhereWithoutBackupCodesInputSchema: z.ZodType<Prisma.TwoFactorUpdateToOneWithWhereWithoutBackupCodesInput> = z.object({
  where: z.lazy(() => TwoFactorWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TwoFactorUpdateWithoutBackupCodesInputSchema),z.lazy(() => TwoFactorUncheckedUpdateWithoutBackupCodesInputSchema) ]),
}).strict();
