...
export const ProductCategoryUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.ProductCategoryUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => ProductCategoryScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductCategoryUpdateManyMutationInputSchema),
        z.lazy(() => ProductCategoryUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
