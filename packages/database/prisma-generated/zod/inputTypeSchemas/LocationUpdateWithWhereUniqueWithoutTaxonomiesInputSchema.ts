...
export const LocationUpdateWithWhereUniqueWithoutTaxonomiesInputSchema: z.ZodType<Prisma.LocationUpdateWithWhereUniqueWithoutTaxonomiesInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateWithoutTaxonomiesInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutTaxonomiesInputSchema) ]),
}).strict();
