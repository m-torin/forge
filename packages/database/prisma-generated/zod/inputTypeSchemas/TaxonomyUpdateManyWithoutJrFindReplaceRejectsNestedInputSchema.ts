...
export const TaxonomyUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithoutJrFindReplaceRejectsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TaxonomyUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => TaxonomyUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TaxonomyScalarWhereInputSchema),z.lazy(() => TaxonomyScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TaxonomyUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema;
