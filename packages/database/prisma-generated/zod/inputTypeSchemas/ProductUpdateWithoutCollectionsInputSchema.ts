...
import { CartItemUpdateManyWithoutVariantNestedInputSchema } from './CartItemUpdateManyWithoutVariantNestedInputSchema';
...
export const ProductUpdateWithoutCollectionsInputSchema: z.ZodType<Prisma.ProductUpdateWithoutCollectionsInput> = z.object({
  ...
  categories: z.lazy(() => ProductCategoryUpdateManyWithoutProductsNestedInputSchema).optional(),
  ...
  cartItemVariants: z.lazy(() => CartItemUpdateManyWithoutVariantNestedInputSchema).optional(),
  orderItems: z.lazy(() => OrderItemUpdateManyWithoutProductNestedInputSchema).optional(),
  orderItemVariants: z.lazy(() => OrderItemUpdateManyWithoutVariantNestedInputSchema).optional(),
  inventory: z.lazy(() => InventoryUpdateManyWithoutProductNestedInputSchema).optional(),
  inventoryVariants: z.lazy(() => InventoryUpdateManyWithoutVariantNestedInputSchema).optional(),
  identifiers: z.lazy(() => ProductIdentifiersUpdateManyWithoutProductNestedInputSchema).optional(),
...
export default ProductUpdateWithoutCollectionsInputSchema;
