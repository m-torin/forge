...
export const JrFindReplaceRejectUpdateManyWithoutFandomsNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithoutFandomsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutFandomsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutFandomsInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutFandomsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default JrFindReplaceRejectUpdateManyWithoutFandomsNestedInputSchema;
