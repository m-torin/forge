...
export const SeriesUpsertWithWhereUniqueWithoutProductsInputSchema: z.ZodType<Prisma.SeriesUpsertWithWhereUniqueWithoutProductsInput> = z.object({
  where: z.lazy(() => SeriesWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SeriesUpdateWithoutProductsInputSchema),z.lazy(() => SeriesUncheckedUpdateWithoutProductsInputSchema) ]),
  create: z.union([ z.lazy(() => SeriesCreateWithoutProductsInputSchema),z.lazy(() => SeriesUncheckedCreateWithoutProductsInputSchema) ]),
}).strict();
