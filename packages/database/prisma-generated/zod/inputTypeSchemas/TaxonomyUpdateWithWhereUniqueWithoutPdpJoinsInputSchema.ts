...
export const TaxonomyUpdateWithWhereUniqueWithoutPdpJoinsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithWhereUniqueWithoutPdpJoinsInput> = z.object({
  where: z.lazy(() => TaxonomyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TaxonomyUpdateWithoutPdpJoinsInputSchema),z.lazy(() => TaxonomyUncheckedUpdateWithoutPdpJoinsInputSchema) ]),
}).strict();
