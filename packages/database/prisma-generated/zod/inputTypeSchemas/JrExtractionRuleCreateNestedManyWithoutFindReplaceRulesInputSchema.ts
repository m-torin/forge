...
export const JrExtractionRuleCreateNestedManyWithoutFindReplaceRulesInputSchema: z.ZodType<Prisma.JrExtractionRuleCreateNestedManyWithoutFindReplaceRulesInput> =
  z
    .object({
      create: z
        .union([
