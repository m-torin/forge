...
export const NestedEnumPurchaseStatusFilterSchema: z.ZodType<Prisma.NestedEnumPurchaseStatusFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => PurchaseStatusSchema),z.lazy(() => NestedEnumPurchaseStatusFilterSchema) ]).optional(),
}).strict();
