...
export const LocationUpdateManyWithoutProductsNestedInputSchema: z.ZodType<Prisma.LocationUpdateManyWithoutProductsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LocationUpsertWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => LocationUpsertWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LocationUpdateWithWhereUniqueWithoutProductsInputSchema),z.lazy(() => LocationUpdateWithWhereUniqueWithoutProductsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LocationUpdateManyWithWhereWithoutProductsInputSchema),z.lazy(() => LocationUpdateManyWithWhereWithoutProductsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LocationScalarWhereInputSchema),z.lazy(() => LocationScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LocationUpdateManyWithoutProductsNestedInputSchema;
