...
export const PdpJoinUpdateWithWhereUniqueWithoutBrandInputSchema: z.ZodType<Prisma.PdpJoinUpdateWithWhereUniqueWithoutBrandInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinWhereUniqueInputSchema),
      data: z.union([
        z.lazy(() => PdpJoinUpdateWithoutBrandInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateWithoutBrandInputSchema),
      ]),
    })
    .strict();
