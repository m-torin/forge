...
export const RegistryItemUpdateManyWithoutRegistryNestedInputSchema: z.ZodType<Prisma.RegistryItemUpdateManyWithoutRegistryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => RegistryItemUpsertWithWhereUniqueWithoutRegistryInputSchema),
          z.lazy(() => RegistryItemUpsertWithWhereUniqueWithoutRegistryInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => RegistryItemUpdateWithWhereUniqueWithoutRegistryInputSchema),
          z.lazy(() => RegistryItemUpdateWithWhereUniqueWithoutRegistryInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => RegistryItemUpdateManyWithWhereWithoutRegistryInputSchema),
          z.lazy(() => RegistryItemUpdateManyWithWhereWithoutRegistryInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default RegistryItemUpdateManyWithoutRegistryNestedInputSchema;
