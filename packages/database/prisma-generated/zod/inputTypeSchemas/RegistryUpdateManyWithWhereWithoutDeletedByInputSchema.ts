...
export const RegistryUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.RegistryUpdateManyWithWhereWithoutDeletedByInput> = z.object({
  where: z.lazy(() => RegistryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryUpdateManyMutationInputSchema),z.lazy(() => RegistryUncheckedUpdateManyWithoutDeletedByInputSchema) ]),
}).strict();
