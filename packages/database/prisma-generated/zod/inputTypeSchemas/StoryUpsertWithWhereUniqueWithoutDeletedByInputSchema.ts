...
export const StoryUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.StoryUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => StoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => StoryUpdateWithoutDeletedByInputSchema),z.lazy(() => StoryUncheckedUpdateWithoutDeletedByInputSchema) ]),
  create: z.union([ z.lazy(() => StoryCreateWithoutDeletedByInputSchema),z.lazy(() => StoryUncheckedCreateWithoutDeletedByInputSchema) ]),
}).strict();
