...
export const ProductUpdateOneRequiredWithoutSoldByNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneRequiredWithoutSoldByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateToOneWithWhereWithoutSoldByInputSchema),
