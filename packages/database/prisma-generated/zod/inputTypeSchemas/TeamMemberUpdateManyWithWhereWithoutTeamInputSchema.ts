...
export const TeamMemberUpdateManyWithWhereWithoutTeamInputSchema: z.ZodType<Prisma.TeamMemberUpdateManyWithWhereWithoutTeamInput> =
  z
    .object({
      where: z.lazy(() => TeamMemberScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => TeamMemberUpdateManyMutationInputSchema),
        z.lazy(() => TeamMemberUncheckedUpdateManyWithoutTeamInputSchema),
      ]),
    })
    .strict();
