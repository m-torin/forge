...
export const ProductUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutMediaNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProductUpdateToOneWithWhereWithoutMediaInputSchema),z.lazy(() => ProductUpdateWithoutMediaInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutMediaInputSchema) ]).optional(),
}).strict();
