...
export const PdpJoinCreateWithoutIdentifiersInputSchema: z.ZodType<Prisma.PdpJoinCreateWithoutIdentifiersInput> = z.object({
  ...
  manufacturerBrands: z.lazy(() => BrandCreateNestedManyWithoutManufacturedProductsInputSchema).optional(),
  urls: z.lazy(() => PdpUrlCreateNestedManyWithoutPdpJoinInputSchema).optional()
}).strict();

export default PdpJoinCreateWithoutIdentifiersInputSchema;
