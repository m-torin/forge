...
export const LocationUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => LocationScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => LocationUpdateManyMutationInputSchema),
        z.lazy(() => LocationUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
