...
export const ProductUpdateOneWithoutIdentifiersNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutIdentifiersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => ProductUpdateToOneWithWhereWithoutIdentifiersInputSchema),
