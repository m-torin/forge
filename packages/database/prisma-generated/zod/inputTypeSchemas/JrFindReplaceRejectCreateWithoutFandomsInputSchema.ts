...
export const JrFindReplaceRejectCreateWithoutFandomsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectCreateWithoutFandomsInput> = z.object({
  lookFor: z.string(),
...
export default JrFindReplaceRejectCreateWithoutFandomsInputSchema;
