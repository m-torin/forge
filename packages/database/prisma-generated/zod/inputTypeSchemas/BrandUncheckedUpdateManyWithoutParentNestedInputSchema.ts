...
export const BrandUncheckedUpdateManyWithoutParentNestedInputSchema: z.ZodType<Prisma.BrandUncheckedUpdateManyWithoutParentNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => BrandUpsertWithWhereUniqueWithoutParentInputSchema),z.lazy(() => BrandUpsertWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BrandUpdateWithWhereUniqueWithoutParentInputSchema),z.lazy(() => BrandUpdateWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BrandUpdateManyWithWhereWithoutParentInputSchema),z.lazy(() => BrandUpdateManyWithWhereWithoutParentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BrandScalarWhereInputSchema),z.lazy(() => BrandScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BrandUncheckedUpdateManyWithoutParentNestedInputSchema;
