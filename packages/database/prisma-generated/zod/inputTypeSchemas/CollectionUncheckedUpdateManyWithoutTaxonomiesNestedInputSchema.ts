...
export const CollectionUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutTaxonomiesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CollectionUpsertWithWhereUniqueWithoutTaxonomiesInputSchema),z.lazy(() => CollectionUpsertWithWhereUniqueWithoutTaxonomiesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CollectionUpdateWithWhereUniqueWithoutTaxonomiesInputSchema),z.lazy(() => CollectionUpdateWithWhereUniqueWithoutTaxonomiesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CollectionUpdateManyWithWhereWithoutTaxonomiesInputSchema),z.lazy(() => CollectionUpdateManyWithWhereWithoutTaxonomiesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CollectionScalarWhereInputSchema),z.lazy(() => CollectionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CollectionUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema;
