...
export const CollectionUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutTaxonomiesNestedInput> =
  z
    .object({
      create: z
        .union([
