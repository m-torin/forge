...
export const SeriesCountOrderByAggregateInputSchema: z.ZodType<Prisma.SeriesCountOrderByAggregateInput> =
  z
    .object({
...
export default SeriesCountOrderByAggregateInputSchema;
