...
export const JrFindReplaceRejectUpdateManyWithoutCastsNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithoutCastsNestedInput> = z.object({
  create: z.union([ z.lazy(() => JrFindReplaceRejectCreateWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectCreateWithoutCastsInputSchema).array(),z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedCreateWithoutCastsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectCreateOrConnectWithoutCastsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutCastsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutCastsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutCastsInputSchema),z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutCastsInputSchema).array() ]).optional(),
...
export default JrFindReplaceRejectUpdateManyWithoutCastsNestedInputSchema;
