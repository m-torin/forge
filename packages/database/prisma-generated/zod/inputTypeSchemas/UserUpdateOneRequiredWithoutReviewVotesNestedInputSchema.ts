...
export const UserUpdateOneRequiredWithoutReviewVotesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutReviewVotesNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutReviewVotesInputSchema),z.lazy(() => UserUncheckedCreateWithoutReviewVotesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutReviewVotesInputSchema),z.lazy(() => UserUpdateWithoutReviewVotesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutReviewVotesInputSchema) ]).optional(),
}).strict();
