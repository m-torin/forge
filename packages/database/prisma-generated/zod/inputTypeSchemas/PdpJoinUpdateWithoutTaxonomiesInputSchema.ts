...
export const PdpJoinUpdateWithoutTaxonomiesInputSchema: z.ZodType<Prisma.PdpJoinUpdateWithoutTaxonomiesInput> = z.object({
  ...
  manufacturerBrands: z.lazy(() => BrandUpdateManyWithoutManufacturedProductsNestedInputSchema).optional(),
  identifiers: z.lazy(() => ProductIdentifiersUpdateManyWithoutPdpJoinNestedInputSchema).optional(),
  urls: z.lazy(() => PdpUrlUpdateManyWithoutPdpJoinNestedInputSchema).optional()
}).strict();

export default PdpJoinUpdateWithoutTaxonomiesInputSchema;
