...
export const ProductUncheckedCreateWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductUncheckedCreateWithoutDeletedByInput> =
  z
    .object({
      ...
      collections: z
        .lazy(() => CollectionUncheckedCreateNestedManyWithoutProductsInputSchema)
        .optional(),
      taxonomies: z
        .lazy(() => TaxonomyUncheckedCreateNestedManyWithoutProductsInputSchema)
        .optional(),
      categories: z
        .lazy(() => ProductCategoryUncheckedCreateNestedManyWithoutProductsInputSchema)
        .optional(),
      media: z.lazy(() => MediaUncheckedCreateNestedManyWithoutProductInputSchema).optional(),
      favorites: z
        .lazy(() => FavoriteJoinUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      registries: z
        .lazy(() => RegistryItemUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      ...
      locations: z
        .lazy(() => LocationUncheckedCreateNestedManyWithoutProductsInputSchema)
        .optional(),
      casts: z.lazy(() => CastUncheckedCreateNestedManyWithoutProductsInputSchema).optional(),
      cartItems: z
        .lazy(() => CartItemUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      cartItemVariants: z
        .lazy(() => CartItemUncheckedCreateNestedManyWithoutVariantInputSchema)
        .optional(),
      orderItems: z
        .lazy(() => OrderItemUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      orderItemVariants: z
        .lazy(() => OrderItemUncheckedCreateNestedManyWithoutVariantInputSchema)
        .optional(),
      inventory: z
        .lazy(() => InventoryUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      inventoryVariants: z
        .lazy(() => InventoryUncheckedCreateNestedManyWithoutVariantInputSchema)
        .optional(),
      identifiers: z
        .lazy(() => ProductIdentifiersUncheckedCreateNestedManyWithoutProductInputSchema)
        .optional(),
      reviews: z.lazy(() => ReviewUncheckedCreateNestedManyWithoutProductInputSchema).optional(),
    })
    .strict();

export default ProductUncheckedCreateWithoutDeletedByInputSchema;
