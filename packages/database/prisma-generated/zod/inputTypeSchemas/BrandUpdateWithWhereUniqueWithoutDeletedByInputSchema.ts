...
export const BrandUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.BrandUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => BrandWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BrandUpdateWithoutDeletedByInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
