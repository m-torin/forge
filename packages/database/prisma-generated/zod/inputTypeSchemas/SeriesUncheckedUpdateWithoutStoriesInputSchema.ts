...
export const SeriesUncheckedUpdateWithoutStoriesInputSchema: z.ZodType<Prisma.SeriesUncheckedUpdateWithoutStoriesInput> =
  z
    .object({
      id: z
      ...
      jrFindReplaceRejects: z
        .lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutSeriesNestedInputSchema)
        .optional(),
    })
    .strict();

export default SeriesUncheckedUpdateWithoutStoriesInputSchema;
