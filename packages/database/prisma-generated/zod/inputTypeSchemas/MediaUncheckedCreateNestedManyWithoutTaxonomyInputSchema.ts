...
export const MediaUncheckedCreateNestedManyWithoutTaxonomyInputSchema: z.ZodType<Prisma.MediaUncheckedCreateNestedManyWithoutTaxonomyInput> =
  z
    .object({
      create: z
        .union([
...
export default MediaUncheckedCreateNestedManyWithoutTaxonomyInputSchema;
