...
export const UserUpdateOneWithoutDeletedReviewsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedReviewsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedReviewsInputSchema),
