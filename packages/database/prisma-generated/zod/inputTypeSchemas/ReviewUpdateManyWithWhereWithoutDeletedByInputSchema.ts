...
export const ReviewUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.ReviewUpdateManyWithWhereWithoutDeletedByInput> =
  z
    .object({
      where: z.lazy(() => ReviewScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ReviewUpdateManyMutationInputSchema),
        z.lazy(() => ReviewUncheckedUpdateManyWithoutDeletedByInputSchema),
      ]),
    })
    .strict();
