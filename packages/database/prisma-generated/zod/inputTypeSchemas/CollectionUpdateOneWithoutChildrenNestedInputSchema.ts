...
export const CollectionUpdateOneWithoutChildrenNestedInputSchema: z.ZodType<Prisma.CollectionUpdateOneWithoutChildrenNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateToOneWithWhereWithoutChildrenInputSchema),
