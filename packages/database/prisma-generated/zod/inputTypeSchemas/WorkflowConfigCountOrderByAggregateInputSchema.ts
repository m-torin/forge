...
export const WorkflowConfigCountOrderByAggregateInputSchema: z.ZodType<Prisma.WorkflowConfigCountOrderByAggregateInput> = z.object({
  ...
  customPayload: z.lazy(() => SortOrderSchema).optional(),
...
export default WorkflowConfigCountOrderByAggregateInputSchema;
