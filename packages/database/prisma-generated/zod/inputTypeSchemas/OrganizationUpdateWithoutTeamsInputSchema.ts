...
export const OrganizationUpdateWithoutTeamsInputSchema: z.ZodType<Prisma.OrganizationUpdateWithoutTeamsInput> =
  z
    .object({
      ...
      invitations: z
        .lazy(() => InvitationUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
    })
    .strict();

export default OrganizationUpdateWithoutTeamsInputSchema;
