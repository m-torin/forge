...
export const FandomUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema: z.ZodType<Prisma.FandomUpdateManyWithoutJrFindReplaceRejectsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => FandomUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),
          z.lazy(() => FandomUpsertWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => FandomUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema),
          z.lazy(() => FandomUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => FandomUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema),
          z.lazy(() => FandomUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default FandomUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema;
