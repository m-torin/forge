...
export const MediaUpdateManyWithoutReviewNestedInputSchema: z.ZodType<Prisma.MediaUpdateManyWithoutReviewNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutReviewInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutReviewInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutReviewInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutReviewInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutReviewInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutReviewInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUpdateManyWithoutReviewNestedInputSchema;
