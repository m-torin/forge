...
export const CollectionUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithoutDeletedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutDeletedByInputSchema),
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutDeletedByInputSchema),
          z.lazy(() => CollectionUpdateManyWithWhereWithoutDeletedByInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default CollectionUpdateManyWithoutDeletedByNestedInputSchema;
