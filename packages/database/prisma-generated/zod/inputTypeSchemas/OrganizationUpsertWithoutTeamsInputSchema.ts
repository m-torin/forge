...
export const OrganizationUpsertWithoutTeamsInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutTeamsInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutTeamsInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutTeamsInputSchema) ]),
