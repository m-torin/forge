...
export const RegistryItemUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.RegistryItemUncheckedUpdateManyWithoutProductNestedInput> = z.object({
  create: z.union([ z.lazy(() => RegistryItemCreateWithoutProductInputSchema),z.lazy(() => RegistryItemCreateWithoutProductInputSchema).array(),z.lazy(() => RegistryItemUncheckedCreateWithoutProductInputSchema),z.lazy(() => RegistryItemUncheckedCreateWithoutProductInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RegistryItemCreateOrConnectWithoutProductInputSchema),z.lazy(() => RegistryItemCreateOrConnectWithoutProductInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RegistryItemUpsertWithWhereUniqueWithoutProductInputSchema),z.lazy(() => RegistryItemUpsertWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => RegistryItemUpdateWithWhereUniqueWithoutProductInputSchema),z.lazy(() => RegistryItemUpdateWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => RegistryItemUpdateManyWithWhereWithoutProductInputSchema),z.lazy(() => RegistryItemUpdateManyWithWhereWithoutProductInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => RegistryItemScalarWhereInputSchema),z.lazy(() => RegistryItemScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default RegistryItemUncheckedUpdateManyWithoutProductNestedInputSchema;
