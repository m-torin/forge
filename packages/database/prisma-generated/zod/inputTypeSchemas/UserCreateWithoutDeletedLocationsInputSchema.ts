...
export const UserCreateWithoutDeletedLocationsInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedLocationsInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutDeletedLocationsInputSchema;
