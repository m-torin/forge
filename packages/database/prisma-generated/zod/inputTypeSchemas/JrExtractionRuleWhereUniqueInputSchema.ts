...
export const JrExtractionRuleWhereUniqueInputSchema: z.ZodType<Prisma.JrExtractionRuleWhereUniqueInput> = z.union([
  z.object({
    id: z.number().int(),
    jollyRogerId_fieldName: z.lazy(() => JrExtractionRuleJollyRogerIdFieldNameCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.number().int(),
  }),
...
.and(z.object({
  ...
  jollyRogerId_fieldName: z.lazy(() => JrExtractionRuleJollyRogerIdFieldNameCompoundUniqueInputSchema).optional(),
