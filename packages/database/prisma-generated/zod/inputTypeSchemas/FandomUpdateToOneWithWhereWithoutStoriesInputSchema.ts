...
export const FandomUpdateToOneWithWhereWithoutStoriesInputSchema: z.ZodType<Prisma.FandomUpdateToOneWithWhereWithoutStoriesInput> = z.object({
  where: z.lazy(() => FandomWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => FandomUpdateWithoutStoriesInputSchema),z.lazy(() => FandomUncheckedUpdateWithoutStoriesInputSchema) ]),
}).strict();
