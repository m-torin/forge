...
export const MediaUpdateManyWithWhereWithoutDeletedByInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutDeletedByInput> = z.object({
  where: z.lazy(() => MediaScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateManyMutationInputSchema),z.lazy(() => MediaUncheckedUpdateManyWithoutDeletedByInputSchema) ]),
}).strict();
