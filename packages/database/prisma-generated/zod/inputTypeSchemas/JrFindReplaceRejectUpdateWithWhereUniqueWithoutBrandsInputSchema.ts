...
export const JrFindReplaceRejectUpdateWithWhereUniqueWithoutBrandsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateWithWhereUniqueWithoutBrandsInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectWhereUniqueInputSchema),
      data: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateWithoutBrandsInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateWithoutBrandsInputSchema),
      ]),
    })
    .strict();
