...
export const OrderItemUpdateManyWithoutRegistryNestedInputSchema: z.ZodType<Prisma.OrderItemUpdateManyWithoutRegistryNestedInput> = z.object({
  create: z.union([ z.lazy(() => OrderItemCreateWithoutRegistryInputSchema),z.lazy(() => OrderItemCreateWithoutRegistryInputSchema).array(),z.lazy(() => OrderItemUncheckedCreateWithoutRegistryInputSchema),z.lazy(() => OrderItemUncheckedCreateWithoutRegistryInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => OrderItemCreateOrConnectWithoutRegistryInputSchema),z.lazy(() => OrderItemCreateOrConnectWithoutRegistryInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => OrderItemUpsertWithWhereUniqueWithoutRegistryInputSchema),z.lazy(() => OrderItemUpsertWithWhereUniqueWithoutRegistryInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => OrderItemUpdateWithWhereUniqueWithoutRegistryInputSchema),z.lazy(() => OrderItemUpdateWithWhereUniqueWithoutRegistryInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => OrderItemUpdateManyWithWhereWithoutRegistryInputSchema),z.lazy(() => OrderItemUpdateManyWithWhereWithoutRegistryInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => OrderItemScalarWhereInputSchema),z.lazy(() => OrderItemScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default OrderItemUpdateManyWithoutRegistryNestedInputSchema;
