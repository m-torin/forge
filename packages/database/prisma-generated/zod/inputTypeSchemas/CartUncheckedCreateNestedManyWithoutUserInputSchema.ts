...
export const CartUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.CartUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export default CartUncheckedCreateNestedManyWithoutUserInputSchema;
