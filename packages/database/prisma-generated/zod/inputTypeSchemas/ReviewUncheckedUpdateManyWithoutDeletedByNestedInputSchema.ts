...
export const ReviewUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.ReviewUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReviewCreateWithoutDeletedByInputSchema),z.lazy(() => ReviewCreateWithoutDeletedByInputSchema).array(),z.lazy(() => ReviewUncheckedCreateWithoutDeletedByInputSchema),z.lazy(() => ReviewUncheckedCreateWithoutDeletedByInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReviewCreateOrConnectWithoutDeletedByInputSchema),z.lazy(() => ReviewCreateOrConnectWithoutDeletedByInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ReviewUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ReviewUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ReviewUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ReviewUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReviewUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => ReviewUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReviewScalarWhereInputSchema),z.lazy(() => ReviewScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReviewUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
