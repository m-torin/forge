...
export const RegistryItemWhereUniqueInputSchema: z.ZodType<Prisma.RegistryItemWhereUniqueInput> = z
  .union([
    z.object({
      id: z.string().cuid(),
      registryId_productId_collectionId: z.lazy(
        () => RegistryItemRegistryIdProductIdCollectionIdCompoundUniqueInputSchema,
      ),
    }),
    z.object({
      id: z.string().cuid(),
  ...
  .and(
    z
      .object({
        ...
        registryId_productId_collectionId: z
          .lazy(() => RegistryItemRegistryIdProductIdCollectionIdCompoundUniqueInputSchema)
          .optional(),
        AND: z
          .union([
            z.lazy(() => RegistryItemWhereInputSchema),
            z.lazy(() => RegistryItemWhereInputSchema).array(),
          ])
          .optional(),
        OR: z
          .lazy(() => RegistryItemWhereInputSchema)
          .array()
          .optional(),
        NOT: z
          .union([
