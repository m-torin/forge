...
export const RegistryPurchaseJoinUpdateManyWithWhereWithoutRegistryItemInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinUpdateManyWithWhereWithoutRegistryItemInput> = z.object({
  where: z.lazy(() => RegistryPurchaseJoinScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegistryPurchaseJoinUpdateManyMutationInputSchema),z.lazy(() => RegistryPurchaseJoinUncheckedUpdateManyWithoutRegistryItemInputSchema) ]),
}).strict();
