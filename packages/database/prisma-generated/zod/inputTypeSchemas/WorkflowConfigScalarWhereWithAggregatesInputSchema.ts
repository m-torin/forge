...
export const WorkflowConfigScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.WorkflowConfigScalarWhereWithAggregatesInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(() => WorkflowConfigScalarWhereWithAggregatesInputSchema),
          z.lazy(() => WorkflowConfigScalarWhereWithAggregatesInputSchema).array(),
        ])
        .optional(),
      OR: z
        .lazy(() => WorkflowConfigScalarWhereWithAggregatesInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
