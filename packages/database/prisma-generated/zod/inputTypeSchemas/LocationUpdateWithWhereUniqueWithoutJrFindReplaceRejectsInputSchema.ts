...
export const LocationUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.LocationUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
