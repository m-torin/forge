...
export const CollectionUpdateManyWithoutParentNestedInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithoutParentNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutParentInputSchema),
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutParentInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutParentInputSchema),
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutParentInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutParentInputSchema),
          z.lazy(() => CollectionUpdateManyWithWhereWithoutParentInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default CollectionUpdateManyWithoutParentNestedInputSchema;
