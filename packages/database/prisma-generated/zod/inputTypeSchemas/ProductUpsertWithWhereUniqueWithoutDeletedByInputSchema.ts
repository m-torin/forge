...
export const ProductUpsertWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.ProductUpsertWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProductUpdateWithoutDeletedByInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutDeletedByInputSchema) ]),
  create: z.union([ z.lazy(() => ProductCreateWithoutDeletedByInputSchema),z.lazy(() => ProductUncheckedCreateWithoutDeletedByInputSchema) ]),
}).strict();
