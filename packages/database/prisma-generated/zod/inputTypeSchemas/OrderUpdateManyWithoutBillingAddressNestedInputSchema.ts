...
export const OrderUpdateManyWithoutBillingAddressNestedInputSchema: z.ZodType<Prisma.OrderUpdateManyWithoutBillingAddressNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => OrderCreateWithoutBillingAddressInputSchema),
          z.lazy(() => OrderCreateWithoutBillingAddressInputSchema).array(),
          z.lazy(() => OrderUncheckedCreateWithoutBillingAddressInputSchema),
          z.lazy(() => OrderUncheckedCreateWithoutBillingAddressInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => OrderCreateOrConnectWithoutBillingAddressInputSchema),
          z.lazy(() => OrderCreateOrConnectWithoutBillingAddressInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => OrderUpsertWithWhereUniqueWithoutBillingAddressInputSchema),
          z.lazy(() => OrderUpsertWithWhereUniqueWithoutBillingAddressInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => OrderUpdateWithWhereUniqueWithoutBillingAddressInputSchema),
          z.lazy(() => OrderUpdateWithWhereUniqueWithoutBillingAddressInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => OrderUpdateManyWithWhereWithoutBillingAddressInputSchema),
          z.lazy(() => OrderUpdateManyWithWhereWithoutBillingAddressInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default OrderUpdateManyWithoutBillingAddressNestedInputSchema;
