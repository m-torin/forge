...
export const MediaUpsertWithWhereUniqueWithoutArticleInputSchema: z.ZodType<Prisma.MediaUpsertWithWhereUniqueWithoutArticleInput> = z.object({
  where: z.lazy(() => MediaWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => MediaUpdateWithoutArticleInputSchema),z.lazy(() => MediaUncheckedUpdateWithoutArticleInputSchema) ]),
  create: z.union([ z.lazy(() => MediaCreateWithoutArticleInputSchema),z.lazy(() => MediaUncheckedCreateWithoutArticleInputSchema) ]),
}).strict();
