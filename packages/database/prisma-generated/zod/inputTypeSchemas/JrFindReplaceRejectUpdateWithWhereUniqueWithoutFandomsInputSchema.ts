...
export const JrFindReplaceRejectUpdateWithWhereUniqueWithoutFandomsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateWithWhereUniqueWithoutFandomsInput> = z.object({
  where: z.lazy(() => JrFindReplaceRejectWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => JrFindReplaceRejectUpdateWithoutFandomsInputSchema),z.lazy(() => JrFindReplaceRejectUncheckedUpdateWithoutFandomsInputSchema) ]),
}).strict();
