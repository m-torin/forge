...
export const ReviewVoteJoinWhereUniqueInputSchema: z.ZodType<Prisma.ReviewVoteJoinWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        .object({
          ...
          userId_reviewId: z
            .lazy(() => ReviewVoteJoinUserIdReviewIdCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
          ...
          review: z
            .union([
              z.lazy(() => ReviewScalarRelationFilterSchema),
