...
export const RegistryPurchaseJoinUpdateManyWithoutPurchaserNestedInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinUpdateManyWithoutPurchaserNestedInput> =
  z
    .object({
      create: z
        .union([
