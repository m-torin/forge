...
export const SeriesUncheckedUpdateManyWithoutFandomNestedInputSchema: z.ZodType<Prisma.SeriesUncheckedUpdateManyWithoutFandomNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => SeriesUpsertWithWhereUniqueWithoutFandomInputSchema),
          z.lazy(() => SeriesUpsertWithWhereUniqueWithoutFandomInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => SeriesUpdateWithWhereUniqueWithoutFandomInputSchema),
          z.lazy(() => SeriesUpdateWithWhereUniqueWithoutFandomInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => SeriesUpdateManyWithWhereWithoutFandomInputSchema),
          z.lazy(() => SeriesUpdateManyWithWhereWithoutFandomInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default SeriesUncheckedUpdateManyWithoutFandomNestedInputSchema;
