...
export const MediaUpdateManyWithWhereWithoutBrandInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutBrandInput> = z.object({
  where: z.lazy(() => MediaScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MediaUpdateManyMutationInputSchema),z.lazy(() => MediaUncheckedUpdateManyWithoutBrandInputSchema) ]),
}).strict();
