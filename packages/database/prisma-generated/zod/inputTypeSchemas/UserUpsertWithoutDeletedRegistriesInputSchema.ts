...
export const UserUpsertWithoutDeletedRegistriesInputSchema: z.ZodType<Prisma.UserUpsertWithoutDeletedRegistriesInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutDeletedRegistriesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedRegistriesInputSchema) ]),
