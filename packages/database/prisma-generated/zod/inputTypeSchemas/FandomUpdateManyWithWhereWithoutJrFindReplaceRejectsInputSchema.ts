...
export const FandomUpdateManyWithWhereWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.FandomUpdateManyWithWhereWithoutJrFindReplaceRejectsInput> =
  z
    .object({
      where: z.lazy(() => FandomScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => FandomUpdateManyMutationInputSchema),
        z.lazy(() => FandomUncheckedUpdateManyWithoutJrFindReplaceRejectsInputSchema),
      ]),
    })
    .strict();
