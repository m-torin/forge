...
export const CollectionUpsertWithoutRegistriesInputSchema: z.ZodType<Prisma.CollectionUpsertWithoutRegistriesInput> = z.object({
  update: z.union([ z.lazy(() => CollectionUpdateWithoutRegistriesInputSchema),z.lazy(() => CollectionUncheckedUpdateWithoutRegistriesInputSchema) ]),
  create: z.union([ z.lazy(() => CollectionCreateWithoutRegistriesInputSchema),z.lazy(() => CollectionUncheckedCreateWithoutRegistriesInputSchema) ]),
