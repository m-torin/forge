...
export const JrFindReplaceRejectCreateNestedManyWithoutTaxonomiesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectCreateNestedManyWithoutTaxonomiesInput> =
  z
    .object({
      create: z
        .union([
