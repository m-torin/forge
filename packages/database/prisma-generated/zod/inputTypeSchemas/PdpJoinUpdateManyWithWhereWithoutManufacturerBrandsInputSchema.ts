...
export const PdpJoinUpdateManyWithWhereWithoutManufacturerBrandsInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutManufacturerBrandsInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => PdpJoinUpdateManyMutationInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateManyWithoutManufacturerBrandsInputSchema),
      ]),
    })
    .strict();
