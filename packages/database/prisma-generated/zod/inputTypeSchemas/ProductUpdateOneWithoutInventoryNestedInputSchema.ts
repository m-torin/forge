...
export const ProductUpdateOneWithoutInventoryNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutInventoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProductUpdateToOneWithWhereWithoutInventoryInputSchema),z.lazy(() => ProductUpdateWithoutInventoryInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutInventoryInputSchema) ]).optional(),
}).strict();
