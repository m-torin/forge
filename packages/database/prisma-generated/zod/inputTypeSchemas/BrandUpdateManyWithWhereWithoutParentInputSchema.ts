...
export const BrandUpdateManyWithWhereWithoutParentInputSchema: z.ZodType<Prisma.BrandUpdateManyWithWhereWithoutParentInput> =
  z
    .object({
      where: z.lazy(() => BrandScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => BrandUpdateManyMutationInputSchema),
        z.lazy(() => BrandUncheckedUpdateManyWithoutParentInputSchema),
      ]),
    })
    .strict();
