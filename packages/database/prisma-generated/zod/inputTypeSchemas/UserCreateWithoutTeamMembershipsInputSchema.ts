...
export const UserCreateWithoutTeamMembershipsInputSchema: z.ZodType<Prisma.UserCreateWithoutTeamMembershipsInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutTeamMembershipsInputSchema;
