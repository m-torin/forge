...
export const StoryUpdateWithWhereUniqueWithoutSeriesInputSchema: z.ZodType<Prisma.StoryUpdateWithWhereUniqueWithoutSeriesInput> = z.object({
  where: z.lazy(() => StoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => StoryUpdateWithoutSeriesInputSchema),z.lazy(() => StoryUncheckedUpdateWithoutSeriesInputSchema) ]),
}).strict();
