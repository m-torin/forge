...
export const TaxonomyUncheckedUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.TaxonomyUncheckedUpdateManyWithoutCollectionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutCollectionsInputSchema),
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutCollectionsInputSchema),
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutCollectionsInputSchema),
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutCollectionsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TaxonomyUncheckedUpdateManyWithoutCollectionsNestedInputSchema;
