...
export const FavoriteJoinUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.FavoriteJoinUncheckedUpdateManyWithoutProductNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => FavoriteJoinUpsertWithWhereUniqueWithoutProductInputSchema),z.lazy(() => FavoriteJoinUpsertWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => FavoriteJoinUpdateWithWhereUniqueWithoutProductInputSchema),z.lazy(() => FavoriteJoinUpdateWithWhereUniqueWithoutProductInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => FavoriteJoinUpdateManyWithWhereWithoutProductInputSchema),z.lazy(() => FavoriteJoinUpdateManyWithWhereWithoutProductInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => FavoriteJoinScalarWhereInputSchema),z.lazy(() => FavoriteJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default FavoriteJoinUncheckedUpdateManyWithoutProductNestedInputSchema;
