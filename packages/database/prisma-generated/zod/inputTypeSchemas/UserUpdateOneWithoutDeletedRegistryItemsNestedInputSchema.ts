...
export const UserUpdateOneWithoutDeletedRegistryItemsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedRegistryItemsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutDeletedRegistryItemsInputSchema),
