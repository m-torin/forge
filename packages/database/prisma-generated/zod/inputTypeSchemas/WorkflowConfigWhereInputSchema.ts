...
export const WorkflowConfigWhereInputSchema: z.ZodType<Prisma.WorkflowConfigWhereInput> = z.object({
  ...
  maxRetries: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  timeoutSeconds: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  rateLimitPerHour: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  maxConcurrent: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
