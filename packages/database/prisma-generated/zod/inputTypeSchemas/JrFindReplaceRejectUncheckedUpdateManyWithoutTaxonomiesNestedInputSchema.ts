...
export const JrFindReplaceRejectUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateManyWithoutTaxonomiesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutTaxonomiesInputSchema),
          z
            .lazy(() => JrFindReplaceRejectUpsertWithWhereUniqueWithoutTaxonomiesInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutTaxonomiesInputSchema),
          z
            .lazy(() => JrFindReplaceRejectUpdateWithWhereUniqueWithoutTaxonomiesInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutTaxonomiesInputSchema),
          z.lazy(() => JrFindReplaceRejectUpdateManyWithWhereWithoutTaxonomiesInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default JrFindReplaceRejectUncheckedUpdateManyWithoutTaxonomiesNestedInputSchema;
