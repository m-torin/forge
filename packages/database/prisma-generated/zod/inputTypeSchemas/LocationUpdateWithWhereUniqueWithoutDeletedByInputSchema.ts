...
export const LocationUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.LocationUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateWithoutDeletedByInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
