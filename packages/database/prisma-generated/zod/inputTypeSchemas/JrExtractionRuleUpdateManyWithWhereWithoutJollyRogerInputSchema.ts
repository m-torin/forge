...
export const JrExtractionRuleUpdateManyWithWhereWithoutJollyRogerInputSchema: z.ZodType<Prisma.JrExtractionRuleUpdateManyWithWhereWithoutJollyRogerInput> = z.object({
  where: z.lazy(() => JrExtractionRuleScalarWhereInputSchema),
  data: z.union([ z.lazy(() => JrExtractionRuleUpdateManyMutationInputSchema),z.lazy(() => JrExtractionRuleUncheckedUpdateManyWithoutJollyRogerInputSchema) ]),
}).strict();
