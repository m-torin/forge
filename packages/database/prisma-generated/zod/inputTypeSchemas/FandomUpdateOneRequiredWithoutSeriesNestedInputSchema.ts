...
export const FandomUpdateOneRequiredWithoutSeriesNestedInputSchema: z.ZodType<Prisma.FandomUpdateOneRequiredWithoutSeriesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => FandomUpdateToOneWithWhereWithoutSeriesInputSchema),z.lazy(() => FandomUpdateWithoutSeriesInputSchema),z.lazy(() => FandomUncheckedUpdateWithoutSeriesInputSchema) ]).optional(),
}).strict();
