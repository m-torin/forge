...
export const ProductUpdateManyWithWhereWithoutCastsInputSchema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutCastsInput> =
  z
    .object({
      where: z.lazy(() => ProductScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductUpdateManyMutationInputSchema),
        z.lazy(() => ProductUncheckedUpdateManyWithoutCastsInputSchema),
      ]),
    })
    .strict();
