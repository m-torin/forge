...
export const MediaUncheckedUpdateManyWithoutProductNestedInputSchema: z.ZodType<Prisma.MediaUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutProductInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutProductInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutProductInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutProductInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutProductInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutProductInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUncheckedUpdateManyWithoutProductNestedInputSchema;
