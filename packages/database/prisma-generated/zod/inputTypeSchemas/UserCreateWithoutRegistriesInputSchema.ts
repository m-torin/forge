...
export const UserCreateWithoutRegistriesInputSchema: z.ZodType<Prisma.UserCreateWithoutRegistriesInput> =
  z
    .object({
      id: z.string(),
      name: z.string(),
...
export default UserCreateWithoutRegistriesInputSchema;
