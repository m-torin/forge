...
export const BrandUpdateOneWithoutJollyRogerNestedInputSchema: z.ZodType<Prisma.BrandUpdateOneWithoutJollyRogerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => BrandUpdateToOneWithWhereWithoutJollyRogerInputSchema),
          z.lazy(() => BrandUpdateWithoutJollyRogerInputSchema),
          z.lazy(() => BrandUncheckedUpdateWithoutJollyRogerInputSchema),
        ])
        .optional(),
    })
    .strict();
