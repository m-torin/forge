...
export const InventoryUpdateManyWithWhereWithoutVariantInputSchema: z.ZodType<Prisma.InventoryUpdateManyWithWhereWithoutVariantInput> =
  z
    .object({
      where: z.lazy(() => InventoryScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => InventoryUpdateManyMutationInputSchema),
        z.lazy(() => InventoryUncheckedUpdateManyWithoutVariantInputSchema),
      ]),
    })
    .strict();
