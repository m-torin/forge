...
export const NestedEnumJrChartMethodFilterSchema: z.ZodType<Prisma.NestedEnumJrChartMethodFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => JrChartMethodSchema),z.lazy(() => NestedEnumJrChartMethodFilterSchema) ]).optional(),
}).strict();
