...
export const RegistryPurchaseJoinUncheckedUpdateManyWithoutRegistryItemNestedInputSchema: z.ZodType<Prisma.RegistryPurchaseJoinUncheckedUpdateManyWithoutRegistryItemNestedInput> =
  z
    .object({
      create: z
        .union([
