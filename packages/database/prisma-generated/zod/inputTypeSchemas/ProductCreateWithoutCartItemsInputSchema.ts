...
export const ProductCreateWithoutCartItemsInputSchema: z.ZodType<Prisma.ProductCreateWithoutCartItemsInput> =
  z
    .object({
...
export default ProductCreateWithoutCartItemsInputSchema;
