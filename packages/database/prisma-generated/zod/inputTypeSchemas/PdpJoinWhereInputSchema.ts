...
export const PdpJoinWhereInputSchema: z.ZodType<Prisma.PdpJoinWhereInput> = z
  .object({
    AND: z
      .union([z.lazy(() => PdpJoinWhereInputSchema), z.lazy(() => PdpJoinWhereInputSchema).array()])
      .optional(),
    OR: z
    ...
    product: z
      ...
      .optional(),
    brand: z
      .union([z.lazy(() => BrandScalarRelationFilterSchema), z.lazy(() => BrandWhereInputSchema)])
      .optional(),
