...
export const BackupCodeUncheckedUpdateInputSchema: z.ZodType<Prisma.BackupCodeUncheckedUpdateInput> = z.object({
  ...
  twoFactorId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default BackupCodeUncheckedUpdateInputSchema;
