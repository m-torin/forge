...
export const UserUpdateOneWithoutAddressesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutAddressesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutAddressesInputSchema),
