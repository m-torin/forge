...
export const ProductIdentifiersUncheckedUpdateManyWithoutPdpJoinNestedInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedUpdateManyWithoutPdpJoinNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutPdpJoinInputSchema),z.lazy(() => ProductIdentifiersUpsertWithWhereUniqueWithoutPdpJoinInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutPdpJoinInputSchema),z.lazy(() => ProductIdentifiersUpdateWithWhereUniqueWithoutPdpJoinInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutPdpJoinInputSchema),z.lazy(() => ProductIdentifiersUpdateManyWithWhereWithoutPdpJoinInputSchema).array() ]).optional(),
...
export default ProductIdentifiersUncheckedUpdateManyWithoutPdpJoinNestedInputSchema;
