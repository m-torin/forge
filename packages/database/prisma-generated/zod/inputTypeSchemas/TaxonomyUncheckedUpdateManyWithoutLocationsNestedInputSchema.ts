...
export const TaxonomyUncheckedUpdateManyWithoutLocationsNestedInputSchema: z.ZodType<Prisma.TaxonomyUncheckedUpdateManyWithoutLocationsNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => TaxonomyCreateWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyCreateWithoutLocationsInputSchema).array(),
          z.lazy(() => TaxonomyUncheckedCreateWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyUncheckedCreateWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => TaxonomyCreateOrConnectWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyCreateOrConnectWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyUpsertWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyUpdateWithWhereUniqueWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutLocationsInputSchema),
          z.lazy(() => TaxonomyUpdateManyWithWhereWithoutLocationsInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TaxonomyUncheckedUpdateManyWithoutLocationsNestedInputSchema;
