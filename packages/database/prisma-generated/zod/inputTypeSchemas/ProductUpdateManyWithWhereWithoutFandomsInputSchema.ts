...
export const ProductUpdateManyWithWhereWithoutFandomsInputSchema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutFandomsInput> =
  z
    .object({
      where: z.lazy(() => ProductScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => ProductUpdateManyMutationInputSchema),
        z.lazy(() => ProductUncheckedUpdateManyWithoutFandomsInputSchema),
      ]),
    })
    .strict();
