...
export const MediaUpdateManyWithoutCategoryNestedInputSchema: z.ZodType<Prisma.MediaUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => MediaCreateWithoutCategoryInputSchema),
          z.lazy(() => MediaCreateWithoutCategoryInputSchema).array(),
          z.lazy(() => MediaUncheckedCreateWithoutCategoryInputSchema),
          z.lazy(() => MediaUncheckedCreateWithoutCategoryInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => MediaCreateOrConnectWithoutCategoryInputSchema),
          z.lazy(() => MediaCreateOrConnectWithoutCategoryInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutCategoryInputSchema),
          z.lazy(() => MediaUpsertWithWhereUniqueWithoutCategoryInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutCategoryInputSchema),
          z.lazy(() => MediaUpdateWithWhereUniqueWithoutCategoryInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MediaUpdateManyWithWhereWithoutCategoryInputSchema),
          z.lazy(() => MediaUpdateManyWithWhereWithoutCategoryInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default MediaUpdateManyWithoutCategoryNestedInputSchema;
