...
export const ArticleUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.ArticleUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ArticleUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ArticleUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ArticleUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => ArticleUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ArticleUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => ArticleUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ArticleScalarWhereInputSchema),z.lazy(() => ArticleScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ArticleUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
