...
export const PdpJoinUpdateManyWithWhereWithoutBrandInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutBrandInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => PdpJoinUpdateManyMutationInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateManyWithoutBrandInputSchema),
      ]),
    })
    .strict();
