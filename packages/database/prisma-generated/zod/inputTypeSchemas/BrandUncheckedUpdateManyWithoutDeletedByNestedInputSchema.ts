...
export const BrandUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.BrandUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => BrandUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => BrandUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BrandUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => BrandUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BrandUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => BrandUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BrandScalarWhereInputSchema),z.lazy(() => BrandScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BrandUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
