...
export const ProductIdentifiersUncheckedCreateNestedManyWithoutProductInputSchema: z.ZodType<Prisma.ProductIdentifiersUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
