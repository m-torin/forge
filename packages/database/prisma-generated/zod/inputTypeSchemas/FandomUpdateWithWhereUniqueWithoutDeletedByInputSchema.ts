...
export const FandomUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.FandomUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => FandomWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => FandomUpdateWithoutDeletedByInputSchema),z.lazy(() => FandomUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
