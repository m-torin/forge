...
export const CastUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInputSchema: z.ZodType<Prisma.CastUpdateWithWhereUniqueWithoutJrFindReplaceRejectsInput> = z.object({
  where: z.lazy(() => CastWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CastUpdateWithoutJrFindReplaceRejectsInputSchema),z.lazy(() => CastUncheckedUpdateWithoutJrFindReplaceRejectsInputSchema) ]),
}).strict();
