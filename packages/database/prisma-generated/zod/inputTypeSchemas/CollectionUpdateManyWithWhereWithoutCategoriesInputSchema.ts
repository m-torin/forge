...
export const CollectionUpdateManyWithWhereWithoutCategoriesInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutCategoriesInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutCategoriesInputSchema),
      ]),
    })
    .strict();
