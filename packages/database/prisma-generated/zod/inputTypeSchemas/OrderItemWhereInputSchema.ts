...
export const OrderItemWhereInputSchema: z.ZodType<Prisma.OrderItemWhereInput> = z
  .object({
    AND: z
      .union([
    ...
    registryId: z
      ...
      .nullable(),
    status: z
      .union([z.lazy(() => EnumOrderItemStatusFilterSchema), z.lazy(() => OrderItemStatusSchema)])
      .optional(),
    fulfilledAt: z
