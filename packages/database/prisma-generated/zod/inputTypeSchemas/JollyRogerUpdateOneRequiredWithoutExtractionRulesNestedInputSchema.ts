...
export const JollyRogerUpdateOneRequiredWithoutExtractionRulesNestedInputSchema: z.ZodType<Prisma.JollyRogerUpdateOneRequiredWithoutExtractionRulesNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => JollyRogerCreateOrConnectWithoutExtractionRulesInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => JollyRogerUpdateToOneWithWhereWithoutExtractionRulesInputSchema),
