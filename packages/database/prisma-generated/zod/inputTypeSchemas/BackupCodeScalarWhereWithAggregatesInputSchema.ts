...
export const BackupCodeScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BackupCodeScalarWhereWithAggregatesInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(() => BackupCodeScalarWhereWithAggregatesInputSchema),
          z.lazy(() => BackupCodeScalarWhereWithAggregatesInputSchema).array(),
        ])
        .optional(),
      OR: z
        .lazy(() => BackupCodeScalarWhereWithAggregatesInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
