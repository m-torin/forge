...
export const PdpJoinUpdateManyWithWhereWithoutCollectionsInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithWhereWithoutCollectionsInput> = z.object({
  where: z.lazy(() => PdpJoinScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PdpJoinUpdateManyMutationInputSchema),z.lazy(() => PdpJoinUncheckedUpdateManyWithoutCollectionsInputSchema) ]),
}).strict();
