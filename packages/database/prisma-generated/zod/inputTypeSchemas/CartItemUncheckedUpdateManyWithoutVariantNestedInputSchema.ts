...
export const CartItemUncheckedUpdateManyWithoutVariantNestedInputSchema: z.ZodType<Prisma.CartItemUncheckedUpdateManyWithoutVariantNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => CartItemCreateWithoutVariantInputSchema),
          z.lazy(() => CartItemCreateWithoutVariantInputSchema).array(),
          z.lazy(() => CartItemUncheckedCreateWithoutVariantInputSchema),
          z.lazy(() => CartItemUncheckedCreateWithoutVariantInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => CartItemCreateOrConnectWithoutVariantInputSchema),
          z.lazy(() => CartItemCreateOrConnectWithoutVariantInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => CartItemUpsertWithWhereUniqueWithoutVariantInputSchema),
          z.lazy(() => CartItemUpsertWithWhereUniqueWithoutVariantInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CartItemUpdateWithWhereUniqueWithoutVariantInputSchema),
          z.lazy(() => CartItemUpdateWithWhereUniqueWithoutVariantInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CartItemUpdateManyWithWhereWithoutVariantInputSchema),
          z.lazy(() => CartItemUpdateManyWithWhereWithoutVariantInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default CartItemUncheckedUpdateManyWithoutVariantNestedInputSchema;
