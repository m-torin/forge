...
export const MediaUpdateManyWithWhereWithoutCategoryInputSchema: z.ZodType<Prisma.MediaUpdateManyWithWhereWithoutCategoryInput> =
  z
    .object({
      where: z.lazy(() => MediaScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MediaUpdateManyMutationInputSchema),
        z.lazy(() => MediaUncheckedUpdateManyWithoutCategoryInputSchema),
      ]),
    })
    .strict();
