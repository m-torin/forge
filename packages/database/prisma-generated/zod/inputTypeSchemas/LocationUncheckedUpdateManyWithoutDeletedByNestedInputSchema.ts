...
export const LocationUncheckedUpdateManyWithoutDeletedByNestedInputSchema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutDeletedByNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LocationUpsertWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => LocationUpsertWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LocationUpdateWithWhereUniqueWithoutDeletedByInputSchema),z.lazy(() => LocationUpdateWithWhereUniqueWithoutDeletedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LocationUpdateManyWithWhereWithoutDeletedByInputSchema),z.lazy(() => LocationUpdateManyWithWhereWithoutDeletedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LocationScalarWhereInputSchema),z.lazy(() => LocationScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LocationUncheckedUpdateManyWithoutDeletedByNestedInputSchema;
