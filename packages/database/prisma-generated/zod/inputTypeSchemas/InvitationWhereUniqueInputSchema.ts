...
export const InvitationWhereUniqueInputSchema: z.ZodType<Prisma.InvitationWhereUniqueInput> = z
  .object({
    id: z.string(),
  })
  .and(
    z
      .object({
        ...
        AND: z
          .union([
            z.lazy(() => InvitationWhereInputSchema),
            z.lazy(() => InvitationWhereInputSchema).array(),
          ])
          .optional(),
        OR: z
          .lazy(() => InvitationWhereInputSchema)
          .array()
          .optional(),
        NOT: z
          .union([
