...
export const JrExtractionRuleUncheckedUpdateManyWithoutFindReplaceRulesNestedInputSchema: z.ZodType<Prisma.JrExtractionRuleUncheckedUpdateManyWithoutFindReplaceRulesNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => JrExtractionRuleCreateWithoutFindReplaceRulesInputSchema),
          z.lazy(() => JrExtractionRuleCreateWithoutFindReplaceRulesInputSchema).array(),
          z.lazy(() => JrExtractionRuleUncheckedCreateWithoutFindReplaceRulesInputSchema),
          z.lazy(() => JrExtractionRuleUncheckedCreateWithoutFindReplaceRulesInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => JrExtractionRuleCreateOrConnectWithoutFindReplaceRulesInputSchema),
          z.lazy(() => JrExtractionRuleCreateOrConnectWithoutFindReplaceRulesInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => JrExtractionRuleUpsertWithWhereUniqueWithoutFindReplaceRulesInputSchema),
          z
            .lazy(() => JrExtractionRuleUpsertWithWhereUniqueWithoutFindReplaceRulesInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => JrExtractionRuleUpdateWithWhereUniqueWithoutFindReplaceRulesInputSchema),
          z
            .lazy(() => JrExtractionRuleUpdateWithWhereUniqueWithoutFindReplaceRulesInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => JrExtractionRuleUpdateManyWithWhereWithoutFindReplaceRulesInputSchema),
          z
            .lazy(() => JrExtractionRuleUpdateManyWithWhereWithoutFindReplaceRulesInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
...
export default JrExtractionRuleUncheckedUpdateManyWithoutFindReplaceRulesNestedInputSchema;
