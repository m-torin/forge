...
export const ProductIdentifiersUpdateWithWhereUniqueWithoutCollectionInputSchema: z.ZodType<Prisma.ProductIdentifiersUpdateWithWhereUniqueWithoutCollectionInput> = z.object({
  where: z.lazy(() => ProductIdentifiersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProductIdentifiersUpdateWithoutCollectionInputSchema),z.lazy(() => ProductIdentifiersUncheckedUpdateWithoutCollectionInputSchema) ]),
}).strict();
