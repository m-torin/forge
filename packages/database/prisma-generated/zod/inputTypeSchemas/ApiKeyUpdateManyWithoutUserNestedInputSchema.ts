...
export const ApiKeyUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ApiKeyUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => ApiKeyUpsertWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => ApiKeyUpsertWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => ApiKeyUpdateWithWhereUniqueWithoutUserInputSchema),
          z.lazy(() => ApiKeyUpdateWithWhereUniqueWithoutUserInputSchema).array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ApiKeyUpdateManyWithWhereWithoutUserInputSchema),
          z.lazy(() => ApiKeyUpdateManyWithWhereWithoutUserInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => ApiKeyScalarWhereInputSchema),
          z.lazy(() => ApiKeyScalarWhereInputSchema).array(),
        ])
        .optional(),
    })
    .strict();

export default ApiKeyUpdateManyWithoutUserNestedInputSchema;
