...
import { BrandUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema } from './BrandUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema';
...
export const JrFindReplaceRejectUncheckedUpdateInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedUpdateInput> =
  z
    .object({
      ...
      priority: z
        ...
        .optional(),
      brands: z
        .lazy(() => BrandUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      locations: z
        .lazy(() => LocationUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      taxonomies: z
        .lazy(() => TaxonomyUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      stories: z
        .lazy(() => StoryUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      fandoms: z
        .lazy(() => FandomUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      series: z
        .lazy(() => SeriesUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      casts: z
        .lazy(() => CastUncheckedUpdateManyWithoutJrFindReplaceRejectsNestedInputSchema)
        .optional(),
      extractionRules: z
        .lazy(() => JrExtractionRuleUncheckedUpdateManyWithoutFindReplaceRulesNestedInputSchema)
        .optional(),
    })
    .strict();

export default JrFindReplaceRejectUncheckedUpdateInputSchema;
