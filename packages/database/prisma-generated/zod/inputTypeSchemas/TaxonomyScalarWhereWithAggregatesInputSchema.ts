...
export const TaxonomyScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TaxonomyScalarWhereWithAggregatesInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(() => TaxonomyScalarWhereWithAggregatesInputSchema),
          z.lazy(() => TaxonomyScalarWhereWithAggregatesInputSchema).array(),
        ])
        .optional(),
      OR: z
        .lazy(() => TaxonomyScalarWhereWithAggregatesInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
      ...
      type: z
        .union([
          z.lazy(() => EnumTaxonomyTypeWithAggregatesFilterSchema),
