...
export const LocationUpdateWithoutFandomsInputSchema: z.ZodType<Prisma.LocationUpdateWithoutFandomsInput> =
  z
    .object({
      id: z
...
export default LocationUpdateWithoutFandomsInputSchema;
