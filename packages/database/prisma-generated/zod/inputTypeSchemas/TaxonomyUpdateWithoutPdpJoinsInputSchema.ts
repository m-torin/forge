...
export const TaxonomyUpdateWithoutPdpJoinsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithoutPdpJoinsInput> =
  z
    .object({
      id: z
...
export default TaxonomyUpdateWithoutPdpJoinsInputSchema;
