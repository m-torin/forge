...
export const LocationUpdateManyWithWhereWithoutPdpJoinsInputSchema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutPdpJoinsInput> = z.object({
  where: z.lazy(() => LocationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateManyMutationInputSchema),z.lazy(() => LocationUncheckedUpdateManyWithoutPdpJoinsInputSchema) ]),
}).strict();
