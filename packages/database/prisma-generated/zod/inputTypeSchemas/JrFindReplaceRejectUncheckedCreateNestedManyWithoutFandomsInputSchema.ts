...
export const JrFindReplaceRejectUncheckedCreateNestedManyWithoutFandomsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUncheckedCreateNestedManyWithoutFandomsInput> =
  z
    .object({
      create: z
        .union([
