...
export const JrFindReplaceRejectUpdateManyWithWhereWithoutSeriesInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithWhereWithoutSeriesInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateManyMutationInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutSeriesInputSchema),
      ]),
    })
    .strict();
