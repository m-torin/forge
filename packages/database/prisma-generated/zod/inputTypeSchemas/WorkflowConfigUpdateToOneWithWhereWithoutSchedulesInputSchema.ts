...
export const WorkflowConfigUpdateToOneWithWhereWithoutSchedulesInputSchema: z.ZodType<Prisma.WorkflowConfigUpdateToOneWithWhereWithoutSchedulesInput> = z.object({
  where: z.lazy(() => WorkflowConfigWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => WorkflowConfigUpdateWithoutSchedulesInputSchema),z.lazy(() => WorkflowConfigUncheckedUpdateWithoutSchedulesInputSchema) ]),
}).strict();
