...
export const AddressUpdateOneWithoutOrderBillingAddressesNestedInputSchema: z.ZodType<Prisma.AddressUpdateOneWithoutOrderBillingAddressesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => AddressUpdateToOneWithWhereWithoutOrderBillingAddressesInputSchema),
