...
export const PdpJoinUpdateManyWithoutLocationsNestedInputSchema: z.ZodType<Prisma.PdpJoinUpdateManyWithoutLocationsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutLocationsInputSchema),z.lazy(() => PdpJoinUpsertWithWhereUniqueWithoutLocationsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutLocationsInputSchema),z.lazy(() => PdpJoinUpdateWithWhereUniqueWithoutLocationsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PdpJoinUpdateManyWithWhereWithoutLocationsInputSchema),z.lazy(() => PdpJoinUpdateManyWithWhereWithoutLocationsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PdpJoinScalarWhereInputSchema),z.lazy(() => PdpJoinScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PdpJoinUpdateManyWithoutLocationsNestedInputSchema;
