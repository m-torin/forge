...
export const PdpUrlUpdateManyWithWhereWithoutPdpJoinInputSchema: z.ZodType<Prisma.PdpUrlUpdateManyWithWhereWithoutPdpJoinInput> = z.object({
  where: z.lazy(() => PdpUrlScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PdpUrlUpdateManyMutationInputSchema),z.lazy(() => PdpUrlUncheckedUpdateManyWithoutPdpJoinInputSchema) ]),
}).strict();
