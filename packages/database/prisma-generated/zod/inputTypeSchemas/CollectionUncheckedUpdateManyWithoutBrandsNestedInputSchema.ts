...
export const CollectionUncheckedUpdateManyWithoutBrandsNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutBrandsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CollectionUpsertWithWhereUniqueWithoutBrandsInputSchema),z.lazy(() => CollectionUpsertWithWhereUniqueWithoutBrandsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CollectionUpdateWithWhereUniqueWithoutBrandsInputSchema),z.lazy(() => CollectionUpdateWithWhereUniqueWithoutBrandsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CollectionUpdateManyWithWhereWithoutBrandsInputSchema),z.lazy(() => CollectionUpdateManyWithWhereWithoutBrandsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CollectionScalarWhereInputSchema),z.lazy(() => CollectionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CollectionUncheckedUpdateManyWithoutBrandsNestedInputSchema;
