...
export const TaxonomyUpsertWithWhereUniqueWithoutCollectionsInputSchema: z.ZodType<Prisma.TaxonomyUpsertWithWhereUniqueWithoutCollectionsInput> = z.object({
  where: z.lazy(() => TaxonomyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TaxonomyUpdateWithoutCollectionsInputSchema),z.lazy(() => TaxonomyUncheckedUpdateWithoutCollectionsInputSchema) ]),
