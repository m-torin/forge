...
export const BrandUpdateToOneWithWhereWithoutChildrenInputSchema: z.ZodType<Prisma.BrandUpdateToOneWithWhereWithoutChildrenInput> = z.object({
  where: z.lazy(() => BrandWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BrandUpdateWithoutChildrenInputSchema),z.lazy(() => BrandUncheckedUpdateWithoutChildrenInputSchema) ]),
}).strict();
