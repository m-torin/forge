...
export const CollectionUpdateWithWhereUniqueWithoutDeletedByInputSchema: z.ZodType<Prisma.CollectionUpdateWithWhereUniqueWithoutDeletedByInput> = z.object({
  where: z.lazy(() => CollectionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CollectionUpdateWithoutDeletedByInputSchema),z.lazy(() => CollectionUncheckedUpdateWithoutDeletedByInputSchema) ]),
}).strict();
