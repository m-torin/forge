...
export const TaxonomyUpdateManyWithWhereWithoutProductsInputSchema: z.ZodType<Prisma.TaxonomyUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
      where: z.lazy(() => TaxonomyScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => TaxonomyUpdateManyMutationInputSchema),
        z.lazy(() => TaxonomyUncheckedUpdateManyWithoutProductsInputSchema),
      ]),
    })
    .strict();
