...
export const PdpJoinUpdateToOneWithWhereWithoutIdentifiersInputSchema: z.ZodType<Prisma.PdpJoinUpdateToOneWithWhereWithoutIdentifiersInput> = z.object({
  where: z.lazy(() => PdpJoinWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => PdpJoinUpdateWithoutIdentifiersInputSchema),z.lazy(() => PdpJoinUncheckedUpdateWithoutIdentifiersInputSchema) ]),
}).strict();
