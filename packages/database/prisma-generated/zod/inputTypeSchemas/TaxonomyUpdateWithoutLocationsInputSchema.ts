...
export const TaxonomyUpdateWithoutLocationsInputSchema: z.ZodType<Prisma.TaxonomyUpdateWithoutLocationsInput> =
  z
    .object({
      id: z
...
export default TaxonomyUpdateWithoutLocationsInputSchema;
