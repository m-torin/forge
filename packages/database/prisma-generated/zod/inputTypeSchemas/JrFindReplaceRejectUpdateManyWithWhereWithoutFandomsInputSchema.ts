...
export const JrFindReplaceRejectUpdateManyWithWhereWithoutFandomsInputSchema: z.ZodType<Prisma.JrFindReplaceRejectUpdateManyWithWhereWithoutFandomsInput> =
  z
    .object({
      where: z.lazy(() => JrFindReplaceRejectScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => JrFindReplaceRejectUpdateManyMutationInputSchema),
        z.lazy(() => JrFindReplaceRejectUncheckedUpdateManyWithoutFandomsInputSchema),
      ]),
    })
    .strict();
