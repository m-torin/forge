...
export const UserUpsertWithoutCreatedRegistriesInputSchema: z.ZodType<Prisma.UserUpsertWithoutCreatedRegistriesInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutCreatedRegistriesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutCreatedRegistriesInputSchema) ]),
