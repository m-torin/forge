...
export const LocationUpdateManyWithWhereWithoutTaxonomiesInputSchema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutTaxonomiesInput> =
  z
    .object({
      where: z.lazy(() => LocationScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => LocationUpdateManyMutationInputSchema),
        z.lazy(() => LocationUncheckedUpdateManyWithoutTaxonomiesInputSchema),
      ]),
    })
    .strict();
