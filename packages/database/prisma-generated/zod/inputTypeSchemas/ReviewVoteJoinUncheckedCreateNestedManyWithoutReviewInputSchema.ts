...
export const ReviewVoteJoinUncheckedCreateNestedManyWithoutReviewInputSchema: z.ZodType<Prisma.ReviewVoteJoinUncheckedCreateNestedManyWithoutReviewInput> =
  z
    .object({
      create: z
        .union([
