...
export const ArticleUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.ArticleUpdateOneWithoutMediaNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ArticleUpdateToOneWithWhereWithoutMediaInputSchema),z.lazy(() => ArticleUpdateWithoutMediaInputSchema),z.lazy(() => ArticleUncheckedUpdateWithoutMediaInputSchema) ]).optional(),
}).strict();
