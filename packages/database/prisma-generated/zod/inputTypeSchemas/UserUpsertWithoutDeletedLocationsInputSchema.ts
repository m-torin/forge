...
export const UserUpsertWithoutDeletedLocationsInputSchema: z.ZodType<Prisma.UserUpsertWithoutDeletedLocationsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutDeletedLocationsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedLocationsInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutDeletedLocationsInputSchema),z.lazy(() => UserUncheckedCreateWithoutDeletedLocationsInputSchema) ]),
