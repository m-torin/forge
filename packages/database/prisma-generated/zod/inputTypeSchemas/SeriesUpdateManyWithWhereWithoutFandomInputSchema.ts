...
export const SeriesUpdateManyWithWhereWithoutFandomInputSchema: z.ZodType<Prisma.SeriesUpdateManyWithWhereWithoutFandomInput> = z.object({
  where: z.lazy(() => SeriesScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SeriesUpdateManyMutationInputSchema),z.lazy(() => SeriesUncheckedUpdateManyWithoutFandomInputSchema) ]),
}).strict();
