...
export const WorkflowScheduleUncheckedCreateNestedManyWithoutConfigInputSchema: z.ZodType<Prisma.WorkflowScheduleUncheckedCreateNestedManyWithoutConfigInput> =
  z
    .object({
      create: z
        .union([
