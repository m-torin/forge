...
export const PdpJoinUpsertWithWhereUniqueWithoutCollectionsInputSchema: z.ZodType<Prisma.PdpJoinUpsertWithWhereUniqueWithoutCollectionsInput> =
  z
    .object({
      where: z.lazy(() => PdpJoinWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => PdpJoinUpdateWithoutCollectionsInputSchema),
        z.lazy(() => PdpJoinUncheckedUpdateWithoutCollectionsInputSchema),
      ]),
      create: z.union([
