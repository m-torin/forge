...
export const LocationUpdateWithoutDeletedByInputSchema: z.ZodType<Prisma.LocationUpdateWithoutDeletedByInput> =
  z
    .object({
      id: z
...
export default LocationUpdateWithoutDeletedByInputSchema;
