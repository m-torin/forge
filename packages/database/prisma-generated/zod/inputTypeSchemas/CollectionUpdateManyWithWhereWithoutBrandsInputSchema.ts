...
export const CollectionUpdateManyWithWhereWithoutBrandsInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutBrandsInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutBrandsInputSchema),
      ]),
    })
    .strict();
