...
const logger = {
  error: (message: string, ...args: any[]) =>
    console.error(`[database:soft-delete] ${message}`, ...args),
  warn: (message: string, ...args: any[]) =>
    console.warn(`[database:soft-delete] ${message}`, ...args),
  info: (message: string, ...args: any[]) =>
    console.info(`[database:soft-delete] ${message}`, ...args),
  log: (message: string, ...args: any[]) =>
    console.log(`[database:soft-delete] ${message}`, ...args),
};
...
export async function softDeleteAction(
  ...
  try {
    ...
    logger.error(`Error soft deleting ${model}:`, error);
    return {
      success: false,
...
export async function restoreAction(
  ...
  try {
    ...
    logger.error(`Error restoring ${model}:`, error);
    return {
      success: false,
...
export async function bulkSoftDeleteAction(
  ...
  try {
    ...
    logger.error(`Error bulk soft deleting ${model}:`, error);
    return {
      success: false,
...
export async function bulkRestoreAction(
  ...
  try {
    ...
    logger.error(`Error bulk restoring ${model}:`, error);
    return {
      success: false,
