...
const logger = {
  error: (message: string, ...args: any[]) =>
    console.error(`[database:category] ${message}`, ...args),
  warn: (message: string, ...args: any[]) =>
    console.warn(`[database:category] ${message}`, ...args),
  info: (message: string, ...args: any[]) =>
    console.info(`[database:category] ${message}`, ...args),
  log: (message: string, ...args: any[]) => console.log(`[database:category] ${message}`, ...args),
};
...
export async function getCategoriesAction(params?: {
  ...
  'use server';
  return getCategoriesAdvancedAction(params);
}
