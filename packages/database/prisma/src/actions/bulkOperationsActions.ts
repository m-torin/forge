...
export async function bulkUpdateStatusAction(
  ...
  try {
    ...
    console.error(`Error bulk updating status for ${model}:`, error);
    return {
      success: false,
...
export async function bulkAssignRelationshipAction(
  ...
  try {
    ...
    console.error(`Error bulk assigning relationships to ${parentModel}:`, error);
    return {
      success: false,
...
export async function bulkRemoveRelationshipAction(
  ...
  try {
    ...
    console.error(`Error bulk removing relationships from ${parentModel}:`, error);
    return {
      success: false,
...
export async function bulkUpsertAction<T extends Record<string, any>>(
  ...
  try {
    ...
    console.error(`Error bulk upserting ${model}:`, error);
    return {
      success: false,
