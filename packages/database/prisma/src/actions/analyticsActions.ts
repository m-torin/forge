...
export async function getCountByFieldAction(
  ...
  try {
    ...
    console.error(`Error getting count by ${groupByField} for ${model}:`, error);
    return {
      success: false,
...
export async function getActivityStatsAction(
  ...
  try {
    ...
    console.error(`Error getting activity stats for ${model}:`, error);
    return {
      success: false,
...
export async function getAggregateStatsAction(
  ...
  try {
    ...
    console.error(`Error getting aggregate stats for ${model}:`, error);
    return {
      success: false,
...
export async function getConversionRateAction(
  ...
  try {
    ...
    console.error(`Error calculating conversion rate for ${model}:`, error);
    return {
      success: false,
