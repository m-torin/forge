...
export async function checkSlugAvailabilityAction(
  ...
  try {
    ...
    console.error(`Error checking slug availability for ${model}:`, error);
    return {
      success: false,
...
export async function generateUniqueSlugAction(
  ...
  try {
    ...
    console.error(`Error generating unique slug for ${model}:`, error);
    return {
      success: false,
...
export async function validateEntityExistsAction(
  ...
  try {
    ...
    console.error(`Error validating entity existence for ${model}:`, error);
    return {
      success: false,
...
export async function validateEntitiesExistAction(
  ...
  try {
    ...
    console.error(`Error validating entities existence for ${model}:`, error);
    return {
      success: false,
