...
import { ok } from '../utils/tool-helpers';
...
export const reportGeneratorTool = {
  ...
  async execute(args: ReportGeneratorArgs): Promise<MCPToolResponse> {
    try {
        ...
        case 'updatePullRequest': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(updateResult).result,
              },
            ],
          };
        }
        ...
        case 'addPRComment': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(commentResult).result,
              },
            ],
          };
        }
        ...
        case 'getPRTemplate': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(template).result,
              },
            ],
          };
        }
        ...
        case 'generateDocumentation': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(documentation).result,
              },
            ],
          };
        }
        ...
        case 'updateReadme': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(readmeUpdate).result,
              },
            ],
          };
        }
        ...
        case 'generateChangelog': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(changelog).result,
              },
            ],
          };
        }
        ...
        case 'generateAPIdocs': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(apiDoc).result,
              },
            ],
          };
        }
        ...
        case 'processTemplate': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(processed).result,
              },
            ],
          };
        }
        ...
        case 'validateTemplate': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(validation).result,
              },
            ],
          };
        }
        ...
        case 'exportToMarkdown': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(markdown).result,
              },
            ],
          };
        }
        ...
        case 'exportToJSON': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(jsonExport).result,
              },
            ],
          };
        }
        ...
        case 'exportToHTML': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(html).result,
              },
            ],
          };
        }
        ...
        case 'exportToPDF': {
          ...
          return {
            content: [
              {
                type: 'text',
                text: safeStringifyAdvanced(pdf).result,
              },
            ],
          };
        }
      ...
      return createEnhancedMCPErrorResponse(error, 'report_generator', {
        contextInfo: `Report Generator - ${args.action} (${args.reportType || 'unknown type'})`,
      });
    }
  },
};
...
async function createPullRequestWithReport(
  ...
  const prBody = formatReportForPR(report);
