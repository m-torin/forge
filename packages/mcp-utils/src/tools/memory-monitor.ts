              ...
              content: [
                {
                  type: 'text',
                  text: JSON.stringify({
                    error: 'Advanced analysis must be enabled for leak detection',
                    suggestion: 'Set enableAdvancedAnalysis: true',
                  }),
                },
              ],
              isError: true,
                ...
                content: [
                  {
                    ...
                    text: JSON.stringify({
                      ...
                      memoryFreed: Math.round(
                        (beforeUsage.heapUsed - afterUsage.heapUsed) / 1024 / 1024,
                      ),
                    }),
                  },
                ],
        ...
        content: [
          {
            type: 'text',
            text: JSON.stringify({
              error: `Memory monitor error: ${error instanceof Error ? error.message : 'Unknown error'}`,
            }),
          },
        ],
        isError: true,
