...
export interface LinkManager {
  ...
  bulkCreate(request: BulkCreateRequest): Promise<BulkCreateResponse>;
  trackClick(linkId: string, event: Partial<ClickEvent>): Promise<void>;
}

export type { DubProviderConfig as DubConfig };
export type { CreateLinkRequest as CreateLink };
export type { UpdateLinkRequest as UpdateLink };
export type { LinkAnalytics as Analytics };
export type { ClickEvent as Click };
export type { LinkMetrics as Metrics };
