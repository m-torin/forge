...
export async function serverBasicExample() {
  ...
  console.log('Short link created:', link.shortLink);
...
export async function serverAdvancedExample() {
  ...
  console.log('Advanced link created:', link);
...
export async function serverAnalyticsExample() {
  ...
  console.log('Link details:', metrics.link);
  console.log('Time series data:', metrics.timeSeries);
