...
describe("server Links Module", () => {
  ...
  describe("bulk operations", () => {
    test("should handle bulk create with validation", async () => {
      const { bulkCreateShortLinks, createServerLinkManager } = await import(
        "../../src/server"
      );
  ...
  describe("server analytics tracking", () => {
    test("should track server click with request context", async () => {
      const { trackServerClick, createServerLinkManager } = await import(
        "../../src/server"
      );
  ...
  describe("redirect handling", () => {
    test("should create redirect handler function", async () => {
      const { createRedirectHandler, createServerLinkManager } = await import(
        "../../src/server"
      );
  ...
  describe("metrics caching", () => {
    test("should get link metrics with cache", async () => {
      const { getLinkMetricsWithCache, createServerLinkManager } = await import(
        "../../src/server"
      );
  ...
  describe("error handling", () => {
    test("should handle authentication errors", async () => {
      ...
      try {
        ...
        await expect(
          manager.createLink({ url: "https://example.com" }),
