...
describe('VercelBlobProvider', () => {
  ...
  describe('download', () => {
    ...
    it('should handle download errors', async () => {
      ...
      await expect(provider.download('test-key')).rejects.toThrow(
        'Failed to download blob: Not Found',
      );
    });
    ...
    it('should handle fetch network errors', async () => {
      ...
      await expect(provider.download('test-key')).rejects.toThrow('Network error');
    });
  });
